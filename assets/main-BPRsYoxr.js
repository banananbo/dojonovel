  ...
  - id: scene_ch4_monologue
    ...
    messages:
      ...
      - text: でも、あの日の笑い声はまだ耳に残っている。
        voice_character_id: char_hero
      - text: おばちゃんが全力で走って、みんなが名前を呼んでいた。
        voice_character_id: null
  ...
  - id: scene_ch4_detective_intro
    ...
    characters:
      - character_id: char_detective
        ...
        expression: normal
    messages:
      - text: ホームの端に、コートを着た中年男性が立っていた。
        voice_character_id: null
      - text: 男は自動販売機の下をのぞきこんで、落ちていた十円玉をすばやくポケットに入れた。
        voice_character_id: null
      - text: 「……おや、見たかね。これは現場保存というやつじゃ」
        voice_character_id: char_detective
      - text: 「え、探偵さん？」
        voice_character_id: char_hero
      - text: 「そうじゃ。赤羽の探偵、と呼んでくれ。交番には顔が利く。主に、怒られる方でな」
        voice_character_id: char_detective
      - text: 「わしのロケットペンダント、さっきここのベンチで子猫に取られてしもうたんじゃ。大事な形見でな」
        voice_character_id: char_detective
      - text: 「子猫が……ペンダントを？」
        voice_character_id: char_hero
      - text: 「そうじゃ。赤羽のどこかに逃げたはずじゃが……わしは今、駅員に見つかると少々まずい」
        voice_character_id: char_detective
      - text: 「何したんですか」
        voice_character_id: char_hero
...
`;function St({engines:e,initial:t,initialContext:n,defaultTransition:r=`none`}){let[i,o]=(0,a.useState)(n),[s,c]=(0,a.useState)(t),[l,u]=(0,a.useState)(`idle`),[d,f]=(0,a.useState)(`none`),p=(0,a.useRef)(null);function m(e,t){let n=null;if(t?n={engineId:t.engineId,config:t.config,returnEngineId:t.returnEngineId,returnConfig:t.returnConfig,returnTransition:t.returnTransition}:s.returnEngineId&&(n={engineId:s.returnEngineId,config:s.returnConfig}),!n)return;let i=(t?t.transition:s.returnTransition)??r??`none`;if(i===`none`||!(i in yt)){o(e),c(n);return}p.current={updated:e,next:n},f(i),u(`out`)}(0,a.useEffect)(()=>{if(l!==`out`)return;let e=setTimeout(()=>{p.current&&=(o(p.current.updated),c(p.current.next),null),u(`in`)},yt[d]);return()=>clearTimeout(e)},[l,d]),(0,a.useEffect)(()=>{if(l!==`in`)return;let e=setTimeout(()=>u(`idle`),yt[d]);return()=>clearTimeout(e)},[l,d]);let h=e[s.engineId];if(!h)return(0,F.jsxs)(`div`,{style:{padding:24,color:`red`},children:[`Engine not found: `,s.engineId]});let g=h.component,_=l!==`idle`,v=d===`flash`?`#fff`:d===`speedline`?[`radial-gradient(circle at 50% 50%, rgba(255,255,255,0.95) 0 5%, rgba(255,210,90,0.78) 9%, rgba(255,120,70,0.38) 18%, rgba(0,0,0,0.92) 58%)`,`repeating-linear-gradient(100deg, rgba(255,255,255,0.95) 0 8px, rgba(255,210,90,0.35) 8px 14px, rgba(0,0,0,0) 14px 34px)`,`#050505`].join(`, `):d===`rift`?[`radial-gradient(circle at 50% 50%, rgba(190,120,255,0.95) 0 4%, rgba(80,20,120,0.82) 13%, rgba(12,2,24,0.98) 54%, #000 100%)`,`repeating-conic-gradient(from 0deg, rgba(210,170,255,0.24) 0deg 7deg, rgba(0,0,0,0) 7deg 18deg)`,`#000`].join(`, `):d===`cardflip`?[`radial-gradient(circle at 50% 50%, rgba(255,245,210,0.9) 0 8%, rgba(110,45,80,0.84) 34%, rgba(12,8,22,0.98) 74%)`,`linear-gradient(90deg, rgba(255,255,255,0.20) 0 1px, transparent 1px 80px)`,`linear-gradient(0deg, rgba(255,255,255,0.16) 0 1px, transparent 1px 112px)`,`#0d0712`].join(`, `):d===`numberstorm`?[`radial-gradient(circle at 50% 46%, rgba(255,255,255,0.98) 0 6%, rgba(255,230,92,0.74) 14%, rgba(25,190,220,0.38) 33%, rgba(21,24,60,0.96) 72%)`,`repeating-linear-gradient(24deg, rgba(255,255,255,0.18) 0 2px, transparent 2px 28px)`,`repeating-linear-gradient(116deg, rgba(255,223,92,0.17) 0 2px, transparent 2px 34px)`,`#11183c`].join(`, `):`#000`,y=_?{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`all`,background:v,backgroundSize:d===`speedline`?`100% 100%, 220px 100%, 100% 100%`:d===`rift`?`100% 100%, 180px 180px, 100% 100%`:d===`cardflip`?`100% 100%, 80px 100%, 100% 112px, 100% 100%`:d===`numberstorm`?`100% 100%, 120px 120px, 150px 150px, 100% 100%`:void 0,animation:`hub-${d}-${l} ${yt[d]}ms ease forwards`}:{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`none`,opacity:0};return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(`style`,{children:xt}),(0,F.jsx)(g,{context:i,config:s.config,onExit:m}),(0,F.jsxs)(`div`,{style:y,children:[_&&d===`speedline`&&(0,F.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#fff7c8`,fontFamily:`'Impact', 'Arial Black', sans-serif`,fontSize:96,letterSpacing:0,textShadow:`0 0 18px rgba(255,118,54,0.95), 0 8px 0 rgba(0,0,0,0.55)`,transform:l===`out`?`rotate(-5deg) scale(1.08)`:`rotate(5deg) scale(0.96)`},children:`RUN!`}),_&&d===`cardflip`&&(0,F.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:190,height:260,borderRadius:8,border:`2px solid rgba(255,245,210,0.95)`,background:`linear-gradient(145deg, rgba(255,245,210,0.96), rgba(170,80,130,0.92))`,boxShadow:`0 0 30px rgba(255,230,160,0.8), inset 0 0 0 10px rgba(70,22,48,0.32)`,transform:`translate(-50%, -50%) ${l===`out`?`rotate(-4deg)`:`rotate(4deg)`}`}}),_&&d===`numberstorm`&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:210,height:210,borderRadius:`50%`,background:`radial-gradient(circle, rgba(255,255,255,0.96) 0 18%, rgba(255,222,82,0.84) 31%, rgba(34,206,230,0.22) 56%, transparent 70%)`,boxShadow:`0 0 34px rgba(255,234,94,0.85), 0 0 72px rgba(73,220,255,0.48)`,animation:`hub-number-pulse 520ms ease-in-out infinite`}}),(0,F.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#162057`,fontFamily:`'Arial Black', 'Impact', sans-serif`,fontSize:64,letterSpacing:0,textShadow:`0 2px 0 rgba(255,255,255,0.8), 0 0 16px rgba(255,241,124,0.9)`},children:`COUNT!`}),bt.map((e,t)=>(0,F.jsx)(`span`,{style:{position:`absolute`,left:e.left,top:e.top,color:e.color,fontFamily:`'Arial Black', 'Impact', sans-serif`,fontSize:e.size,lineHeight:1,letterSpacing:0,textShadow:`0 0 16px rgba(255,255,255,0.92), 0 5px 0 rgba(7,11,34,0.42)`,transform:`rotate(${e.rotate}deg)`,animation:`hub-number-fly 620ms cubic-bezier(0.2, 0.9, 0.2, 1) ${e.delay}ms both`},children:e.value},`${e.value}-${t}`))]})]})]})}function Ct({context:e,config:t,onExit:n}){let r=(0,a.useCallback)((r,i,a,o)=>{let s={flags:r,inventory:i,playerStats:e.playerStats};if(a.id===`__return__`){n(s);return}let c=Object.values(t.masterData.items).map(e=>({id:e.id,name:e.name,usable:e.usable,description:e.description,category:e.category})),l=a.config??{},u={},d=(e,n)=>{if(typeof e!=`string`)return;let r=t.masterData.characters[e];if(!r)return;u[`${n}Name`]=r.name;let i=r.sprites?.normal??(r.sprites?Object.values(r.sprites)[0]:void 0);i&&(u[`${n}FaceImage`]=i),r.voicevox_speaker_id&&(u[`${n}VoicevoxSpeakerId`]=r.voicevox_speaker_id)};d(l.playerCharacterId,`player`),d(l.opponentCharacterId,`opponent`);let f={masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,chapterId:o,initialLocationId:t.initialLocationId,chapters:t.chapters,exitSceneId:a.return_scene,gameoverSceneId:a.gameover_scene,gameoverBossSceneId:a.gameover_boss_scene,gameoverLandingSceneId:a.gameover_landing_scene};n(s,{engineId:a.id,transition:a.transition,config:{assetsBaseUrl:t.assetsBaseUrl,items:c,...u,...a.config??{},_novelReturn:f},returnEngineId:a.return_scene?`novel`:void 0,returnConfig:a.return_scene?{...t,chapterId:o,initialSceneId:a.return_scene,autoStart:!0}:void 0})},[e.playerStats,t,n]);return(0,F.jsx)(ft,{masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,config:{initialSceneId:t.initialSceneId,initialLocationId:t.initialLocationId,chapterId:t.chapterId,chapters:t.chapters},initialFlags:e.flags,initialInventory:e.inventory,autoStart:t.autoStart,onEngineTransition:r})}var wt={component:Ct},Tt={dungeon_01:[`###########`,`#S........#`,`#.#######.#`,`###.......#`,`###.#######`,`###.....###`,`#######.###`,`#######.###`,`#######.###`,`#######...#`,`#########X#`,`###########`],dungeon_02:[`###############`,`#S..........###`,`#.#########.###`,`###.........###`,`###.#######.###`,`###E#.........#`,`###.#.#########`,`###.#.........#`,`###.###########`,`###..........B#`,`#############X#`,`###############`],dungeon_03:[`###############`,`#S.....##.#####`,`#.#######.#####`,`#.#######.#####`,`#.#######.#####`,`#.###.#E......#`,`#.###.#.#####.#`,`#.###.#.#####.#`,`#.###.#.#####.#`,`#.......#####B#`,`#############X#`,`###############`]};function Et(e){return{...e,maxHp:e.hp}}var Dt={ghost:{id:`ghost`,name:`ゴースト`,hp:10,atk:4,def:1},bat:{id:`bat`,name:`コウモリ`,hp:6,atk:3,def:0},wraith:{id:`wraith`,name:`レイス`,hp:14,atk:5,def:2}},Ot={dungeon_02:[Dt.ghost,Dt.bat,Dt.wraith],dungeon_03:[Dt.ghost,Dt.bat,Dt.wraith]},kt={dungeon_02:{id:`maze_boss`,name:`迷宮の主`,hp:22,atk:7,def:2},dungeon_03:{id:`maze_boss`,name:`迷宮の主`,hp:22,atk:7,def:2}};function At(e){let t=kt[e];return t?Et(t):null}function jt(e){let t=Ot[e];return!t||t.length===0?null:Et(t[Math.floor(Math.random()*t.length)])}function Mt(e){let t=jt(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が現れた！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function Nt(e){let t=At(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が立ちはだかった！　逃げられない！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function Pt(e){let{battle:t}=e;if(!t)return e;let n=Math.max(1,t.enemy.atk-(t.guarding?e.playerDef*2:e.playerDef)),r=e.playerHp-n,i=[...t.log,`${t.enemy.name} の攻撃！ ケン に ${n} ダメージ！`];return r<=0?{...e,playerHp:0,battle:{...t,phase:`lose`,log:[...i,`ケン は倒れた……`],guarding:!1}}:{...e,playerHp:r,battle:{...t,phase:`select`,log:i,guarding:!1}}}function Ft(e){let{battle:t}=e;if(!t)return e;if(t.cursorIndex===3){if(e.pendingBossTilePos){let n=[...t.log,`逃げることはできない！`];return Pt({...e,battle:{...t,log:n,guarding:!1}})}if(Math.random()<.5)return{...e,battle:null};let n=[...t.log,`逃げられなかった！`];return Pt({...e,battle:{...t,log:n,guarding:!1}})}if(t.cursorIndex===1){let n=[...t.log,`ケン は身を守った！`];return Pt({...e,battle:{...t,log:n,guarding:!0}})}if(t.cursorIndex===2)return e;let n=Math.max(1,e.playerAtk-t.enemy.def),r=t.enemy.hp-n,i=[...t.log,`ケン の攻撃！ ${t.enemy.name} に ${n} ダメージ！`];if(r<=0){let n={...t.enemy,hp:0};return{...e,battle:{...t,enemy:n,phase:`win`,log:[...i,`${t.enemy.name} を倒した！`],guarding:!1}}}let a={...t.enemy,hp:r};return Pt({...e,battle:{...t,enemy:a,log:i,guarding:!1}})}function It(e,t){let{battle:n}=e;if(!n)return e;let r=t===`Enter`||t===` `,i=t===`ArrowUp`||t===`w`||t===`W`,a=t===`ArrowDown`||t===`s`||t===`S`;if(n.phase===`select`)return i?{...e,battle:{...n,cursorIndex:(n.cursorIndex+3)%4}}:a?{...e,battle:{...n,cursorIndex:(n.cursorIndex+1)%4}}:r?Ft(e):e;if(!r)return e;if(n.phase===`win`){if(e.pendingBossTilePos){let t=new Set(e.triggeredEvents);return t.add(e.pendingBossTilePos),{...e,battle:null,pendingBossTilePos:null,triggeredEvents:t}}return{...e,battle:null}}return n.phase===`lose`?{...e,pendingDeath:!0}:e}var Lt=.2,Rt={N:{fwd:{x:0,y:-1},left:{x:-1,y:0},right:{x:1,y:0},back:{x:0,y:1}},E:{fwd:{x:1,y:0},left:{x:0,y:-1},right:{x:0,y:1},back:{x:-1,y:0}},S:{fwd:{x:0,y:1},left:{x:1,y:0},right:{x:-1,y:0},back:{x:0,y:-1}},W:{fwd:{x:-1,y:0},left:{x:0,y:1},right:{x:0,y:-1},back:{x:1,y:0}}},zt={N:`W`,W:`S`,S:`E`,E:`N`},Bt={N:`E`,E:`S`,S:`W`,W:`N`};function Vt(e,t,n){return n<0||n>=e.length||t<0||t>=(e[n]?.length??0)?`#`:e[n][t]??`#`}function J(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Ht(e,t){return{x:e.x*t,y:e.y*t}}function Ut(e){for(let t=0;t<e.length;t++){let n=e[t].indexOf(`S`);if(n>=0)return{x:n,y:t}}return{x:1,y:1}}function Wt(e,t,n,r){let i=Tt[e]??Tt.dungeon_01,a=r?.initialPos??Ut(i),o=r?.initialDir??`N`,s=t?.maxHp??20,c=Math.min(s,Math.max(1,t?.hp??s)),l=r?.initialVisited?new Set(r.initialVisited):new Set([`${a.x},${a.y}`]),u=r?.initialTriggeredEvents?new Set(r.initialTriggeredEvents):new Set;return{pos:a,dir:o,map:i,mapId:e,visited:l,atExit:!1,steps:0,playerHp:c,playerMaxHp:s,playerAtk:t?.atk??5,playerDef:t?.def??2,battle:null,inventory:n??[],pendingEvent:null,triggeredEvents:u,pendingDeath:!1,pendingBossTilePos:null}}function Gt(e,t,n,r){let i=e.inventory.indexOf(t);if(i===-1||r?.attackEnemy!==void 0&&!e.battle)return e;let a=[...e.inventory.slice(0,i),...e.inventory.slice(i+1)],o=[`${n}を使った！`],s=e.playerHp;if(r?.healHp===`full`?(s=e.playerMaxHp,o.push(`HPが全回復した！`)):typeof r?.healHp==`number`&&(s=Math.min(e.playerMaxHp,e.playerHp+r.healHp),o.push(`HPが ${r.healHp} 回復した！`)),e.battle&&r?.attackEnemy!==void 0){let t=e.battle.enemy,n=Math.min(r.attackEnemy,t.hp),i=Math.max(0,t.hp-r.attackEnemy);o.push(`${t.name} に ${n} の大ダメージ！`);let c={...t,hp:i};return i<=0?(o.push(`${t.name} を倒した！`),{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,phase:`win`,log:[...e.battle.log,...o]}}):{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,log:[...e.battle.log,...o]}}}if(e.battle){let t=[...e.battle.log,...o];return{...e,inventory:a,playerHp:s,battle:{...e.battle,log:t}}}return{...e,inventory:a,playerHp:s}}var Kt=new Set([`.`,`S`,`X`,`#`]);function qt(e,t){let n=J(e.pos,t),r=Vt(e.map,n.x,n.y);if(r===`#`)return e;let i=`${n.x},${n.y}`,a=new Set(e.visited);a.add(i);let o=r===`X`,s={...e,pos:n,visited:a,atExit:o,steps:e.steps+1};return!o&&r===`B`&&!e.triggeredEvents.has(i)?Nt({...s,pendingBossTilePos:i}):!o&&!Kt.has(r)&&r!==`B`&&!e.triggeredEvents.has(i)?{...s,pendingEvent:r}:!o&&r!==`B`&&Ot[e.mapId]&&Math.random()<Lt?Mt(s):s}function Jt(e){return qt(e,Rt[e.dir].fwd)}function Yt(e){return qt(e,Rt[e.dir].back)}function Xt(e){return{...e,dir:zt[e.dir]}}function Zt(e){return{...e,dir:Bt[e.dir]}}function Qt(e,t){if(e.pendingDeath)return e;if(e.battle)return It(e,t);if(e.pendingEvent!==null||e.atExit)return e;switch(t){case`ArrowUp`:case`w`:case`W`:return Jt(e);case`ArrowDown`:case`s`:case`S`:return Yt(e);case`ArrowLeft`:case`a`:case`A`:return Xt(e);case`ArrowRight`:case`d`:case`D`:return Zt(e);default:return e}}function $t(e,t){let{fwd:n,left:r,right:i}=Rt[e.dir],a=[!1],o=[!1],s=[!1];for(let c=1;c<=t;c++){let t=J(e.pos,Ht(n,c));a.push(Vt(e.map,t.x,t.y)===`#`);let l=J(e.pos,Ht(n,c-1));o.push(Vt(e.map,J(l,r).x,J(l,r).y)===`#`),s.push(Vt(e.map,J(l,i).x,J(l,i).y)===`#`)}return{front:a,left:o,right:s}}var en=480,Y=320,tn=4,nn=[[0,0,480,320],[60,40,420,280],[120,80,360,240],[172,110,308,210],[207,128,273,192]],rn=[1,1,.78,.56,.38];function an(e,t,n,r){return`rgb(${Math.round(e*r)},${Math.round(t*r)},${Math.round(n*r)})`}function on(e){let t=parseInt(e.replace(`#`,``),16);return[t>>16&255,t>>8&255,t&255]}function sn(e,t,n){let{front:r,left:i,right:a}=$t(t,tn),[o,s,c]=on(n.wallFront),[l,u,d]=on(n.wallSide),f=e.createLinearGradient(0,0,0,Y/2);f.addColorStop(0,n.ceilTop),f.addColorStop(1,n.ceilBottom),e.fillStyle=f,e.fillRect(0,0,en,Y/2);let p=e.createLinearGradient(0,Y/2,0,Y);p.addColorStop(0,n.floorTop),p.addColorStop(1,n.floorBottom),e.fillStyle=p,e.fillRect(0,Y/2,en,Y/2);let m=tn;for(let e=1;e<=tn;e++)if(r[e]){m=e;break}for(let t=m;t>=1;t--){let n=rn[t]??.3,[f,p,m,h]=nn[t],[g,_,v,y]=nn[t-1];if(r[t]){e.fillStyle=an(o,s,c,n),e.fillRect(f,p,m-f,h-p),e.strokeStyle=`rgba(0,0,0,0.45)`,e.lineWidth=1;let t=Math.max(8,Math.floor((h-p)/3));for(let n=p+t;n<h;n+=t)e.beginPath(),e.moveTo(f,n),e.lineTo(m,n),e.stroke();let r=Math.floor((h-p)/t);for(let n=0;n<r;n++){let r=n%2*Math.floor((m-f)/4),i=Math.max(6,Math.floor((m-f)/3));for(let a=f+r;a<m;a+=i)e.beginPath(),e.moveTo(a,p+n*t),e.lineTo(a,p+(n+1)*t),e.stroke()}}i[t]&&(e.fillStyle=an(l,u,d,n),e.beginPath(),e.moveTo(g,_),e.lineTo(f,p),e.lineTo(f,h),e.lineTo(g,y),e.closePath(),e.fill(),e.strokeStyle=an(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(f,p),e.lineTo(f,h),e.stroke()),a[t]&&(e.fillStyle=an(l,u,d,n),e.beginPath(),e.moveTo(m,p),e.lineTo(v,_),e.lineTo(v,y),e.lineTo(m,h),e.closePath(),e.fill(),e.strokeStyle=an(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(m,p),e.lineTo(m,h),e.stroke())}if(!r[m]&&m===tn){let[t,r,i,a]=nn[tn];e.fillStyle=n.ceilTop,e.fillRect(t,r,i-t,a-r)}}var cn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function ln({state:e,theme:t}){let n=(0,a.useRef)(null),r=t??cn;return(0,a.useEffect)(()=>{let t=n.current?.getContext(`2d`);t&&sn(t,e,r)},[e,r]),(0,F.jsx)(`canvas`,{ref:n,width:en,height:Y,style:{display:`block`,imageRendering:`pixelated`}})}var X=10,un=3,dn={N:[[0,-5],[-4,4],[4,4]],E:[[5,0],[-4,-4],[-4,4]],S:[[0,5],[-4,-4],[4,-4]],W:[[-5,0],[4,-4],[4,4]]};function fn({state:e}){let t=(0,a.useRef)(null),n=e.map[0]?.length??0,r=e.map.length,i=n*X+un*2,o=r*X+un*2;return(0,a.useEffect)(()=>{let a=t.current?.getContext(`2d`);if(!a)return;a.clearRect(0,0,i,o),a.fillStyle=`#0a0a0a`,a.fillRect(0,0,i,o);for(let t=0;t<r;t++)for(let r=0;r<n;r++){let n=e.map[t]?.[r]??`#`,i=`${r},${t}`,o=e.visited.has(i),s=un+r*X,c=un+t*X;n===`#`?(a.fillStyle=o?`#554433`:`#2a1a0a`,a.fillRect(s,c,X,X)):(a.fillStyle=o?`#443322`:`#110a04`,a.fillRect(s,c,X,X),n===`X`&&(a.fillStyle=`#33bb55`,a.fillRect(s+2,c+2,X-4,X-4)))}let s=un+e.pos.x*X+X/2,c=un+e.pos.y*X+X/2,l=dn[e.dir]??dn.N;a.fillStyle=`#ffdd00`,a.beginPath(),a.moveTo(s+l[0][0],c+l[0][1]),a.lineTo(s+l[1][0],c+l[1][1]),a.lineTo(s+l[2][0],c+l[2][1]),a.closePath(),a.fill()},[e,i,o,r,n]),(0,F.jsx)(`canvas`,{ref:t,width:i,height:o,style:{display:`block`,imageRendering:`pixelated`}})}var pn=[`攻撃`,`防御`,`アイテム`,`逃げる`];function mn({hp:e,maxHp:t,color:n}){return(0,F.jsx)(`div`,{style:{height:8,background:`#2a2020`,borderRadius:4,overflow:`hidden`},children:(0,F.jsx)(`div`,{style:{width:`${Math.max(0,Math.min(1,t>0?e/t:0))*100}%`,height:`100%`,background:n,transition:`width 0.2s`,borderRadius:4}})})}function hn({label:e,active:t,font:n,theme:r,onHover:i,onClick:o}){let[s,c]=(0,a.useState)(!1),l=t||s;return(0,F.jsx)(`div`,{onMouseEnter:()=>{c(!0),i()},onMouseLeave:()=>c(!1),onClick:o,style:{flex:1,fontSize:13,padding:`8px 0`,background:l?r.uiBorder:`#1a1008`,color:r.uiAccent,border:`1px solid ${l?r.uiAccent:r.uiBorder}`,borderRadius:3,cursor:`pointer`,userSelect:`none`,textAlign:`center`,fontFamily:n,transition:`background 0.1s, border-color 0.1s`},children:e})}function gn({state:e,theme:t,onSelectCommand:n,onCommand:r,font:i}){let{battle:a}=e;if(!a)return null;let o=a.log.at(-1);return(0,F.jsxs)(`div`,{style:{width:`100%`,display:`flex`,flexDirection:`column`,gap:8,flexShrink:0,fontFamily:i},children:[(0,F.jsxs)(`div`,{children:[(0,F.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:t.uiAccent},children:[(0,F.jsx)(`span`,{children:a.enemy.name}),(0,F.jsxs)(`span`,{style:{opacity:.65},children:[`HP `,a.enemy.hp,`/`,a.enemy.maxHp]})]}),(0,F.jsx)(mn,{hp:a.enemy.hp,maxHp:a.enemy.maxHp,color:`#e05050`})]}),a.phase===`select`?(0,F.jsx)(`div`,{style:{display:`flex`,gap:6},children:pn.map((e,o)=>(0,F.jsx)(hn,{label:e,active:a.cursorIndex===o,font:i,theme:t,onHover:()=>n?.(o),onClick:()=>{n?.(o),r?.(o)}},e))}):a.phase===`win`?(0,F.jsx)(`div`,{style:{fontSize:12,color:`#d8b8ff`,opacity:.95,userSelect:`none`,textShadow:`0 0 8px rgba(180,120,255,0.65)`},children:`撃破！`}):(0,F.jsx)(`div`,{style:{fontSize:12,color:`#ff9090`,opacity:.95,userSelect:`none`},children:`倒れてしまった……`}),(0,F.jsxs)(`div`,{style:{borderTop:`1px solid ${t.uiBorder}`,paddingTop:6},children:[o&&(0,F.jsx)(`div`,{style:{fontSize:13,lineHeight:1.5,marginBottom:5,color:`#f3dfaa`,textShadow:`0 0 6px rgba(204,170,102,0.35)`},children:o}),(0,F.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2,maxHeight:74,overflow:`hidden`,background:`rgba(0,0,0,0.18)`,border:`1px solid ${t.uiBorder}`,borderRadius:3,padding:`5px 6px`},children:a.log.slice(-5).map((e,t,n)=>(0,F.jsx)(`div`,{style:{fontSize:11,lineHeight:1.35,opacity:.36+(t+1)/n.length*.5},children:e},`${e}-${t}`))})]})]})}function _n({enemy:e,assetsBaseUrl:t,defeated:n=!1,onClick:r}){let i=e.maxHp>0?e.hp/e.maxHp:1,a=.4+i*.6,o=`${t}/enemies/${e.id}.png`,s=e.id===`maze_boss`;return(0,F.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,pointerEvents:`none`},children:[(0,F.jsx)(`div`,{style:{position:`absolute`,width:s?380:250,height:s?340:220,borderRadius:`50%`,background:s?`radial-gradient(circle, rgba(80,0,0,0.80) 0%, rgba(0,0,0,0.60) 40%, transparent 70%)`:`radial-gradient(circle, rgba(0,0,0,0.70) 0%, transparent 68%)`}}),(0,F.jsx)(`img`,{src:o,alt:e.name,style:{position:`relative`,maxHeight:s?280:180,maxWidth:s?300:220,objectFit:`contain`,opacity:a,transition:`opacity 0.5s, transform 0.45s, filter 0.45s`,imageRendering:`pixelated`,transform:n?`scale(1.18) rotate(-3deg)`:void 0,pointerEvents:r&&!n?`auto`:`none`,cursor:r&&!n?`crosshair`:`default`,filter:n?`brightness(2.3) saturate(0) blur(2px) drop-shadow(0 0 28px rgba(220,180,255,0.95))`:s?`drop-shadow(0 0 18px rgba(200,0,0,${.3+i*.5}))`:void 0},title:r&&!n?`${e.name}を攻撃`:void 0,onClick:r,onError:e=>{e.target.style.display=`none`}}),n&&(0,F.jsx)(`div`,{style:{position:`absolute`,width:s?360:250,height:s?300:210,borderRadius:`50%`,background:`radial-gradient(circle, rgba(255,255,255,0.95) 0%, rgba(180,120,255,0.5) 26%, transparent 68%)`,mixBlendMode:`screen`,animation:`maze-enemy-burst 650ms ease-out forwards`}})]})}function vn(e){if(!e)return`迷路内で特別な効果はない`;let t=[];return e.healHp===`full`?t.push(`HP全回復`):typeof e.healHp==`number`&&t.push(`HP+${e.healHp}`),typeof e.attackEnemy==`number`&&t.push(`敵に${e.attackEnemy}ダメージ`),t.length>0?t.join(` / `):`迷路内で特別な効果はない`}function yn(e){switch(e){case`key_item`:return`大事なもの`;case`consumable`:return`消耗品`;case`tool`:return`道具`;case`misc`:return`その他`;default:return`アイテム`}}function bn(e,t,n){return e?.usable?n===`explore`&&t?.attackEnemy!==void 0?{canUse:!1,reason:`戦闘中のみ使用可`}:n===`battle`&&!t?.healHp&&t?.attackEnemy===void 0?{canUse:!1,reason:`戦闘中は効果なし`}:{canUse:!0,reason:`使用可能`}:{canUse:!1,reason:`使用できない`}}function xn({name:e,selected:t,usable:n,count:r,theme:i,font:a,onSelect:o}){return(0,F.jsxs)(`button`,{type:`button`,onClick:o,style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,width:`100%`,fontSize:12,padding:`5px 8px`,borderRadius:3,cursor:`pointer`,background:t?i.uiBorder:`transparent`,border:`1px solid ${t?i.uiAccent:i.uiBorder}`,color:n?i.uiAccent:i.uiBorder,opacity:n?1:.55,fontFamily:a,userSelect:`none`,transition:`background 0.12s, border-color 0.12s`},children:[(0,F.jsx)(`span`,{style:{overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:e}),(0,F.jsx)(`span`,{style:{fontSize:10,opacity:.6},children:r>1?`x${r}`:``})]})}function Sn({inventory:e,itemDefs:t,theme:n,mode:r,itemEffects:i,selectedItemId:a,onSelect:o,onUse:s,notification:c,font:l}){let u=new Map(t.map(e=>[e.id,e])),d=new Map;for(let t of e)d.set(t,(d.get(t)??0)+1);let f=[...d.keys()],p=a&&d.has(a)?a:null,m=p?u.get(p):void 0,h=m?.name??p??``,g=p?i?.[p]:void 0,_=bn(m,g,r);return(0,F.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:5,minHeight:0,flex:1},children:[(0,F.jsxs)(`div`,{style:{borderTop:`1px solid ${n.uiBorder}`,paddingTop:8,fontSize:10,color:n.uiBorder,letterSpacing:`0.08em`,fontFamily:l},children:[`アイテム`,(0,F.jsx)(`span`,{style:{marginLeft:8,color:n.uiAccent,opacity:.7},children:r===`battle`?`戦闘中`:`探索中`})]}),c&&(0,F.jsx)(`div`,{style:{fontSize:11,color:n.uiAccent,padding:`3px 6px`,background:`${n.uiBorder}55`,borderRadius:3,fontFamily:l},children:c}),f.length===0?(0,F.jsx)(`div`,{style:{fontSize:11,color:n.uiBorder,opacity:.4,padding:`2px 4px`,fontFamily:l},children:`持ち物なし`}):(0,F.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2,maxHeight:96,overflow:`auto`,paddingRight:2},children:f.map(e=>{let t=u.get(e),a=i?.[e],s=bn(t,a,r);return(0,F.jsx)(xn,{name:t?.name??e,selected:p===e,usable:s.canUse,count:d.get(e)??1,theme:n,font:l,onSelect:()=>o(e)},e)})}),(0,F.jsx)(`div`,{style:{minHeight:118,border:`1px solid ${n.uiBorder}`,borderRadius:3,background:`rgba(0,0,0,0.18)`,padding:`7px 8px`,fontFamily:l,display:`flex`,flexDirection:`column`,gap:5},children:p?(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,gap:8,alignItems:`baseline`},children:[(0,F.jsx)(`strong`,{style:{color:n.uiAccent,fontSize:13,fontWeight:700},children:h}),(0,F.jsxs)(`span`,{style:{color:n.uiBorder,fontSize:10,whiteSpace:`nowrap`},children:[yn(m?.category),` `,d.get(p)>1?`x${d.get(p)}`:``]})]}),(0,F.jsx)(`div`,{style:{color:`#e8d5aa`,fontSize:11,lineHeight:1.45,minHeight:31},children:m?.description??`説明はない。`}),(0,F.jsxs)(`div`,{style:{color:n.uiAccent,fontSize:11,opacity:.85},children:[`効果: `,vn(g)]}),(0,F.jsxs)(`div`,{style:{display:`flex`,gap:6,alignItems:`center`,marginTop:`auto`},children:[(0,F.jsx)(`button`,{type:`button`,disabled:!_.canUse,onClick:()=>s(p,h),style:{flex:`0 0 76px`,padding:`6px 0`,borderRadius:3,border:`1px solid ${_.canUse?n.uiAccent:n.uiBorder}`,background:_.canUse?n.uiBorder:`transparent`,color:_.canUse?n.uiAccent:n.uiBorder,cursor:_.canUse?`pointer`:`default`,fontFamily:l,fontSize:12},children:`使う`}),(0,F.jsx)(`span`,{style:{color:_.canUse?n.uiAccent:n.uiBorder,fontSize:10,opacity:.8},children:_.reason})]})]}):(0,F.jsx)(`div`,{style:{color:n.uiBorder,opacity:.55,fontSize:11,lineHeight:1.5},children:`アイテムを選ぶと、説明と効果を確認できます。`})})]})}var Cn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function wn(e){return e?{...Cn,...e}:Cn}var Tn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,En={N:`北`,E:`東`,S:`南`,W:`西`};function Dn(){let e=()=>Math.min(1,Math.min(window.innerWidth/800,window.innerHeight/600)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function On(e,t,n,r){let i=r&&n?n:t;(0,a.useEffect)(()=>{if(!i)return;let t=`${e.replace(/\/$/,``)}/${i}`,n=new Audio(t);return n.loop=!0,n.volume=.6,n.play().catch(()=>{}),()=>{n.pause(),n.currentTime=0}},[i,e])}function kn({hp:e,maxHp:t,theme:n}){let r=Math.max(0,Math.min(1,t>0?e/t:0)),i=r>.5?`#50c050`:r>.25?`#c0a020`:`#e03030`;return(0,F.jsxs)(`div`,{children:[(0,F.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:n.uiAccent},children:[(0,F.jsx)(`span`,{style:{letterSpacing:`0.06em`},children:`HP`}),(0,F.jsxs)(`span`,{style:{opacity:.8},children:[e,` / `,t]})]}),(0,F.jsx)(`div`,{style:{height:6,background:`#2a2020`,borderRadius:3,overflow:`hidden`},children:(0,F.jsx)(`div`,{style:{width:`${r*100}%`,height:`100%`,background:i,transition:`width 0.3s`,borderRadius:3}})})]})}function An({label:e,theme:t,onClick:n}){let[r,i]=(0,a.useState)(!1);return(0,F.jsx)(`button`,{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),onClick:n,style:{flex:1,background:r?t.uiBorder:`#1a1008`,border:`1px solid ${r?t.uiAccent:t.uiBorder}`,color:t.uiAccent,fontFamily:Tn,fontSize:12,padding:`8px 4px`,cursor:`pointer`,borderRadius:3,userSelect:`none`,textAlign:`center`,transition:`background 0.1s, border-color 0.1s`},children:e})}function jn({context:e,config:t,onExit:n}){let r=Dn(),[i,o]=(0,a.useState)(()=>Wt(t.map,e.playerStats,e.inventory,{initialPos:t.initialPos,initialDir:t.initialDir,initialVisited:t.initialVisited,initialTriggeredEvents:t.initialTriggeredEvents})),s=wn(t.theme),c=t.assetsBaseUrl??`/assets`;On(c,t.bgm,t.battleBgm,!!i.battle);let[l,u]=(0,a.useState)(`explore`),[d,f]=(0,a.useState)(null),[p,m]=(0,a.useState)(null),[h,g]=(0,a.useState)(!1),[_,v]=(0,a.useState)(!1),y=(0,a.useRef)(null),b=(0,a.useRef)(i.battle),x=(0,a.useCallback)(e=>{o(t=>Qt(t,e))},[]),S=(0,a.useCallback)(()=>{!i.battle||i.battle.phase!==`select`||(g(!0),window.setTimeout(()=>g(!1),180),o(e=>!e.battle||e.battle.phase!==`select`?e:Qt({...e,battle:{...e.battle,cursorIndex:0}},`Enter`)))},[i.battle]),C=(0,a.useCallback)((e,n)=>{let r=t.itemEffects?.[e];r?.attackEnemy!==void 0&&!i.battle||(o(t=>Gt(t,e,n,r)),f(null),i.battle||(y.current&&clearTimeout(y.current),m(r?.healHp===`full`?`${n}を使った！ HP全回復！`:typeof r?.healHp==`number`?`${n}を使った！ HP+${r.healHp}！`:`${n}を使った！`),y.current=setTimeout(()=>m(null),2500)))},[t.itemEffects,i.battle]);(0,a.useEffect)(()=>{let e=e=>{[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Enter`,` `].includes(e.key)&&e.preventDefault();let t=e.key===`Enter`||e.key===` `;o(n=>n.battle?.phase===`select`&&n.battle.cursorIndex===2&&t?(u(`battle`),n):Qt(n,e.key))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[]),(0,a.useEffect)(()=>{i.battle||u(`explore`),(!i.battle||i.battle.phase!==`select`)&&f(null)},[i.battle]),(0,a.useEffect)(()=>{d&&!i.inventory.includes(d)&&f(null)},[d,i.inventory]),(0,a.useEffect)(()=>{let e=b.current,t=i.battle;if(t?.phase===`win`&&e?.phase!==`win`){v(!0);let e=window.setTimeout(()=>v(!1),900);return b.current=t,()=>window.clearTimeout(e)}(!t||t.phase===`select`)&&v(!1),b.current=t},[i.battle]),(0,a.useEffect)(()=>{if(i.battle?.phase!==`win`&&i.battle?.phase!==`lose`)return;let e=i.battle.phase===`win`?850:1050,t=window.setTimeout(()=>{o(e=>e.battle?.phase!==`win`&&e.battle?.phase!==`lose`?e:Qt(e,`Enter`))},e);return()=>window.clearTimeout(t)},[i.battle?.phase]);let w=(0,a.useCallback)(()=>({...e,flags:{...e.flags,[`explored_${t.map}`]:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}}),[e,t.map,i.inventory,i.playerHp,i.playerMaxHp,i.playerAtk,i.playerDef]),T=(0,a.useCallback)(()=>{let e=w(),r={...e,playerStats:{...e.playerStats,hp:i.playerMaxHp}},a=t._novelReturn;a?.exitSceneId?n(r,{engineId:`novel`,config:{...a,initialSceneId:a.exitSceneId,autoStart:!0}}):n(r)},[w,t._novelReturn,n,i.playerMaxHp]);(0,a.useEffect)(()=>{if(!i.pendingDeath)return;let r=t._novelReturn;if(r){if(i.pendingBossTilePos&&r.gameoverBossSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0,flag_boss_challenged:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},[o,s]=i.pendingBossTilePos.split(`,`).map(Number),c={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn,initialPos:{x:(o??0)-1,y:s??0},initialDir:`E`,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverBossSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:c,returnTransition:`rift`})}else if(r.gameoverSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},o={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:o,returnTransition:`rift`})}}},[i.pendingDeath]),(0,a.useEffect)(()=>{if(!i.pendingEvent)return;let e=t.events?.[i.pendingEvent],r=t._novelReturn;if(!e||!r)return;let a=w(),o=`${i.pos.x},${i.pos.y}`,s={...t,initialPos:i.pos,initialDir:i.dir,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents,o]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:e,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:s,returnTransition:`rift`})},[i.pendingEvent]);let E=(0,a.useCallback)(e=>{i.atExit&&(e.key!==`Enter`&&e.key!==` `||T())},[i.atExit,T]);return(0,a.useEffect)(()=>(window.addEventListener(`keydown`,E),()=>window.removeEventListener(`keydown`,E)),[E]),(0,F.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:s.uiBg,overflow:`hidden`},children:(0,F.jsxs)(`div`,{style:{width:800,height:600,flexShrink:0,transformOrigin:`center center`,transform:`scale(${r})`,background:s.uiBg,display:`flex`,flexDirection:`column`,fontFamily:Tn,color:s.uiAccent,userSelect:`none`,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`},children:[(0,F.jsx)(`style`,{children:`
        ...
        `}),(0,F.jsxs)(`div`,{style:{background:s.uiBorder,borderBottom:`1px solid ${s.uiBorder}`,padding:`4px 12px`,fontSize:13,display:`flex`,justifyContent:`space-between`,alignItems:`center`,flexShrink:0,letterSpacing:`0.06em`},children:[(0,F.jsxs)(`span`,{children:[`⚔ `,t.name??t.map]}),(0,F.jsxs)(`span`,{style:{fontSize:11,opacity:.7},children:[`歩数: `,i.steps]})]}),(0,F.jsxs)(`div`,{style:{display:`flex`,flex:1,overflow:`hidden`},children:[(0,F.jsx)(`div`,{style:{flex:`0 0 488px`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,F.jsxs)(`div`,{style:{position:`relative`},children:[(0,F.jsxs)(`div`,{style:{border:`2px solid ${s.uiBorder}`,boxShadow:`0 0 12px rgba(100,60,10,0.4)`,position:`relative`},children:[(0,F.jsx)(ln,{state:i,theme:s}),i.battle&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(_n,{enemy:i.battle.enemy,assetsBaseUrl:c,defeated:_||i.battle.phase===`win`,onClick:i.battle.phase===`select`?S:void 0}),h&&(0,F.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`45%`,width:240,height:18,borderRadius:10,background:`linear-gradient(90deg, transparent, rgba(255,255,255,0.98), rgba(180,90,255,0.7), transparent)`,boxShadow:`0 0 18px rgba(220,180,255,0.9)`,pointerEvents:`none`,animation:`maze-hit-slash 180ms ease-out forwards`}})]}),!i.battle&&!i.atExit&&(0,F.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`grid`,gridTemplateColumns:`1fr 2fr 1fr`,gridTemplateRows:`1fr 1fr`},children:[(0,F.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>x(`ArrowLeft`)}),(0,F.jsx)(`div`,{title:`前進`,style:{cursor:`n-resize`},onClick:()=>x(`ArrowUp`)}),(0,F.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>x(`ArrowRight`)}),(0,F.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>x(`ArrowLeft`)}),(0,F.jsx)(`div`,{title:`後退`,style:{cursor:`s-resize`},onClick:()=>x(`ArrowDown`)}),(0,F.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>x(`ArrowRight`)})]})]}),i.atExit&&(0,F.jsx)(`div`,{onClick:T,style:{marginTop:8,background:`#1a2a0a`,border:`1px solid #44aa22`,borderRadius:4,padding:`8px 16px`,color:`#88ff44`,fontSize:14,textAlign:`center`,cursor:`pointer`,fontFamily:Tn,letterSpacing:`0.04em`},children:`階段を見つけた！ [Enter] / クリックで地上へ戻る`})]})}),(0,F.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,borderLeft:`1px solid ${s.uiBorder}`,padding:`10px 10px 8px`,gap:8,overflow:`hidden`},children:[(0,F.jsx)(kn,{hp:i.playerHp,maxHp:i.playerMaxHp,theme:s}),(0,F.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),(0,F.jsxs)(`div`,{style:{display:`flex`,gap:10,alignItems:`flex-start`,justifyContent:`center`},children:[(0,F.jsx)(`div`,{style:{border:`1px solid ${s.uiBorder}`},children:(0,F.jsx)(fn,{state:i})}),(0,F.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:4},children:[(0,F.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`24px 24px 24px`,gridTemplateRows:`24px 24px 24px`,gap:2,textAlign:`center`},children:[[``,`N`,``].map((e,t)=>(0,F.jsx)(Mn,{label:e,dir:i.dir,theme:s},`t${t}`)),[`W`,``,`E`].map((e,t)=>(0,F.jsx)(Mn,{label:e,dir:i.dir,theme:s},`m${t}`)),[``,`S`,``].map((e,t)=>(0,F.jsx)(Mn,{label:e,dir:i.dir,theme:s},`b${t}`))]}),(0,F.jsx)(`div`,{style:{fontSize:11,color:s.uiAccent,letterSpacing:`0.05em`},children:En[i.dir]}),(0,F.jsxs)(`div`,{style:{fontSize:9,color:s.uiBorder,letterSpacing:`0.04em`},children:[`(`,i.pos.x,`,`,i.pos.y,`)`]})]})]}),(0,F.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),i.battle?(0,F.jsx)(gn,{state:i,theme:s,font:Tn,onSelectCommand:e=>o(t=>!t.battle||t.battle.phase!==`select`?t:{...t,battle:{...t.battle,cursorIndex:e}}),onCommand:e=>{if(e===2){u(`battle`);return}u(`explore`),o(t=>!t.battle||t.battle.phase!==`select`?t:Qt({...t,battle:{...t.battle,cursorIndex:e}},`Enter`))}}):(0,F.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,F.jsx)(`div`,{style:{display:`flex`},children:(0,F.jsx)(An,{label:`↑ 前進`,theme:s,onClick:()=>x(`ArrowUp`)})}),(0,F.jsxs)(`div`,{style:{display:`flex`,gap:4},children:[(0,F.jsx)(An,{label:`← 左`,theme:s,onClick:()=>x(`ArrowLeft`)}),(0,F.jsx)(An,{label:`↓ 後退`,theme:s,onClick:()=>x(`ArrowDown`)}),(0,F.jsx)(An,{label:`→ 右`,theme:s,onClick:()=>x(`ArrowRight`)})]})]}),(0,F.jsx)(Sn,{inventory:i.inventory,itemDefs:t.items??[],theme:s,mode:i.battle?l:`explore`,itemEffects:t.itemEffects,selectedItemId:d,onSelect:f,onUse:C,notification:p??void 0,font:Tn})]})]})]})})}function Mn({label:e,dir:t,theme:n}){let r=e===t;return(0,F.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,background:r?n.uiBorder:e?n.uiBg:`transparent`,border:e?`1px solid ${r?n.uiAccent:n.uiBorder}`:`none`,borderRadius:2,color:r?n.uiAccent:n.uiBorder,fontWeight:r?`bold`:`normal`,fontSize:10,fontFamily:Tn},children:e})}var Nn={component:jn},Z=800,Pn=600,Fn=50,In=Pn-Fn*2,Q=Fn+In-50,$=150,Ln=42,Rn=72,zn=.0017,Bn=-.82,Vn=3e4,Hn=420,Un=100,Wn=.0048,Gn=18,Kn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,qn=[{id:`candy_01`,type:`candy`,spawnMs:1600,laneY:356,speed:.34,size:28},{id:`pot_01`,type:`pot`,spawnMs:3300,laneY:395,speed:.38,size:46},{id:`candy_02`,type:`candy`,spawnMs:4700,laneY:318,speed:.37,size:28},{id:`candy_03`,type:`candy`,spawnMs:6600,laneY:392,speed:.42,size:30},{id:`pot_02`,type:`pot`,spawnMs:8200,laneY:342,speed:.43,size:48},{id:`candy_04`,type:`candy`,spawnMs:1e4,laneY:360,speed:.46,size:28},{id:`candy_05`,type:`candy`,spawnMs:11800,laneY:302,speed:.42,size:30},{id:`pot_03`,type:`pot`,spawnMs:13700,laneY:400,speed:.48,size:50},{id:`candy_06`,type:`candy`,spawnMs:15400,laneY:340,speed:.48,size:30},{id:`candy_07`,type:`candy`,spawnMs:17600,laneY:388,speed:.52,size:28},{id:`pot_04`,type:`pot`,spawnMs:19600,laneY:330,speed:.52,size:50},{id:`candy_08`,type:`candy`,spawnMs:21500,laneY:358,speed:.55,size:30},{id:`candy_09`,type:`candy`,spawnMs:23800,laneY:305,speed:.5,size:28},{id:`pot_05`,type:`pot`,spawnMs:26e3,laneY:390,speed:.56,size:52},{id:`candy_10`,type:`candy`,spawnMs:27800,laneY:346,speed:.58,size:30}],Jn=[{id:`dog_01`,type:`dog`,spawnMs:1800,laneY:392,speed:.42,size:48},{id:`bird_01`,type:`bird`,spawnMs:3800,laneY:300,speed:.46,size:42},{id:`dog_02`,type:`dog`,spawnMs:6200,laneY:394,speed:.5,size:50},{id:`bird_02`,type:`bird`,spawnMs:8400,laneY:292,speed:.52,size:44},{id:`dog_03`,type:`dog`,spawnMs:11100,laneY:396,speed:.56,size:52},{id:`bird_03`,type:`bird`,spawnMs:13600,laneY:306,speed:.58,size:42},{id:`dog_04`,type:`dog`,spawnMs:16400,laneY:390,speed:.62,size:52},{id:`bird_04`,type:`bird`,spawnMs:19e3,laneY:298,speed:.64,size:44}],Yn={sky:`#151827`,ground:`#2a2d32`,accent:`#f2d16b`};function Xn(e){return{...Yn,...e}}function Zn(){let e=()=>Math.min(1,Math.min(window.innerWidth/Z,window.innerHeight/Pn)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function Qn(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function $n(e){let[t,n]=(0,a.useState)(null),[r,i]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{if(!e){n(null),i(!1);return}let t=!1,r=new Image;return r.onload=()=>{t||(n(r),i(!1))},r.onerror=()=>{t||(n(null),i(!0))},r.src=e,()=>{t=!0}},[e]),{image:t,failed:r}}function er(e,t,n=.28){(0,a.useEffect)(()=>{let r,i=Math.max(0,Math.min(1,n));if(t?.startsWith(`synth:`))return r=tr(i),()=>r?.();if(t){let n=new Audio(Qn(e,t));return n.loop=!0,n.volume=i,n.play().catch(()=>{}),r=()=>{n.pause(),n.currentTime=0},()=>r?.()}},[e,t,n])}function tr(e){let t=window.AudioContext??window.webkitAudioContext;if(!t)return()=>{};let n=new t,r=n.createGain();r.gain.value=e,r.connect(n.destination);let i=n.createDelay();i.delayTime.value=.18;let a=n.createGain();a.gain.value=.18,i.connect(a),a.connect(i),i.connect(r);let o=[392,523.25,659.25,783.99,659.25,523.25,440,587.33],s=0,c=!1,l=()=>{if(c)return;let e=n.currentTime,t=n.createOscillator(),a=n.createGain();t.type=s%4==0?`square`:`triangle`,t.frequency.setValueAtTime(o[s%o.length],e),a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.24,e+.018),a.gain.exponentialRampToValueAtTime(1e-4,e+.16),t.connect(a),a.connect(r),a.connect(i),t.start(e),t.stop(e+.18),s+=1};n.resume().catch(()=>{}),l();let u=window.setInterval(l,135);return()=>{c=!0,window.clearInterval(u),n.close().catch(()=>{})}}function nr(e,t,n=1){return Z+80-Math.max(0,t-e.spawnMs)*e.speed*n}function rr(e){return e.type===`dog`?Q-e.size:e.laneY}function ir(e,t){return e.x<t.x+t.width&&e.x+e.width>t.x&&e.y<t.y+t.height&&e.y+e.height>t.y}function ar(e,t){let n=e.y-(Q-Rn);return Q-t+n}function or(e,t,n,r,i){let a=Math.sin(i*.012)*4;e.save(),e.translate(t+r/2,n+r/2),e.rotate(Math.sin(i*.008)*.4),e.fillStyle=`#ff7aa8`,e.beginPath(),e.ellipse(0,0,r*.42,r*.3,0,0,Math.PI*2),e.fill(),e.fillStyle=`#fff1b8`,e.fillRect(-r*.14,-r*.28+a*.03,r*.28,r*.56),e.fillStyle=`#ffd6e5`,e.beginPath(),e.moveTo(-r*.38,0),e.lineTo(-r*.62,-r*.2),e.lineTo(-r*.62,r*.2),e.closePath(),e.fill(),e.beginPath(),e.moveTo(r*.38,0),e.lineTo(r*.62,-r*.2),e.lineTo(r*.62,r*.2),e.closePath(),e.fill(),e.restore()}function sr(e,t,n,r,i){e.save(),e.translate(t+r/2,n+r/2),e.rotate(i*.012),e.fillStyle=`#59606b`,e.beginPath(),e.roundRect(-r*.42,-r*.25,r*.84,r*.58,r*.12),e.fill(),e.strokeStyle=`#d5dde8`,e.lineWidth=4,e.beginPath(),e.arc(0,-r*.32,r*.28,Math.PI,Math.PI*2),e.stroke(),e.strokeStyle=`#2c3139`,e.lineWidth=5,e.beginPath(),e.moveTo(-r*.5,-r*.08),e.lineTo(-r*.7,-r*.08),e.moveTo(r*.5,-r*.08),e.lineTo(r*.7,-r*.08),e.stroke(),e.restore()}function cr(e,t,n,r,i){let a=Math.sin(i*.02)*3;e.save(),e.translate(t,n),e.fillStyle=`#8b5a3c`,e.fillRect(r*.16,r*.34,r*.58,r*.3),e.fillStyle=`#a46a45`,e.beginPath(),e.arc(r*.74,r*.36,r*.18,0,Math.PI*2),e.fill(),e.fillStyle=`#5b3928`,e.beginPath(),e.moveTo(r*.68,r*.22),e.lineTo(r*.78,r*.02),e.lineTo(r*.84,r*.26),e.closePath(),e.fill(),e.strokeStyle=`#5b3928`,e.lineWidth=4,e.beginPath(),e.moveTo(r*.15,r*.38),e.quadraticCurveTo(-r*.05,r*.18,r*.1,r*.08),e.stroke(),e.fillStyle=`#3b2319`,e.fillRect(r*.24,r*.62,r*.1,r*.24+a),e.fillRect(r*.56,r*.62,r*.1,r*.24-a),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.8,r*.34,2.5,0,Math.PI*2),e.fill(),e.restore()}function lr(e,t,n,r,i){let a=Math.sin(i*.024)*r*.16;e.save(),e.translate(t+r/2,n+r/2),e.fillStyle=`#3f78a8`,e.beginPath(),e.ellipse(0,0,r*.28,r*.2,0,0,Math.PI*2),e.fill(),e.fillStyle=`#72b7d2`,e.beginPath(),e.moveTo(-r*.08,-r*.06),e.quadraticCurveTo(-r*.44,-r*.36-a,-r*.5,r*.02),e.quadraticCurveTo(-r*.26,r*.06,-r*.08,r*.04),e.fill(),e.beginPath(),e.moveTo(r*.08,-r*.06),e.quadraticCurveTo(r*.44,-r*.36+a,r*.5,r*.02),e.quadraticCurveTo(r*.26,r*.06,r*.08,r*.04),e.fill(),e.fillStyle=`#f2d16b`,e.beginPath(),e.moveTo(r*.28,-r*.02),e.lineTo(r*.44,r*.04),e.lineTo(r*.28,r*.1),e.closePath(),e.fill(),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.16,-r*.06,2.4,0,Math.PI*2),e.fill(),e.restore()}function ur(e,t,n){let r=Math.min(650,$+95+t*3.6),i=Q-74+Math.sin(n*.02)*3;e.save(),e.translate(r,i),e.fillStyle=`#f1d2b0`,e.fillRect(13,0,24,22),e.fillStyle=`#2b2f39`,e.fillRect(8,20,34,36),e.fillStyle=`#e6533f`,e.fillRect(4,28,42,10),e.fillStyle=`#151827`,e.fillRect(12,54,10,24),e.fillRect(30,54,10,24),e.fillStyle=`#f2d16b`,e.fillRect(17,8,4,4),e.fillRect(29,8,4,4),e.restore()}function dr(e,t,n,r){t.type===`candy`?or(e,n,rr(t),t.size,r):t.type===`pot`?sr(e,n,rr(t),t.size,r):t.type===`dog`?cr(e,n,rr(t),t.size,r):lr(e,n,rr(t),t.size,r)}function fr(e,t,n,r,i){let a=Math.min(1,t.elapsedMs/n.durationMs),o=n.mode===`chase`,s=o?Jn:qn,c=t.worldElapsedMs*.18,l=t.elapsedMs<t.penaltyUntilMs;if(e.fillStyle=`#000`,e.fillRect(0,0,Z,Pn),i.backgroundImage){let t=i.backgroundImage.width*(In/i.backgroundImage.height),n=Math.max(1,i.backgroundLoopWidth,t),r=n*(i.backgroundImage.height/i.backgroundImage.width),a=Fn+(r>In?(In-r)/2:0),o=-(c*.65%n);for(let t=o-n;t<Z+n;t+=n)e.drawImage(i.backgroundImage,t,a,n,r)}else{let t=e.createLinearGradient(0,0,0,Q);t.addColorStop(0,r.sky),t.addColorStop(1,`#090a12`),e.fillStyle=t,e.fillRect(0,Fn,Z,In),e.fillStyle=`rgba(255,255,255,0.12)`;for(let t=0;t<6;t+=1){let n=(t*180-c*.18%180+Z)%Z;e.fillRect(n,120+t%2*34,82,10)}e.fillStyle=`#202431`;for(let t=0;t<9;t+=1){let n=(t*130-c*.48%130+Z)%Z,r=78+t%3*34;e.fillRect(n,Q-r,72,r),e.fillStyle=`rgba(242,209,107,0.22)`,e.fillRect(n+16,Q-r+18,10,16),e.fillRect(n+44,Q-r+46,10,16),e.fillStyle=`#202431`}}if(!i.backgroundImage){e.fillStyle=r.ground,e.fillRect(0,Q,Z,Pn-Q),e.fillStyle=`#11131a`;for(let t=0;t<18;t+=1){let n=(t*58-c%58+Z)%Z;e.fillRect(n,Q+18,34,4)}for(let t=0;t<7;t+=1){let n=(t*190-c*.95%190+Z)%Z,i=28+t%2*18;e.fillStyle=`#342739`,e.fillRect(n,Q-i,38,i),e.fillStyle=r.accent,e.fillRect(n+8,Q-i-8,22,8)}}let u=t.grounded?Math.sin(t.elapsedMs*.018)*3:0,d=t.y+u,f=l?-34+Math.sin(t.elapsedMs*.08)*8:0;i.playerImageEnabled||(e.fillStyle=`#f1f3f5`,e.fillRect($+f+10,d,22,22),e.fillStyle=r.accent,e.fillRect($+f,d+24,Ln,36),e.fillStyle=`#11131a`,e.fillRect($+f+6,d+58,12,24),e.fillRect($+f+25,d+58,12,24),e.fillStyle=`#f1f3f5`,e.fillRect($+f+Ln,d+30,20,10)),o&&!i.opponentImageEnabled&&ur(e,t.chaseDistance,t.elapsedMs);for(let r of s){if(t.collectedIds.includes(r.id)||t.hitIds.includes(r.id))continue;let i=nr(r,t.worldElapsedMs,n.objectSpeedMultiplier);i<-100||i>Z+120||dr(e,r,i,t.elapsedMs)}if(e.fillStyle=`rgba(0,0,0,0.35)`,e.fillRect(24,24,752,56),e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,58,712,8),e.fillStyle=r.accent,e.fillRect(44,58,712*a,8),o){let r=1-Math.min(1,Math.max(0,t.chaseDistance/n.chaseStartDistance));e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,70,712,6),e.fillStyle=`#ff8f70`,e.fillRect(44,70,712*r,6)}e.fillStyle=`#f7f2dc`,e.font=`20px ${Kn}`,e.fillText(o?`公園の追跡劇`:`アーケード街の死闘`,44,48),e.font=`14px ${Kn}`,e.fillText(`${Math.ceil((n.durationMs-t.elapsedMs)/1e3)}秒`,708,48),e.fillText(o?`距離 ${Math.ceil(t.chaseDistance)}`:`アメ ${t.score}`,610,48),l&&(e.fillStyle=`rgba(120,0,0,0.7)`,e.fillRect(300,92,200,32),e.fillStyle=`#fff4e8`,e.font=`16px ${Kn}`,e.fillText(o?`追いつけない！`:`鍋に当たった！`,o?348:344,114));let p=[i.backgroundImageConfigured&&i.backgroundImageFailed?`background image not found`:null,i.playerImageConfigured&&i.playerImageFailed?`player image not found`:null,i.opponentImageConfigured&&i.opponentImageFailed?`opponent image not found`:null].filter(Boolean);p.length>0&&(e.fillStyle=`rgba(120,0,0,0.72)`,e.fillRect(24,92,360,30),e.fillStyle=`#fff4e8`,e.font=`13px ${Kn}`,e.fillText(p.join(` / `),38,112))}function pr({context:e,config:t,onExit:n}){let r=(0,a.useRef)(null),i=t.mode??`collect`,o=Math.max(1e3,t.durationMs||Vn),s=Math.max(1,t.chaseStartDistance??Un),c=Math.max(.001,t.chaseCatchRate??Wn),l=Math.max(0,t.chaseHitDistancePenalty??Gn),u=(0,a.useRef)({elapsedMs:0,worldElapsedMs:0,y:Q-Rn,velocityY:0,grounded:!0,score:0,penaltyCount:0,penaltyUntilMs:0,scrollFreezeUntilMs:0,chaseDistance:s,collectedIds:[],hitIds:[]}),d=(0,a.useRef)(null),f=(0,a.useRef)(!1),[p,m]=(0,a.useState)(0),h=Zn(),g=(0,a.useMemo)(()=>Xn(t.theme),[t.theme]),_=t.stageId||`default`,v=Qn(t.assetsBaseUrl,t.backgroundImage),y=Qn(t.assetsBaseUrl,t.playerImage),b=Qn(t.assetsBaseUrl,t.opponentImage);er(t.assetsBaseUrl,t.bgm,t.bgmVolume);let x=$n(v),S=$n(y),C=$n(b),w=Math.max(1,t.backgroundLoopWidth??Z),T=Math.max(1,t.playerWidth??74),E=Math.max(1,t.playerHeight??104),D=Math.max(1,t.opponentWidth??58),ee=Math.max(1,t.opponentHeight??84),O=Math.max(.1,t.objectSpeedMultiplier??1),k=(0,a.useCallback)(()=>{let e=u.current;e.grounded&&(u.current={...e,velocityY:Bn,grounded:!1})},[]),A=(0,a.useCallback)(t=>{if(f.current)return;f.current=!0;let r=u.current;n({...e,flags:{...e.flags,cleared_runner_action:!0,[`cleared_runner_action_${_}`]:!0,runner_action_score:r.score,[`runner_action_score_${_}`]:r.score,runner_action_penalties:r.penaltyCount,[`runner_action_penalties_${_}`]:r.penaltyCount,runner_action_result:t,[`runner_action_result_${_}`]:t,runner_action_distance:Math.ceil(r.chaseDistance),[`runner_action_distance_${_}`]:Math.ceil(r.chaseDistance)},playerStats:{...e.playerStats,runnerScore:r.score,runnerPenalties:r.penaltyCount,runnerDistance:Math.ceil(r.chaseDistance)}})},[e,n,_]);(0,a.useEffect)(()=>{let e=e=>{e.key!==` `&&e.key!==`Enter`||(e.preventDefault(),k())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[k]),(0,a.useEffect)(()=>{let e=0,t=n=>{let a=d.current??n,f=Math.min(40,n-a);d.current=n;let p=u.current,h=Math.min(o,p.elapsedMs+f),_=p.elapsedMs<p.scrollFreezeUntilMs?0:f,D=Math.min(o,p.worldElapsedMs+_),ee=i===`chase`?Math.max(0,p.chaseDistance-_*c):p.chaseDistance,k=p.velocityY+zn*f,j=p.y+k*f,M=!1,N=Q-Rn;j>=N&&(j=N,k=0,M=!0);let P={...p,elapsedMs:h,worldElapsedMs:D,chaseDistance:ee,y:j,velocityY:k,grounded:M},te=i===`chase`?Jn:qn,ne=h<P.penaltyUntilMs,re=Math.max(24,Math.min(T,74)-12),ie=Math.max(48,Math.min(E,104)-8),ae={x:$+(ne?-34:0)+8,y:ar(P,E)+4,width:re,height:ie};for(let e of te){if(P.collectedIds.includes(e.id)||P.hitIds.includes(e.id))continue;let t=nr(e,D,O);t<-100||t>Z+120||ir(ae,{x:t,y:rr(e),width:e.size,height:e.size})&&(P=e.type===`candy`?{...P,score:P.score+1,collectedIds:[...P.collectedIds,e.id]}:{...P,score:Math.max(0,P.score-2),penaltyCount:P.penaltyCount+1,penaltyUntilMs:h+900,scrollFreezeUntilMs:h+Hn,chaseDistance:i===`chase`?Math.min(s,P.chaseDistance+l):P.chaseDistance,hitIds:[...P.hitIds,e.id]})}u.current=P;let oe=r.current?.getContext(`2d`);if(oe&&fr(oe,P,{durationMs:o,mode:i,chaseStartDistance:s,objectSpeedMultiplier:O},g,{backgroundImage:x.image,backgroundImageConfigured:!!v,backgroundImageFailed:x.failed,backgroundLoopWidth:w,playerImageEnabled:!!y&&!S.failed,playerImageConfigured:!!y,playerImageFailed:S.failed,opponentImageEnabled:!!b&&!C.failed,opponentImageConfigured:!!b,opponentImageFailed:C.failed,playerWidth:T,playerHeight:E}),m(h),i===`chase`&&P.chaseDistance<=0){A(`win`);return}if(h>=o){A(i===`chase`?`lose`:`complete`);return}e=requestAnimationFrame(t)};return e=requestAnimationFrame(t),()=>cancelAnimationFrame(e)},[x.failed,x.image,v,w,c,l,s,o,A,i,C.failed,C.image,b,O,S.failed,S.image,E,y,T,_,g]);let j=Math.min(1,p/o),M=u.current,N=M.elapsedMs<M.penaltyUntilMs,P=M.grounded?Math.sin(M.elapsedMs*.018)*3:0,te=$+(N?-34+Math.sin(M.elapsedMs*.08)*8:0),ne=ar(M,E)+P,re=!!y&&!S.failed,ie=Math.min(650,$+95+M.chaseDistance*3.6),ae=Q-ee+Math.sin(M.elapsedMs*.02)*3,oe=i===`chase`&&!!b&&!C.failed;return(0,F.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#05060a`,overflow:`hidden`},children:(0,F.jsxs)(`div`,{style:{width:Z,height:Pn,flexShrink:0,transform:`scale(${h})`,transformOrigin:`center center`,position:`relative`,background:g.sky,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`,fontFamily:Kn},onMouseDown:k,onTouchStart:e=>{e.preventDefault(),k()},children:[(0,F.jsx)(`canvas`,{ref:r,width:Z,height:Pn,style:{display:`block`}}),re&&(0,F.jsx)(`img`,{src:y,alt:``,draggable:!1,style:{position:`absolute`,left:te,top:ne,width:T,height:E,pointerEvents:`none`,userSelect:`none`}}),oe&&(0,F.jsx)(`img`,{src:b,alt:``,draggable:!1,style:{position:`absolute`,left:ie,top:ae,width:D,height:ee,pointerEvents:`none`,userSelect:`none`}}),(0,F.jsxs)(`div`,{style:{position:`absolute`,left:24,right:24,bottom:22,display:`flex`,alignItems:`center`,justifyContent:`space-between`,color:`#f7f2dc`,fontSize:14,textShadow:`0 2px 6px rgba(0,0,0,0.8)`,pointerEvents:`none`},children:[(0,F.jsx)(`span`,{children:t.name??`Runner Action`}),(0,F.jsx)(`span`,{children:`Space / Enter / Click`}),(0,F.jsxs)(`span`,{children:[Math.round(j*100),`%`]})]})]})})}var mr={component:pr},hr=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,gr=800,_r=600,vr=148,yr=36,br=130,xr=_r-yr-br,Sr=120,Cr=[{symbol:`飴`,color:`#f4a260`},{symbol:`花`,color:`#f48fb1`},{symbol:`星`,color:`#fff176`},{symbol:`月`,color:`#ce93d8`},{symbol:`家`,color:`#80cbc4`},{symbol:`鐘`,color:`#80deea`},{symbol:`鳥`,color:`#a5d6a7`},{symbol:`波`,color:`#64b5f6`}],wr=[`どれかな……`,`えーと……`,`うーん……`],Tr=[`……`,`ふむ……`,`どれかな`],Er=[`やった！`,`そろった！`,`ふふ`],Dr=[`いただき`,`ふふふ`,`そうそう`],Or=[`あれ……`,`ちがった`,`うーん`],kr=[`おや`,`むむ……`,`ちがったか`];async function Ar(e){let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-1`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}function jr(e){let t=(0,a.useRef)(null);return{speak:(0,a.useCallback)(async(n,r)=>{let i=await Ar(`${n}_${r}`),a=`${(e??`/assets`).replace(/\/$/,``)}/voicevox/${i}.wav`,o=(await fetch(a,{method:`HEAD`}).catch(()=>null))?.ok?a:null;if(!o)try{let e=await fetch(`http://localhost:50021/audio_query?text=${encodeURIComponent(n)}&speaker=${r}`,{method:`POST`}).then(e=>e.json()),t=await fetch(`http://localhost:50021/synthesis?speaker=${r}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}).then(e=>e.arrayBuffer()).catch(()=>null);t&&(o=URL.createObjectURL(new Blob([t],{type:`audio/wav`})))}catch{}if(!o)return;t.current&&t.current.pause();let s=new Audio(o);t.current=s,s.play().catch(()=>{})},[e]),stop:(0,a.useCallback)(()=>{t.current&&=(t.current.pause(),null)},[])}}function Mr(){let e=()=>Math.min(1,Math.min(window.innerWidth/gr,window.innerHeight/_r)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function Nr(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function Pr(e){let t=[];for(let n=0;n<e;n++)t.push({id:n*2,pairId:n}),t.push({id:n*2+1,pairId:n});return{cards:Nr(t),flipped:[],matched:[],matchedBy:{},currentTurn:`player`,seen:{},playerPairs:0,opponentPairs:0,turns:0,phase:`playing`,lastEvent:`turn_start`,eventId:0}}var Fr=4,Ir=110,Lr=140,Rr=14,zr=14;function Br(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function Vr(e){return e.length===0?null:e[Math.floor(Math.random()*e.length)]}function Hr(e,t=`normal`){let n=t===`weak`?.18:.45,r=t===`weak`?.08:.25,i=e.cards.filter(t=>!e.matched.includes(t.pairId)&&!e.flipped.includes(t.id));if(i.length===0)return null;if(e.flipped.length===1){let t=e.cards.find(t=>t.id===e.flipped[0]),r=i.find(e=>t&&e.pairId===t.pairId);return r&&Math.random()<n?r.id:Vr(i)?.id??null}let a=new Map;for(let t of i)e.seen[t.id]===t.pairId&&a.set(t.pairId,[...a.get(t.pairId)??[],t.id]);let o=[...a.values()].find(e=>e.length>=2);return o&&Math.random()<r?o[0]:Vr(i)?.id??null}function Ur({side:e,name:t,faceSrc:n,score:r,active:i}){let a=e===`left`?`#fff176`:`#80deea`,o=xr-96;return(0,F.jsxs)(`div`,{style:{position:`absolute`,top:yr,[e]:0,width:vr,height:xr,overflow:`hidden`,background:i?`rgba(${e===`left`?`255,241,118`:`128,222,234`},0.06)`:`rgba(6,6,18,0.65)`,borderRight:e===`left`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,borderLeft:e===`right`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,transition:`background 0.4s, border-color 0.4s`,zIndex:3},children:[(0,F.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:o,overflow:`hidden`},children:[n?(0,F.jsx)(`img`,{src:n,alt:``,draggable:!1,style:{display:`block`,width:`100%`,height:`100%`,objectFit:`contain`,objectPosition:`bottom center`,filter:i?`none`:`brightness(0.55) saturate(0.6)`,transition:`filter 0.4s`}}):(0,F.jsx)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:56,color:`#1e2040`},children:e===`left`?`🎮`:`🤖`}),(0,F.jsx)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:60,background:`linear-gradient(to top, ${i?e===`left`?`rgba(18,16,2,0.96)`:`rgba(2,16,18,0.96)`:`rgba(6,6,18,0.96)`} 0%, transparent 100%)`,pointerEvents:`none`}})]}),(0,F.jsxs)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:96,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:4,borderTop:`1px solid ${i?`${a}44`:`rgba(36,40,68,0.5)`}`,background:i?e===`left`?`rgba(22,18,2,0.92)`:`rgba(2,18,22,0.92)`:`rgba(6,6,18,0.92)`,transition:`background 0.4s, border-color 0.4s`},children:[(0,F.jsx)(`div`,{style:{fontSize:48,lineHeight:1,color:i?a:`#4a5090`,fontVariantNumeric:`tabular-nums`,textShadow:i?`0 0 24px ${a}55`:`none`,transition:`color 0.4s, text-shadow 0.4s`},children:r}),(0,F.jsx)(`div`,{style:{fontSize:10,color:`#3c4278`,letterSpacing:`0.08em`},children:`取得ペア`}),(0,F.jsx)(`div`,{style:{fontSize:11,color:i?`#c5cae9`:`#4a5090`,letterSpacing:`0.05em`,maxWidth:vr-16,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`,textAlign:`center`,transition:`color 0.4s`},children:t})]}),i&&(0,F.jsx)(`div`,{style:{position:`absolute`,top:10,...e===`left`?{right:10}:{left:10},color:a,fontSize:14,opacity:.9},children:e===`left`?`▶`:`◀`})]})}function Wr({speakerName:e,speakerSide:t,text:n}){return(0,F.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,bottom:0,height:br,background:`rgba(6,6,20,0.92)`,borderTop:`1px solid rgba(46,50,88,0.7)`,zIndex:10},children:[e&&(0,F.jsx)(`div`,{style:{position:`absolute`,top:-30,...t===`right`?{right:vr+20}:{left:vr+20},background:`rgba(6,6,20,0.94)`,border:`1px solid rgba(46,50,88,0.7)`,borderBottom:`none`,padding:`5px 20px`,fontSize:13,color:`#c5cae9`,letterSpacing:`0.1em`},children:e}),(0,F.jsx)(`div`,{style:{position:`absolute`,top:18,left:vr+24,right:vr+24,bottom:14,color:`#e8eaf6`,fontSize:15,lineHeight:1.9,letterSpacing:`0.08em`,overflow:`hidden`},children:n??``})]})}function Gr({context:e,config:t,onExit:n}){let r=t.mode??`solo`,i=r===`duel`,o=t.opponentSkill??`normal`,s=t.pairs??6,c=t.maxTurns??20,l=Math.ceil(s*2/Fr),u=i?Sr:Lr,d=Fr*Ir+(Fr-1)*Rr,f=l*u+(l-1)*zr,p=Math.round((gr-d)/2),m=i?yr+Math.round((xr-f)/2):Math.round((_r-f)/2)+16,h=Mr(),{speak:g,stop:_}=jr(t.assetsBaseUrl),[v,y]=(0,a.useState)(()=>Pr(s)),b=(0,a.useRef)(!1),[x,S]=(0,a.useState)(()=>{if(r!==`duel`)return null;let e=Vr(t.playerDialogue?.length?t.playerDialogue:wr);return e?{speaker:`player`,text:e}:null});(0,a.useEffect)(()=>{if(v.phase!==`win`&&v.phase!==`lose`)return;let r=v.phase===`win`,i=setTimeout(()=>{n({...e,flags:{...e.flags,[`memory_game_result_${t.stageId}`]:r?`win`:`lose`,[`memory_game_player_pairs_${t.stageId}`]:v.playerPairs,[`memory_game_opponent_pairs_${t.stageId}`]:v.opponentPairs}})},2500);return()=>clearTimeout(i)},[v.phase]),(0,a.useEffect)(()=>{if(!x||!i)return;let e=x.speaker===`player`?t.playerVoicevoxSpeakerId:t.opponentVoicevoxSpeakerId;if(e!=null)return g(x.text,e),_},[x]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`){S(null);return}let e=v.currentTurn,n;switch(v.lastEvent){case`match`:n=e===`opponent`?t.opponentMatchDialogue?.length?t.opponentMatchDialogue:Dr:t.playerMatchDialogue?.length?t.playerMatchDialogue:Er;break;case`mismatch`:n=e===`opponent`?t.opponentMissDialogue?.length?t.opponentMissDialogue:kr:t.playerMissDialogue?.length?t.playerMissDialogue:Or;break;default:n=e===`opponent`?t.opponentDialogue?.length?t.opponentDialogue:Tr:t.playerDialogue?.length?t.playerDialogue:wr}let r=Vr(n);S(r?{speaker:e,text:r}:null)},[v.eventId,i,v.phase]);let C=(0,a.useCallback)(e=>{b.current||y(t=>{if(t.phase!==`playing`)return t;let n=t.cards.find(t=>t.id===e);if(!n||t.matched.includes(n.pairId)||t.flipped.includes(e)||t.flipped.length>=2)return t;let r=[...t.flipped,e],a={...t.seen,[e]:n.pairId};if(r.length<2)return{...t,flipped:r,seen:a};let[o,c]=r,l=t.cards.find(e=>e.id===o),u=t.cards.find(e=>e.id===c),d=l.pairId===u.pairId,f=t.turns+1,p=i?t.currentTurn:`player`;if(d){let e=[...t.matched,l.pairId],n=t.playerPairs+ +(p===`player`),r=t.opponentPairs+ +(p===`opponent`),o=e.length===s,c=i?n>r:!0;return{...t,flipped:[],matched:e,matchedBy:{...t.matchedBy,[l.pairId]:p},seen:a,playerPairs:n,opponentPairs:r,turns:f,phase:o?c?`win`:`lose`:`playing`,lastEvent:`match`,eventId:t.eventId+1}}return{...t,flipped:r,seen:a,turns:f,lastEvent:`mismatch`,eventId:t.eventId+1}})},[i,s,c]),w=(0,a.useCallback)(e=>{i&&v.currentTurn!==`player`||C(e)},[i,C,v.currentTurn]);(0,a.useEffect)(()=>{if(v.flipped.length!==2)return;let[e,t]=v.flipped,n=v.cards.find(t=>t.id===e),r=v.cards.find(e=>e.id===t);if(n.pairId===r.pairId)return;b.current=!0;let a=setTimeout(()=>{y(e=>({...e,flipped:[],currentTurn:i?e.currentTurn===`player`?`opponent`:`player`:e.currentTurn,phase:!i&&c>0&&e.turns>=c?`lose`:e.phase,lastEvent:`turn_start`,eventId:e.eventId+1})),b.current=!1},900);return()=>{clearTimeout(a),b.current=!1}},[v.flipped]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`||v.currentTurn!==`opponent`||b.current)return;let e=v.flipped.length===0?650:820,t=setTimeout(()=>{let e=Hr(v,o);e!==null&&C(e)},e);return()=>clearTimeout(t)},[i,o,C,v]);let T=c>0?c-v.turns:null,E=T!==null&&T<=5,D=Br(t.assetsBaseUrl,t.playerFaceImage),ee=Br(t.assetsBaseUrl,t.opponentFaceImage),O=t.playerName??`こちら`,k=t.opponentName??`相手`,A=Br(t.assetsBaseUrl,t.backgroundImage),j=x?x.speaker===`player`?O:k:null,M=x?x.speaker===`player`?`left`:`right`:null;return(0,F.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#0a0a14`,overflow:`hidden`},children:(0,F.jsxs)(`div`,{style:{width:gr,height:_r,position:`relative`,userSelect:`none`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${h})`,fontFamily:hr,...A?{backgroundImage:`url(${A})`,backgroundSize:`cover`,backgroundPosition:`center`}:{background:`linear-gradient(150deg, #0d0d1a 0%, #0a0a14 60%, #0e0a1c 100%)`}},children:[A&&(0,F.jsx)(`div`,{style:{position:`absolute`,inset:0,background:`rgba(4,4,12,0.56)`,pointerEvents:`none`}}),(0,F.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:yr,display:`flex`,alignItems:`center`,justifyContent:`center`,zIndex:4,borderBottom:`1px solid rgba(36,40,68,0.5)`,background:`rgba(6,6,20,0.7)`},children:[(0,F.jsx)(`span`,{style:{color:`#c5cae9`,fontSize:15,letterSpacing:`0.14em`},children:t.title??`神経衰弱`}),!i&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(`span`,{style:{position:`absolute`,left:20,color:`#8bc34a`,fontSize:13},children:[v.matched.length,` / `,s,` ペア`]}),(0,F.jsx)(`span`,{style:{position:`absolute`,right:20,color:E?`#ef9a9a`:`#4a4d62`,fontSize:13},children:c>0?`残り ${T} 手`:`${v.turns} 手`})]})]}),i&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(Ur,{side:`left`,name:O,faceSrc:D,score:v.playerPairs,active:v.currentTurn===`player`&&v.phase===`playing`}),(0,F.jsx)(Ur,{side:`right`,name:k,faceSrc:ee,score:v.opponentPairs,active:v.currentTurn===`opponent`&&v.phase===`playing`})]}),v.cards.map((e,t)=>{let n=t%Fr,r=Math.floor(t/Fr),a=p+n*(Ir+Rr),o=m+r*(u+zr),s=v.flipped.includes(e.id)||v.matched.includes(e.pairId),c=v.matched.includes(e.pairId),l=Cr[e.pairId%Cr.length],d=(c?v.matchedBy[e.pairId]:void 0)===`opponent`?`#80deea`:l.color;return(0,F.jsx)(`div`,{onClick:()=>w(e.id),style:{position:`absolute`,left:a,top:o,width:Ir,height:u,borderRadius:10,cursor:s||i&&v.currentTurn!==`player`||b.current?`default`:`pointer`,background:s?`#141426`:`#0c0c1c`,border:c?`2px solid ${d}88`:s?`2px solid #3a3a5a`:`2px solid #1c1c30`,display:`flex`,alignItems:`center`,justifyContent:`center`,boxShadow:c?`0 0 20px ${d}36, 0 2px 8px rgba(0,0,0,0.55)`:s?`0 4px 14px rgba(0,0,0,0.65)`:`0 2px 6px rgba(0,0,0,0.45)`,transition:`background 0.12s, border-color 0.12s, box-shadow 0.2s`,zIndex:2},children:s?(0,F.jsx)(`span`,{style:{fontSize:i?44:52,color:c?`${l.color}80`:l.color,lineHeight:1},children:l.symbol}):(0,F.jsx)(`span`,{style:{fontSize:24,color:`#1c1e38`},children:`✦`})},e.id)}),i&&v.phase===`playing`&&(0,F.jsx)(Wr,{speakerName:j,speakerSide:M,text:x?.text??null}),v.phase===`win`&&(0,F.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,F.jsx)(`div`,{style:{fontSize:46,color:`#fff176`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(255,241,118,0.45)`},children:`勝　利`}),(0,F.jsx)(`div`,{style:{fontSize:16,color:`#c5cae9`,letterSpacing:`0.08em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`${v.turns} 手でクリア`})]}),v.phase===`lose`&&(0,F.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,F.jsx)(`div`,{style:{fontSize:46,color:`#ef9a9a`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(239,154,154,0.35)`},children:`惜　敗`}),(0,F.jsx)(`div`,{style:{fontSize:16,color:`#667`,letterSpacing:`0.06em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`もう一度チャレンジしてください`})]})]})})}var Kr={component:Gr},qr=800,Jr=600,Yr=`'Hiragino Kaku Gothic ProN', 'Meiryo', 'Yu Gothic', sans-serif`,Xr=3,Zr=`
...
`,Qr={easy:{count:3,min:1,max:9,flashMs:800,blankMs:150,negatives:0},normal:{count:4,min:3,max:20,flashMs:600,blankMs:120,negatives:1},hard:{count:5,min:5,max:50,flashMs:400,blankMs:100,negatives:2}};function $r(e,t){return Math.floor(Math.random()*(t-e+1))+e}function ei(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function ti(e){let{count:t,min:n,max:r,negatives:i}=Qr[e];for(;;){let e=[$r(n,r)];for(let a=1;a<t;a++){let t=i>0&&a<=i&&Math.random()<.45;e.push($r(n,r)*(t?-1:1))}let a=e.reduce((e,t)=>e+t,0);if(a>0)return{nums:e,answer:a}}}function ni(e){let t=new Set([e]);for(let n of ei([3,7,12,18,25])){if(t.size>=4)break;let r=e+(Math.random()<.5?n:-n);r>0&&r!==e&&t.add(r)}let n=1;for(;t.size<4;)t.add(e+n),t.add(e-n),n++;return ei([...t].slice(0,4))}function ri(e){let t=ti(e);return{phase:`countdown`,countdown:5,round:0,problem:t,flashIdx:0,choices:ni(t.answer),selected:null,isCorrect:null,score:0,seq:0}}function ii(){let e=()=>Math.min(1,Math.min(window.innerWidth/qr,window.innerHeight/Jr)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function ai(){(0,a.useEffect)(()=>{let e=document.createElement(`style`);return e.setAttribute(`data-fc`,`1`),e.textContent=Zr,document.head.appendChild(e),()=>{document.head.removeChild(e)}},[])}function oi({context:e,config:t,onExit:n}){let r=t.difficulty??`easy`,i=t.rounds??5,o=Qr[r],s=ii();ai();let[c,l]=(0,a.useState)(()=>ri(r)),u=(0,a.useRef)(0),d=(0,a.useCallback)(()=>(u.current+=1,u.current),[]);(0,a.useEffect)(()=>{if(c.phase!==`countdown`)return;let e=d(),t=c.countdown===0?700:460,n=setTimeout(()=>{u.current===e&&(c.countdown>0?l(e=>({...e,countdown:e.countdown-1,seq:e.seq+1})):l(e=>({...e,phase:`flash`,flashIdx:0,seq:e.seq+1})))},t);return()=>clearTimeout(n)},[c.phase,c.countdown,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`flash`)return;let e=d(),t=setTimeout(()=>{u.current===e&&(c.flashIdx+1<c.problem.nums.length?l(e=>({...e,phase:`blank`,seq:e.seq+1})):l(e=>({...e,phase:`answer`,selected:null,isCorrect:null,seq:e.seq+1})))},o.flashMs);return()=>clearTimeout(t)},[c.phase,c.flashIdx,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`blank`)return;let e=d(),t=setTimeout(()=>{u.current===e&&l(e=>({...e,phase:`flash`,flashIdx:e.flashIdx+1,seq:e.seq+1}))},o.blankMs);return()=>clearTimeout(t)},[c.phase,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`feedback`)return;let e=d(),t=setTimeout(()=>{if(u.current!==e)return;let t=c.round+1;if(t>=i)l(e=>({...e,phase:`result`,seq:e.seq+1}));else{let e=ti(r);l(n=>({...n,phase:`countdown`,countdown:5,round:t,problem:e,flashIdx:0,choices:ni(e.answer),selected:null,isCorrect:null,seq:n.seq+1}))}},1400);return()=>clearTimeout(t)},[c.phase,c.round,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`result`)return;let t=d(),r=setTimeout(()=>{u.current===t&&n({...e,flags:{...e.flags,flash_calc_score:c.score,flash_calc_rounds:i,flash_calc_passed:c.score>Xr},playerStats:{...e.playerStats,flash_calc_score:c.score}})},3500);return()=>clearTimeout(r)},[c.phase]);let f=(0,a.useCallback)(e=>{if(c.phase!==`answer`)return;let t=e===c.problem.answer;l(n=>({...n,phase:`feedback`,selected:e,isCorrect:t,score:t?n.score+1:n.score,seq:n.seq+1}))},[c.phase,c.problem.answer]),p=c.problem.nums[c.flashIdx],m=c.phase===`flash`?`flash-${c.flashIdx}`:c.phase;return(0,F.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#02020a`,overflow:`hidden`},children:(0,F.jsxs)(`div`,{style:{width:qr,height:Jr,position:`relative`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${s})`,fontFamily:Yr,background:[`repeating-linear-gradient(0deg,transparent,transparent 49px,rgba(0,240,255,0.04) 49px,rgba(0,240,255,0.04) 50px)`,`repeating-linear-gradient(90deg,transparent,transparent 49px,rgba(0,240,255,0.04) 49px,rgba(0,240,255,0.04) 50px)`,`linear-gradient(155deg,#07071a 0%,#040409 55%,#07040f 100%)`].join(`,`),userSelect:`none`,animation:`fcMountIn 0.55s ease-out`},children:[(0,F.jsx)(`div`,{style:{position:`absolute`,inset:0,zIndex:40,pointerEvents:`none`,background:`repeating-linear-gradient(0deg,rgba(0,0,0,0.08),rgba(0,0,0,0.08) 1px,transparent 1px,transparent 4px)`,backgroundSize:`100% 4px`,animation:`fcScan 4s linear infinite`}}),(0,F.jsx)(si,{top:10,left:10}),(0,F.jsx)(si,{top:10,right:10}),(0,F.jsx)(si,{bottom:10,left:10}),(0,F.jsx)(si,{bottom:10,right:10}),(0,F.jsx)(ci,{round:c.round,totalRounds:i,score:c.score}),(0,F.jsx)(ui,{phase:c.phase,countdown:c.countdown,currentNum:p,isNeg:typeof p==`number`&&p<0,flashIdx:c.flashIdx,totalNums:c.problem.nums.length,isCorrect:c.isCorrect,correctAnswer:c.problem.answer,selected:c.selected},m),(c.phase===`answer`||c.phase===`feedback`)&&(0,F.jsx)(fi,{choices:c.choices,selected:c.selected,correct:c.problem.answer,onSelect:f,disabled:c.phase===`feedback`}),c.phase===`result`&&(0,F.jsx)(pi,{score:c.score,total:i})]})})}function si({top:e,bottom:t,left:n,right:r}){return(0,F.jsx)(`div`,{style:{position:`absolute`,top:e,bottom:t,left:n,right:r,width:28,height:28,zIndex:3,pointerEvents:`none`,borderTop:e===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderBottom:t===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderLeft:n===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderRight:r===void 0?void 0:`1px solid rgba(0,240,255,0.4)`}})}function ci({round:e,totalRounds:t,score:n}){return(0,F.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:44,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(3,3,14,0.92)`,borderBottom:`1px solid rgba(0,240,255,0.15)`,zIndex:5},children:[(0,F.jsx)(`span`,{style:{color:`#6878b0`,fontSize:12,letterSpacing:`0.55em`,textTransform:`uppercase`},children:`Flash\xA0Calc`}),(0,F.jsxs)(`span`,{style:{position:`absolute`,left:40,color:`#283050`,fontSize:12,letterSpacing:`0.12em`,fontVariantNumeric:`tabular-nums`},children:[(0,F.jsx)(`span`,{style:{color:`#304070`},children:`RND`}),` `,(0,F.jsx)(`span`,{style:{color:`#4060a0`},children:e+1}),` `,(0,F.jsxs)(`span`,{style:{color:`#202840`},children:[`/ `,t]})]}),(0,F.jsxs)(`span`,{style:{position:`absolute`,right:40,display:`flex`,alignItems:`center`,gap:8,fontVariantNumeric:`tabular-nums`},children:[(0,F.jsx)(`span`,{style:{color:`#283050`,fontSize:11,letterSpacing:`0.12em`},children:`SCORE`}),(0,F.jsx)(`span`,{style:{color:`#40c070`,fontSize:18,fontWeight:700,textShadow:`0 0 12px rgba(60,200,100,0.5)`},children:n})]})]})}var li={position:`absolute`,left:0,right:0,top:44,bottom:150,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`};function ui({phase:e,countdown:t,currentNum:n,isNeg:r,flashIdx:i,totalNums:a,isCorrect:o,correctAnswer:s,selected:c}){if(e===`result`)return null;if(e===`countdown`){let e=t===0?0:6-t,n=t===0;return(0,F.jsxs)(`div`,{style:{...li,animation:`fcPhaseIn 0.22s ease-out`,gap:0},children:[(0,F.jsx)(`div`,{style:{fontSize:11,letterSpacing:`0.55em`,color:`#2a3060`,textTransform:`uppercase`,marginBottom:24},children:n?`Start`:`Ready`}),(0,F.jsx)(`div`,{style:{background:`radial-gradient(ellipse at 50% 30%, #0c0a1e, #060410)`,border:`1px solid rgba(60,40,110,0.55)`,borderRadius:16,padding:`26px 40px`,display:`flex`,gap:30,boxShadow:`inset 0 0 80px rgba(0,0,0,0.85), 0 4px 40px rgba(0,0,0,0.6)`},children:Array.from({length:5},(t,n)=>{let r=n<e;return(0,F.jsx)(`div`,{style:{width:56,height:56,borderRadius:`50%`,background:r?`radial-gradient(circle at 38% 32%, #ff6050 0%, #cc0000 55%, #800000 100%)`:`radial-gradient(circle at 38% 32%, #1e0c0c 0%, #0e0404 100%)`,border:`3px solid ${r?`#ff4030`:`#1a0808`}`,boxShadow:r?`0 0 22px #ff0000, 0 0 50px rgba(255,0,0,0.55), 0 0 90px rgba(255,0,0,0.25), inset 0 2px 8px rgba(255,180,160,0.25)`:`inset 0 2px 6px rgba(0,0,0,0.9)`,animation:r?`fcLightOn 1.6s ease-in-out infinite`:`none`,transition:`background 0.12s, border-color 0.12s, box-shadow 0.15s`}},n)})}),n?(0,F.jsx)(`div`,{style:{fontSize:86,color:`#00ff60`,letterSpacing:`0.1em`,marginTop:28,textShadow:`0 0 28px #00ff60, 0 0 60px rgba(0,255,96,0.6), 0 0 120px rgba(0,255,96,0.3)`,animation:`fcGoFlash 0.38s cubic-bezier(0.17,0.89,0.32,1.27)`},children:`GO！`}):(0,F.jsx)(`div`,{style:{fontSize:12,color:`#252548`,letterSpacing:`0.14em`,marginTop:22},children:`集中してください`})]})}if(e===`flash`){let e=r?`−${Math.abs(n)}`:`${n}`,t=r?`#ff7878`:`#d8eeff`,o=r?`rgba(255,80,80,0.65)`:`rgba(80,180,255,0.7)`;return(0,F.jsxs)(`div`,{style:{...li,gap:0},children:[(0,F.jsx)(di,{total:a,done:i,active:i}),(0,F.jsx)(`div`,{style:{fontSize:118,color:t,lineHeight:1,fontWeight:700,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 40px ${o}, 0 0 90px ${o.replace(`0.7`,`0.35`)}`,animation:`fcNumPop 0.2s cubic-bezier(0.17,0.89,0.32,1.27)`,letterSpacing:`0.04em`},children:e})]})}return e===`blank`?(0,F.jsx)(`div`,{style:{...li},children:(0,F.jsx)(di,{total:a,done:i+1,active:null})}):e===`answer`?(0,F.jsxs)(`div`,{style:{...li,gap:14,animation:`fcPhaseIn 0.25s ease-out`},children:[(0,F.jsx)(`div`,{style:{fontSize:88,color:`#3a4888`,textShadow:`0 0 24px rgba(60,80,180,0.4)`,lineHeight:1},children:`?`}),(0,F.jsx)(`div`,{style:{fontSize:13,color:`#2c2c54`,letterSpacing:`0.18em`},children:`こたえを　えらんでね`})]}):e===`feedback`?o?(0,F.jsxs)(`div`,{style:{...li,gap:12,animation:`fcCorrect 0.42s ease-out`},children:[(0,F.jsx)(`div`,{style:{fontSize:60,color:`#50ff8c`,textShadow:`0 0 28px rgba(80,255,140,0.7), 0 0 60px rgba(80,255,140,0.35)`,letterSpacing:`0.08em`},children:`せいかい！`}),(0,F.jsx)(`div`,{style:{fontSize:42,color:`#a0ffcc`,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 16px rgba(80,255,140,0.4)`},children:s})]}):(0,F.jsxs)(`div`,{style:{...li,gap:10,animation:`fcWrong 0.48s ease-out`},children:[(0,F.jsx)(`div`,{style:{fontSize:60,color:`#ff5555`,textShadow:`0 0 28px rgba(255,60,60,0.7)`,letterSpacing:`0.08em`},children:`ざんねん`}),(0,F.jsxs)(`div`,{style:{fontSize:18,color:`#7a3a5a`,letterSpacing:`0.1em`},children:[`こたえは\xA0`,(0,F.jsx)(`span`,{style:{color:`#c06080`,fontVariantNumeric:`tabular-nums`},children:s})]}),c!==null&&(0,F.jsxs)(`div`,{style:{fontSize:13,color:`#3a2030`},children:[`あなたは `,c,` と答えました`]})]}):null}function di({total:e,done:t,active:n}){return(0,F.jsx)(`div`,{style:{display:`flex`,gap:14,marginBottom:28},children:Array.from({length:e},(e,r)=>{let i=r<t,a=r===n;return(0,F.jsx)(`div`,{style:{width:10,height:10,borderRadius:2,background:a?`#00f0ff`:i?`rgba(0,200,255,0.45)`:`rgba(24,24,50,0.7)`,boxShadow:a?`0 0 10px #00f0ff, 0 0 22px rgba(0,240,255,0.5)`:i?`0 0 4px rgba(0,200,255,0.3)`:`none`,transition:`background 0.15s, box-shadow 0.15s`}},r)})})}function fi({choices:e,selected:t,correct:n,onSelect:r,disabled:i}){return(0,F.jsx)(`div`,{style:{position:`absolute`,left:36,right:36,bottom:36,height:104,display:`flex`,gap:18,alignItems:`stretch`},children:e.map(e=>{let a=`rgba(10,8,28,0.92)`,o=`1px solid rgba(0,180,220,0.18)`,s=`#8898cc`,c=`none`,l=`none`;return i&&t!==null&&(e===n?(a=`rgba(20,60,35,0.95)`,o=`1px solid rgba(80,255,140,0.55)`,s=`#80ffb8`,c=`0 0 28px rgba(60,220,110,0.35)`,l=`fcCorrect 0.4s ease-out`):e===t&&(a=`rgba(60,18,22,0.95)`,o=`1px solid rgba(255,80,80,0.5)`,s=`#ff7070`,c=`0 0 18px rgba(255,60,60,0.3)`)),(0,F.jsx)(`button`,{className:`fc-btn`,onClick:()=>!i&&r(e),disabled:i,style:{flex:1,height:`100%`,background:a,border:o,borderRadius:10,color:s,fontSize:38,fontFamily:Yr,fontVariantNumeric:`tabular-nums`,fontWeight:700,boxShadow:c,animation:l,letterSpacing:`0.04em`},children:e},e)})})}function pi({score:e,total:t}){let n=e>Xr,r=e===t,i=r?`#fff080`:n?`#60ff90`:`#ff6060`,a=r?`パーフェクト！`:n?`よくできました！`:`ざんねん…`;return(0,F.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(2,2,12,0.94)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:0,animation:`fcResultIn 0.5s cubic-bezier(0.17,0.89,0.32,1.27)`},children:[(0,F.jsx)(`div`,{style:{fontSize:11,letterSpacing:`0.55em`,color:`#242448`,textTransform:`uppercase`,marginBottom:32},children:`Result`}),(0,F.jsx)(`div`,{style:{fontSize:46,color:i,letterSpacing:`0.14em`,textShadow:`0 0 36px ${i}88, 0 0 70px ${i}44`,marginBottom:24},children:a}),(0,F.jsxs)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:14},children:[(0,F.jsx)(`span`,{style:{fontSize:92,color:i,fontVariantNumeric:`tabular-nums`,fontWeight:700,textShadow:`0 0 50px ${i}66, 0 0 100px ${i}33`},children:e}),(0,F.jsxs)(`span`,{style:{fontSize:28,color:`#242448`},children:[`/ `,t]})]}),!n&&(0,F.jsx)(`div`,{style:{fontSize:15,color:`#4a2840`,letterSpacing:`0.12em`,marginTop:20},children:`4もん以上せいかいしてね`})]})}var mi={component:oi},hi=vt(),gi=vt(`chapter2`),_i=vt(`chapter3`),vi=vt(`chapter4`),yi=`/dojonovel/assets`,bi=[{id:`chapter1`,title:`第1章へ`,chapterTitle:`赤羽の一日`,masterData:hi,initialSceneId:`scene_danchi_morning`,initialLocationId:`loc_danchi`,initialFlags:{flag_chapter:1}},{id:`chapter2`,title:`第2章へ`,chapterTitle:`一番街の怨霊`,masterData:gi,initialSceneId:`scene_ch2_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_chapter1_cleared`,initialFlags:{flag_chapter:2,flag_chapter1_cleared:!0}},{id:`chapter3`,title:`第3章へ`,chapterTitle:`アーケード街の死闘`,masterData:_i,initialSceneId:`scene_ch3_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_ch2_cleared`,initialFlags:{flag_chapter:3,flag_chapter1_cleared:!0,flag_ch2_cleared:!0}},{id:`chapter4`,title:`第4章へ`,chapterTitle:`（タイトル未定）`,masterData:vi,initialSceneId:`scene_ch4_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_ch3_cleared`,initialFlags:{flag_chapter:4,flag_chapter1_cleared:!0,flag_ch2_cleared:!0,flag_ch3_cleared:!0,flag_station_explored:!0,flag_visited_slope:!0,flag_ch3_museum_unlocked:!0}}];function xi(){return(0,F.jsx)(St,{engines:{novel:wt,maze_rpg:Nn,runner_action:mr,memory_game:Kr,flash_calc:mi},initial:{engineId:`novel`,config:{masterData:hi,assetsBaseUrl:yi,chapterId:`chapter1`,initialSceneId:`scene_danchi_morning`,initialLocationId:`loc_danchi`,chapters:bi}},initialContext:{flags:{},inventory:[],playerStats:{}}})}(0,o.createRoot)(document.getElementById(`root`)).render((0,F.jsx)(a.StrictMode,{children:(0,F.jsx)(xi,{})}));