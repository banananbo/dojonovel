...
`,d=`scenes:
    ...
    branches:
      ...
      choices:
        - condition:
            flag: flag_ch5_oyaji_purified
            value: true
          next_scene: scene_ch5_oyaji_after
        - condition: null
          next_scene: scene_ch5_oyaji_possessed
  - id: scene_ch5_oyaji_possessed
    location_id: loc_museum_oyaji_room
    background: backgrounds/musium_room01.jpg
    background_effect: possessed
    bgm: audio/bgm/museum.mp3
    characters:
      - character_id: char_oyaji
        ...
        expression: possessed
    messages:
      - text: 古い看板の前で、おじさんがふらふらと揺れていた。
        voice_character_id: null
      - text: 「あああ……止まらん。世界が、右へ左へ、ぐるぐるじゃ」
        voice_character_id: char_oyaji
      - text: 「タイミングを合わせれば、悪霊を止められるかもしれない」
        voice_character_id: char_hero
    next_engine:
      id: timing_game
      transition: timing
      config:
        stageId: oyaji_spirit
        title: おじさんのタイミング勝負
        rounds: 6
        targetHits: 4
        cycleMs: 1750
        targetWidth: 0.2
      return_scene: scene_ch5_oyaji_battle_result
  - id: scene_ch5_oyaji_battle_result
    location_id: loc_museum_oyaji_room
    background: backgrounds/musium_room01.jpg
    background_effect: possessed
    bgm: audio/bgm/museum.mp3
    ...
    branches:
      ...
      choices:
        - condition:
            flag: timing_game_result_oyaji_spirit
            value: win
          next_scene: scene_ch5_oyaji_purified
        - condition: null
          next_scene: scene_ch5_oyaji_retry
  - id: scene_ch5_oyaji_retry
    location_id: loc_museum_oyaji_room
    background: backgrounds/musium_room01.jpg
    background_effect: possessed
    bgm: audio/bgm/museum.mp3
    characters:
      - character_id: char_oyaji
        ...
        expression: possessed
    messages:
      - text: 赤い光がおじさんのまわりをまた回りはじめた。
        voice_character_id: null
      - text: 「すまん、今のはわしも目が回った。もう一度頼む」
        voice_character_id: char_oyaji
    next_scene: scene_ch5_oyaji_possessed
  - id: scene_ch5_oyaji_purified
    location_id: loc_museum_oyaji_room
    background: backgrounds/musium_room01.jpg
    bgm: audio/bgm/museum.mp3
    flags_set:
    ...
    characters:
      - character_id: char_oyaji
        ...
        expression: normal
    messages:
      - text: タイミングが合った瞬間、赤い光がおじさんから弾け飛んだ。
        voice_character_id: null
      - text: 「はあ……助かった。飲んでもおらんのに、酔うところじゃった」
        voice_character_id: char_oyaji
      - text: 「中心部へ戻ろう。まだ終わってない気がする」
        voice_character_id: char_hero
  - id: scene_ch5_oyaji_after
    location_id: loc_museum_oyaji_room
    background: backgrounds/musium_room01.jpg
    bgm: audio/bgm/museum.mp3
    characters:
      - character_id: char_oyaji
        ...
        expression: normal
    messages:
      - text: おじさんは古い道具の棚のそばで、目をぱちぱちさせている。
        voice_character_id: null
      - text: 「わしはもう大丈夫じゃ。中心部を見てきておくれ」
        voice_character_id: char_oyaji
    next_scene: null
  - id: scene_ch5_deep_core_all_purified
    ...
    characters: []
    messages:
      - text: ユイとおじさんを浄化すると、奥の中心部の赤い光が一つに集まった。
        voice_character_id: null
      - text: それでも、ミュージアムのいちばん奥には、まだ細い光の道が残っている。
        voice_character_id: null
      - text: （ここまで来た。もう少しだけ、奥へ）
        voice_character_id: char_hero
    next_scene: scene_ch5_proto_end
  - id: scene_ch5_proto_end
    location_id: loc_museum_deep_core
    background: backgrounds/center_musium.png
    background_effect: possessed
    bgm: audio/bgm/ending.mp3
    ...
    flags_set:
      - flag: flag_ch5_cleared
        value: true
    messages:
      - text: こうして、奥の中心部にいた二人も、悪霊から解き放たれた。
        voice_character_id: null
      - text: でも、さらに奥へ続く細い光は、まだ消えていない。
        voice_character_id: null
      - text: （次は、あの光の先だ）
        voice_character_id: char_hero
    game_end: true
...
`,f=`flags:
  ...
  - id: flag_ch5_oyaji_purified
    type: boolean
    default: false
    description: "第5章奥エリアでおじさんに取りついた悪霊を払った"
  ...
  - id: timing_game_result_oyaji_spirit
    type: string
    default: ""
    description: "第5章おじさん悪霊戦のタイミングゲーム結果"

  - id: flag_ch5_cleared
    type: boolean
    default: false
    description: "第5章プロトタイプをクリア済み"
`,p=`items:
  - id: item_suica
    name: "Suicaカード"
...
`,m=`locations:
  ...
  - id: loc_museum_oyaji_room
    name: "古い道具の部屋"
    description: "昔の道具や看板が並ぶ展示室。床の赤い光が妙に速い。"
    background_default: backgrounds/musium_room01.jpg
    default_commands:
      - cmd_move
      - cmd_inventory
...
`,_=e=>{let t,n=new Set,r=(e,r)=>{let i=typeof e==`function`?e(t):e;if(!Object.is(i,t)){let e=t;t=r??(typeof i!=`object`||!i)?i:Object.assign({},t,i),n.forEach(n=>n(t,e))}},i=()=>t,a={setState:r,getState:i,getInitialState:()=>o,subscribe:e=>(n.add(e),()=>n.delete(e))},o=t=e(r,i,a);return a},v=(e=>e?_(e):_),y=e=>e;function b(e,t=y){let n=a.useSyncExternalStore(e.subscribe,a.useCallback(()=>t(e.getState()),[e,t]),a.useCallback(()=>t(e.getInitialState()),[e,t]));return a.useDebugValue(n),n}var x=e=>{let t=v(e),n=e=>b(t,e);return Object.assign(n,t),n},S=(e=>e?x(e):x),C={bgmVolume:.4,seVolume:.8,voiceVolume:.8,textSpeed:40,autoMode:!1,fullscreen:!1};function w(e){return Object.fromEntries(e.map(e=>[e.id,e.default]))}function T(e,t){if(!e||e.length===0)return t;let n={...t};for(let{flag:t,value:r}of e)n[t]=r;return n}function E(e,t){if(!e)return!0;if(e.and)return e.and.every(e=>E(e,t));if(e.or)return e.or.some(e=>E(e,t));let n=!0;if(e.flag!==void 0){let r=t.flags[e.flag],i=e.value;i!==void 0&&(n&&=r===i),e.min!==void 0&&(n=n&&typeof r==`number`&&r>=e.min),e.max!==void 0&&(n=n&&typeof r==`number`&&r<=e.max)}if(e.has_item!==void 0&&(n&&=t.inventory.includes(e.has_item)),e.item_count!==void 0){let r=new Set(e.item_count.items),i=t.inventory.filter(e=>r.has(e)).length;e.item_count.min!==void 0&&(n&&=i>=e.item_count.min),e.item_count.max!==void 0&&(n&&=i<=e.item_count.max)}return e.location_id!==void 0&&(n&&=t.locationId===e.location_id),e.negate&&(n=!n),n}function D(e,t){if(!e||e.length===0)return t;let n={flags:t.flags,inventory:t.inventory,locationId:t.currentLocationId},r=[...t.inventory];for(let t of e)E(t.condition,n)&&(r.includes(t.item_id)||(r=[...r,t.item_id]));return{...t,inventory:r}}function O(e,t){return{...t,inventory:t.inventory.filter(t=>t!==e)}}function k(e,t,n){let r=n.items[e];if(!r||!r.usable)return!1;let i={flags:t.flags,inventory:t.inventory,locationId:t.currentLocationId};return E(r.use_condition,i)}function A(e,t,n){let r=n.items[e];if(!r||!r.usable)return{newState:t,sceneId:null};let i=t;return r.stackable||(i=O(e,t)),{newState:i,sceneId:r.use_scene??null}}function j(e,t,n){let r=n.scenes[e];if(!r)return console.warn(`[SceneEngine] Scene not found: ${e}`),t;let i={...t,currentSceneId:e,currentMessageIndex:0,phase:`message`};if(r.location_id&&r.location_id!==t.currentLocationId&&(i={...i,currentLocationId:r.location_id,currentCharacters:[]}),r.characters!==void 0&&(i={...i,currentCharacters:r.characters}),r.messages[0]?.characters!==void 0&&(i={...i,currentCharacters:r.messages[0].characters}),i={...i,flags:T(r.flags_set,i.flags)},r.item_remove)for(let e of r.item_remove)i=O(e,i);return r.messages.length===0?r.game_end?{...i,phase:`ending`}:r.cg_sequence?.length?{...i,phase:`cg_sequence`}:N(i,r,n):i}function M(e,t){let n=t.scenes[e.currentSceneId];if(!n)return e;let r=e.currentMessageIndex+1;if(r<n.messages.length){let t=n.messages[r],i={...e,currentMessageIndex:r};return t.characters===void 0?i:{...i,currentCharacters:t.characters}}return N(e,n,t)}function N(e,t,n){let r=D(t.item_give,e);if(t.game_end)return{...r,phase:`ending`};if(t.next_engine)return{...r,phase:`engine_transition`,pendingEngineTransition:t.next_engine};let i=t.branches,a={flags:r.flags,inventory:r.inventory,locationId:r.currentLocationId};if(i?.type===`choice`&&i.choices&&i.choices.length>0){let e=i.choices.filter(e=>E(e.condition,a));return e.length===1&&e[0].next_scene?j(e[0].next_scene,r,n):{...r,phase:`choice`}}if(i?.type===`auto`&&i.choices){for(let e of i.choices)if(E(e.condition,a))return e.next_scene?j(e.next_scene,r,n):e.next_scene===null?F(r,n):I(r,t,n);return F(r,n)}return t.next_scene?j(t.next_scene,r,n):t.next_scene===null?F(r,n):I(r,t,n)}function P(e,t,n){let r=n.scenes[t.currentSceneId];if(!r?.branches?.choices)return t;let i=r.branches.choices[e];return i?i.next_scene?j(i.next_scene,t,n):F(t,n):t}function F(e,t){if(e.sceneHistory.length===0)return I(e,t.scenes[e.currentSceneId],t);let n=[...e.sceneHistory],r=n.pop();return t.scenes[r],{...e,currentSceneId:r,currentMessageIndex:0,sceneHistory:n,phase:`command`,currentCharacters:[]}}function I(e,t,n){return{...e,phase:`command`}}function ee(e,t){let n=t.scenes[e.currentSceneId];return n?N(e,n,t):e}function L(e,t){return{...t,sceneHistory:[...t.sceneHistory,e]}}function R(e,t,n){return(e?.commands??t?.default_commands??Object.keys(n.commands)).map(e=>n.commands[e]).filter(e=>!!e)}function te(e,t,n){let r=n.commands[e];if(!r)return{newPhase:t.phase};switch(r.action_type){case`examine`:return{newPhase:`examine`};case`move`:return{newPhase:`map`};case`inventory`:return{newPhase:`inventory`};case`talk`:{let e=n.scenes[t.currentSceneId]?.talkable??[],r={flags:t.flags,inventory:t.inventory,locationId:t.currentLocationId},i=e.filter(e=>E(e.condition??null,r)).map(e=>({characterId:e.character_id,sceneId:e.scene_id}));return i.length===0?{newPhase:`command`}:i.length===1?{newPhase:`message`,transitionSceneId:i[0].sceneId}:{newPhase:`talk_select`,talkCandidates:i}}case`system`:return{newPhase:`system_menu`};default:return{newPhase:t.phase}}}function ne(e,t,n){let r=n.locations[e];if(!r)return[];let i={flags:t.flags,inventory:t.inventory,locationId:e};return r.connections.filter(e=>E(e.condition,i))}function re(e,t,n){let r=n.locations[e];if(!r)return t;let i={...t,currentLocationId:e,currentCharacters:[],sceneHistory:[],phase:`message`};return j(r.entry_scene,i,n)}function ie(e,t){return!e.phase&&t?.next_engine?`message`:!e.phase||e.phase===`title`||e.phase===`ending`?`command`:e.phase}function z(e,t,n,r){let i=w(e.flags);return{currentSceneId:t,currentLocationId:n,currentMessageIndex:0,flags:r?.initialFlags?{...i,...r.initialFlags}:i,inventory:r?.initialInventory??[],sceneHistory:[],phase:`title`,currentCharacters:[],talkCandidates:[]}}function ae(e,t,n,r){let i=z(e,t,n,r);return v((a,o)=>({state:i,masterData:e,chapterId:r?.chapterId??`chapter1`,playtimeStart:Date.now(),startNewGame:()=>{let e=o().masterData;a({state:j(t,{...z(e,t,n,r),phase:`message`},e),playtimeStart:Date.now()})},startDebugGame:e=>{let i=o().masterData,s=z(i,t,n,r),c={...s,currentSceneId:e.sceneId,currentLocationId:e.locationId,flags:{...s.flags,...e.flags??{}},inventory:e.inventory??[],phase:`message`};a({state:j(e.sceneId,c,i),playtimeStart:Date.now()})},loadGame:e=>{let t=o().masterData.scenes[e.currentSceneId],n=ie(e,t);a({state:{currentSceneId:e.currentSceneId,currentLocationId:e.currentLocationId,currentMessageIndex:e.currentMessageIndex??0,flags:e.flags,inventory:e.inventory,sceneHistory:e.sceneHistory,phase:n,currentCharacters:e.currentCharacters??[],talkCandidates:[],pendingEngineTransition:n===`engine_transition`?t?.next_engine:void 0},playtimeStart:Date.now()-e.playtime*1e3})},toSaveData:()=>{let{state:e,playtimeStart:t}=o();return{version:1,chapterId:o().chapterId,timestamp:Date.now(),currentSceneId:e.currentSceneId,currentLocationId:e.currentLocationId,currentMessageIndex:e.currentMessageIndex,phase:e.phase,flags:e.flags,inventory:e.inventory,sceneHistory:e.sceneHistory,currentCharacters:e.currentCharacters,playtime:Math.floor((Date.now()-t)/1e3)}},advanceMessage:()=>{let{state:e,masterData:t}=o();e.phase===`message`&&a({state:M(e,t)})},selectChoice:e=>{let{state:t,masterData:n}=o();t.phase===`choice`&&a({state:P(e,t,n)})},executeCommand:e=>{let{state:t,masterData:n}=o();if(t.phase!==`command`)return;let r=te(e,t,n);if(r.transitionSceneId){let e=L(t.currentSceneId,t);a({state:j(r.transitionSceneId,e,n)})}else a({state:{...t,phase:r.newPhase,talkCandidates:r.talkCandidates??[]}})},selectTalkTarget:e=>{let{state:t,masterData:n}=o();if(t.phase!==`talk_select`)return;if(e<0){a(e=>({state:{...e.state,phase:`command`,talkCandidates:[]}}));return}let r=t.talkCandidates[e];if(!r)return;let i=L(t.currentSceneId,t);a({state:{...j(r.sceneId,i,n),talkCandidates:[]}})},completeCgSequence:()=>{let{state:e,masterData:t}=o();e.phase===`cg_sequence`&&a({state:ee(e,t)})},moveToLocation:e=>{let{state:t,masterData:n}=o();a({state:re(e,t,n)})},clickArea:e=>{let{state:t,masterData:n}=o();if(t.phase!==`examine`)return;let r=n.scenes[t.currentSceneId]?.clickable_areas?.find(t=>t.id===e);if(!r)return;let i={flags:t.flags,inventory:t.inventory,locationId:t.currentLocationId};if(!E(r.condition,i))return;let s=L(t.currentSceneId,t);a({state:j(r.next_scene,s,n)})},useItem:e=>{let{state:t,masterData:n}=o(),{newState:r,sceneId:i}=A(e,t,n);a(i?{state:j(i,L(t.currentSceneId,{...r,phase:`command`}),n)}:{state:r})},closeOverlay:()=>{a(e=>({state:{...e.state,phase:`command`}}))},goToTitle:()=>{a(e=>({state:{...e.state,phase:`title`}}))},startFromScene:(e,t,n)=>{let{state:r,masterData:i}=o();a({state:j(e,{...z(i,e,t,{}),flags:{...r.flags,...n??{}},inventory:r.inventory,phase:`message`},i),playtimeStart:Date.now()})},debugSetFlag:(e,t)=>{a(n=>({state:{...n.state,flags:{...n.state.flags,[e]:t}}}))},debugSetInventory:e=>{a(t=>({state:{...t.state,inventory:e}}))},debugJumpToScene:(e,t)=>{let{state:n,masterData:r}=o();a({state:j(e,{...n,currentLocationId:t,phase:`message`},r)})}}))}var oe=(0,a.createContext)(null);function se(){let e=(0,a.useContext)(oe);if(!e)throw Error(`useGameStore must be used within a GameStoreContext.Provider`);return b(e)}var B=t(),ce=(0,a.createContext)({resolveAsset:e=>e,resolveVoicePath:e=>`assets/voicevox/${e}.mp3`});function le({assetsBaseUrl:e,children:t}){let n=e.replace(/\/$/,``),r=(0,a.useMemo)(()=>({resolveAsset:e=>`${n}/${e}`,resolveVoicePath:e=>`${n}/voicevox/${e}.mp3`}),[n]);return(0,B.jsx)(ce.Provider,{value:r,children:t})}function V(){return(0,a.useContext)(ce)}var ue=class{prefix=`novel_`;key(e){return`${this.prefix}${e}`}setItem(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{console.warn(`[LocalStorage] Failed to save:`,e)}}getItem(e){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}}async save(e,t){this.setItem(this.key(`save_${e}`),t)}async load(e){let t=this.getItem(this.key(`save_${e}`));return!t||t.version!==1?null:t}async deleteSave(e){localStorage.removeItem(this.key(`save_${e}`))}async listSaves(){return Array.from({length:3},(e,t)=>{let n=this.getItem(this.key(`save_${t+1}`));return!n||n.version!==1?null:{slotId:t+1,data:n}})}async saveSettings(e){this.setItem(this.key(`settings`),e)}async loadSettings(){return this.getItem(this.key(`settings`))}async autoSave(e){this.setItem(this.key(`autosave`),e)}async loadAutoSave(){let e=this.getItem(this.key(`autosave`));return!e||e.version!==1?null:e}};function de(e=`localStorage`){switch(e){default:return new ue}}var fe=null;function pe(){return fe||=de(),fe}var H=new class{bgmAudio=null;voiceAudio=null;playBgm(e,t=!0,n=.8){this.bgmAudio&&this.bgmAudio.pause();let r=new Audio(e);r.loop=t,r.volume=n,r.play().catch(()=>{}),this.bgmAudio=r}stopBgm(){this.bgmAudio&&=(this.bgmAudio.pause(),null)}setBgmVolume(e){this.bgmAudio&&(this.bgmAudio.volume=Math.max(0,Math.min(1,e)))}async playVoice(e,t=.9,n){this.voiceAudio&&this.voiceAudio.pause();let r=new Audio(e);r.volume=t,this.voiceAudio=r,n&&r.addEventListener(`ended`,n,{once:!0}),console.log(`[AudioManager] playVoice:`,e.slice(0,60)),await r.play().catch(e=>console.warn(`[AudioManager] play failed:`,e))}stopVoice(){this.voiceAudio&&=(this.voiceAudio.pause(),null)}playSe(e,t=.8){let n=new Audio(e);n.volume=t,n.play().catch(()=>{})}playItemGetSe(e=.4){try{let t=new AudioContext;t.createGain().connect(t.destination);for(let{freq:n,start:r,dur:i}of[{freq:880,start:0,dur:.12},{freq:1320,start:.1,dur:.18}]){let a=t.createOscillator(),o=t.createGain();a.type=`sine`,a.frequency.setValueAtTime(n,t.currentTime+r),o.gain.setValueAtTime(0,t.currentTime+r),o.gain.linearRampToValueAtTime(e,t.currentTime+r+.01),o.gain.exponentialRampToValueAtTime(.001,t.currentTime+r+i),a.connect(o),o.connect(t.destination),a.start(t.currentTime+r),a.stop(t.currentTime+r+i)}setTimeout(()=>t.close(),600)}catch{}}},me=S((e,t)=>({settings:C,updateSettings:n=>{let r={...t().settings,...n};e({settings:r}),n.bgmVolume!==void 0&&H.setBgmVolume(n.bgmVolume),pe().saveSettings(r).catch(()=>{})},loadSettings:async()=>{let t=await pe().loadSettings().catch(()=>null);t&&(e({settings:{...C,...t}}),H.setBgmVolume(t.bgmVolume??C.bgmVolume))}})),he={btn:`_btn_jkuam_1`,btnLarge:`_btnLarge_jkuam_29`,btnSmall:`_btnSmall_jkuam_34`};function U({label:e,onClick:t,disabled:n,size:r=`normal`}){let i=r===`large`?he.btnLarge:r===`small`?he.btnSmall:``;return(0,B.jsx)(`button`,{className:`${he.btn} ${i}`,onClick:t,disabled:n,children:e})}var ge={overlay:`_overlay_2rhas_1`,box:`_box_2rhas_11`,title:`_title_2rhas_23`,closeBtn:`_closeBtn_2rhas_32`};function _e({title:e,onClose:t,children:n}){return(0,B.jsx)(`div`,{className:ge.overlay,onClick:t,children:(0,B.jsxs)(`div`,{className:ge.box,onClick:e=>e.stopPropagation(),children:[t&&(0,B.jsx)(`button`,{className:ge.closeBtn,onClick:t,children:`×`}),e&&(0,B.jsx)(`div`,{className:ge.title,children:e}),n]})})}var W={slots:`_slots_1la7k_1`,slot:`_slot_1la7k_1`,slotInfo:`_slotInfo_1la7k_17`,slotLabel:`_slotLabel_1la7k_21`,slotData:`_slotData_1la7k_27`,slotEmpty:`_slotEmpty_1la7k_32`,slotActions:`_slotActions_1la7k_38`,tabs:`_tabs_1la7k_43`,tab:`_tab_1la7k_43`,tabActive:`_tabActive_1la7k_60`};function ve({onSave:e,onLoad:t,onClose:n,initialTab:r=`save`}){let[i,o]=(0,a.useState)(r),[s,c]=(0,a.useState)([]);(0,a.useEffect)(()=>{pe().listSaves().then(c)},[]);async function l(t){await e(t),c(await pe().listSaves())}function u(e){return new Date(e).toLocaleString(`ja-JP`,{month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`})}return(0,B.jsxs)(_e,{title:`セーブ / ロード`,onClose:n,children:[(0,B.jsxs)(`div`,{className:W.tabs,children:[(0,B.jsx)(`button`,{className:`${W.tab} ${i===`save`?W.tabActive:``}`,onClick:()=>o(`save`),children:`セーブ`}),(0,B.jsx)(`button`,{className:`${W.tab} ${i===`load`?W.tabActive:``}`,onClick:()=>o(`load`),children:`ロード`})]}),(0,B.jsx)(`div`,{className:W.slots,children:Array.from({length:3},(e,r)=>{let a=r+1,o=s[r]??null;return(0,B.jsxs)(`div`,{className:W.slot,children:[(0,B.jsxs)(`div`,{className:W.slotInfo,children:[(0,B.jsxs)(`div`,{className:W.slotLabel,children:[`スロット `,a]}),o?(0,B.jsxs)(`div`,{className:W.slotData,children:[u(o.data.timestamp),`プレイ時間: `,Math.floor(o.data.playtime/60),`分`]}):(0,B.jsx)(`div`,{className:W.slotEmpty,children:`データなし`})]}),(0,B.jsxs)(`div`,{className:W.slotActions,children:[i===`save`&&(0,B.jsx)(U,{label:`セーブ`,size:`small`,onClick:()=>l(a)}),i===`load`&&o&&(0,B.jsx)(U,{label:`ロード`,size:`small`,onClick:()=>{t(o.data),n()}})]})]},a)})})]})}var ye={root:`_root_1g679_1`,title:`_title_1g679_12`,subtitle:`_subtitle_1g679_20`,actions:`_actions_1g679_28`,continueMenu:`_continueMenu_1g679_35`,chapterList:`_chapterList_1g679_42`,sectionLabel:`_sectionLabel_1g679_49`};function be({onNewGame:e,onLoad:t,chapters:n,onStartChapter:r}){let[i,o]=(0,a.useState)(!1),[s,c]=(0,a.useState)(!1),[l,u]=(0,a.useState)([]),{state:d}=se();(0,a.useEffect)(()=>{pe().listSaves().then(u)},[]);async function f(e){}function p(e){let{unlockFlag:t}=e;return!t||d.flags[t]?!0:l.some(e=>!!e?.data.flags[t])}let m=n?.filter(p)??[],h=l.some(Boolean),g=h||m.length>0;return(0,B.jsxs)(`div`,{className:ye.root,children:[(0,B.jsx)(`h1`,{className:ye.title,children:`ノベルゲーム`}),(0,B.jsx)(`p`,{className:ye.subtitle,children:`NOVEL GAME`}),(0,B.jsxs)(`div`,{className:ye.actions,children:[(0,B.jsx)(U,{label:`はじめから`,size:`large`,onClick:e}),g&&(0,B.jsx)(U,{label:`続きから`,size:`large`,onClick:()=>o(!0)})]}),i&&(0,B.jsx)(_e,{title:`続きから`,onClose:()=>o(!1),children:(0,B.jsxs)(`div`,{className:ye.continueMenu,children:[h&&(0,B.jsx)(U,{label:`セーブデータをロード`,size:`large`,onClick:()=>{o(!1),c(!0)}}),m.length>0&&(0,B.jsxs)(`div`,{className:ye.chapterList,children:[(0,B.jsx)(`div`,{className:ye.sectionLabel,children:`章を選ぶ`}),m.map(e=>(0,B.jsx)(U,{label:e.title,size:`large`,onClick:()=>{o(!1),r?.(e)}},`${e.initialSceneId}:${e.initialLocationId}`))]})]})}),s&&(0,B.jsx)(ve,{onSave:f,onLoad:e=>{c(!1),t(e)},onClose:()=>c(!1),initialTab:`load`})]})}var xe={root:`_root_1sghz_1`,img:`_img_1sghz_9`,possessed:`_possessed_1sghz_15`,possessedBgPulse:`_possessedBgPulse_1sghz_1`,possessedBgDrift:`_possessedBgDrift_1sghz_1`,fallback:`_fallback_1sghz_58`,locationName:`_locationName_1sghz_66`};function Se({backgroundPath:e,locationName:t,possessed:n=!1}){let{resolveAsset:r}=V(),[i,o]=(0,a.useState)(!1),s=e?r(e):null;return(0,a.useEffect)(()=>{o(!1)},[s]),(0,B.jsx)(`div`,{className:`${xe.root} ${n?xe.possessed:``}`,children:s&&!i?(0,B.jsx)(`img`,{className:xe.img,src:s,alt:``,onError:()=>o(!0)}):(0,B.jsx)(`div`,{className:xe.fallback,children:t&&(0,B.jsx)(`span`,{className:xe.locationName,children:t})})})}var G={root:`_root_egkzc_1`,left:`_left_egkzc_7`,center:`_center_egkzc_11`,right:`_right_egkzc_16`,img:`_img_egkzc_20`,possessed:`_possessed_egkzc_24`,possessedPulse:`_possessedPulse_egkzc_1`,placeholder:`_placeholder_egkzc_46`,placeholderName:`_placeholderName_egkzc_57`};function Ce({display:e,character:t,isSpeaking:n}){let{resolveAsset:r}=V(),[i,o]=(0,a.useState)(!1),s=n&&t.sprites?.talking?`talking`:e.expression,c=t.sprites?.[s]??t.sprites?.normal,l=c?r(c):null,u=e.expression===`possessed`,d=e.position===`left`?G.left:e.position===`right`?G.right:G.center,f=120+(e.y_offset??t.y_offset??0);return(0,B.jsx)(`div`,{className:`${G.root} ${d} ${u?G.possessed:``}`,style:{bottom:`${f}px`},children:l&&!i?(0,B.jsx)(`img`,{className:G.img,src:l,alt:t.name,onError:()=>o(!0)}):(0,B.jsx)(`div`,{className:G.placeholder,children:(0,B.jsx)(`span`,{className:G.placeholderName,children:t.name})})})}var we={root:`_root_2afjl_1`};function Te({text:e,speed:t,onComplete:n,instant:r}){let[i,o]=(0,a.useState)(``),[s,c]=(0,a.useState)(!1),l=(0,a.useRef)(null),u=(0,a.useRef)(0);return(0,a.useEffect)(()=>{if(o(``),c(!1),u.current=0,r||t===0){o(e),c(!0),n?.();return}let i=Math.max(1,Math.floor(1e3/t));return l.current=setInterval(()=>{u.current+=1,o(e.slice(0,u.current)),u.current>=e.length&&(clearInterval(l.current),c(!0),n?.())},i),()=>{l.current&&clearInterval(l.current)}},[e,t,r]),(0,B.jsx)(`span`,{className:we.root,children:i})}var Ee={baseUrl:`http://localhost:50021`,enabled:!0,prebuiltOnly:!0},De=new class{config;constructor(e=Ee){this.config=e}async isAvailable(){if(this.config.prebuiltOnly)return!1;try{return(await fetch(`${this.config.baseUrl}/version`,{signal:AbortSignal.timeout(1e3)})).ok}catch{return!1}}async synthesize(e,t){if(!this.config.enabled||this.config.prebuiltOnly)return null;try{let n=await fetch(`${this.config.baseUrl}/audio_query?text=${encodeURIComponent(e)}&speaker=${t}`,{method:`POST`});if(!n.ok)return null;let r=await n.json(),i=await fetch(`${this.config.baseUrl}/synthesis?speaker=${t}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)});return i.ok?i.arrayBuffer():null}catch{return null}}};async function Oe(e){let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-1`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}async function ke(e,t){return Oe(`${e}_${t}`)}var Ae=new Map;function je(){let e=(0,a.useRef)(!1),{resolveVoicePath:t}=V();return{speak:(0,a.useCallback)(async(n,r,i)=>{if(console.log(`[Voicevox] speak called:`,{character:r?.id,speakerId:r?.voicevox_speaker_id,voiceCharId:n.voice_character_id}),!r?.voicevox_speaker_id||!n.voice_character_id)return;let a=r.voicevox_speaker_id,o=n.text;e.current=!0;try{let e=await ke(o,a);if(console.log(`[Voicevox] synthesizing:`,{text:o,speakerId:a,hashKey:e}),Ae.has(e)){console.log(`[Voicevox] cache hit`),await H.playVoice(Ae.get(e),.9,i);return}let n=t(e),r=await fetch(n,{method:`HEAD`}).catch(()=>null);if(r?.ok&&r.headers.get(`content-type`)?.startsWith(`audio/`)){console.log(`[Voicevox] prebuilt hit`),Ae.set(e,n),await H.playVoice(n,.9,i);return}console.log(`[Voicevox] calling engine...`);let s=await De.synthesize(o,a);if(!s){console.warn(`[Voicevox] synthesize returned null (engine not running?)`);return}console.log(`[Voicevox] playing synthesized audio`);let c=new Blob([s],{type:`audio/mp3`}),l=URL.createObjectURL(c);Ae.set(e,l),await H.playVoice(l,.9,i)}finally{e.current=!1}},[t]),stop:(0,a.useCallback)(()=>{H.stopVoice()},[])}}var K={root:`_root_448af_1`,nameplate:`_nameplate_448af_10`,box:`_box_448af_22`,boxNarration:`_boxNarration_448af_32`,text:`_text_448af_42`,textNarration:`_textNarration_448af_48`,arrow:`_arrow_448af_55`,blink:`_blink_448af_1`};function Me({message:e,speaker:t,textSpeed:n,onAdvance:r,onSpeakingChange:i}){let[o,s]=(0,a.useState)(!1),[c,l]=(0,a.useState)(!1),{speak:u,stop:d}=je();(0,a.useEffect)(()=>{s(!1),l(!1),u(e,t,()=>i?.(!1)),i?.(!0)},[e.text]);function f(){o?(d(),r()):(d(),l(!0),s(!0),i?.(!1))}let p=t?.name??null,m=!p;return(0,B.jsxs)(`div`,{className:K.root,children:[p&&(0,B.jsx)(`div`,{className:K.nameplate,children:p}),(0,B.jsxs)(`div`,{className:m?K.boxNarration:K.box,onClick:f,children:[(0,B.jsx)(`div`,{className:m?K.textNarration:K.text,children:(0,B.jsx)(Te,{text:e.text,speed:n,instant:c,onComplete:()=>s(!0)})}),o&&(0,B.jsx)(`span`,{className:K.arrow,children:`▼`})]})]})}var Ne={root:`_root_13pfy_1`,box:`_box_13pfy_10`,choice:`_choice_13pfy_20`};function Pe({choices:e,flags:t,inventory:n,locationId:r,onSelect:i}){let a={flags:t,inventory:n,locationId:r},o=e.map((e,t)=>({choice:e,originalIndex:t})).filter(({choice:e})=>E(e.condition,a));return(0,B.jsx)(`div`,{className:Ne.root,children:(0,B.jsx)(`div`,{className:Ne.box,children:o.map(({choice:e,originalIndex:t})=>(0,B.jsx)(`button`,{className:Ne.choice,onClick:()=>i(t),children:e.label},t))})})}var Fe={root:`_root_1l2ff_1`,commands:`_commands_1l2ff_12`,cmd:`_cmd_1l2ff_19`};function Ie({commands:e,onSelect:t}){return(0,B.jsx)(`div`,{className:Fe.root,children:(0,B.jsx)(`div`,{className:Fe.commands,children:e.map(e=>(0,B.jsx)(`button`,{className:Fe.cmd,onClick:()=>t(e.id),title:e.description,children:e.label},e.id))})})}var Le={root:`_root_13hn2_1`,area:`_area_13hn2_7`,label:`_label_13hn2_23`,hint:`_hint_13hn2_32`,closeBtn:`_closeBtn_13hn2_44`};function Re({areas:e,flags:t,inventory:n,locationId:r,onClick:i,onClose:a}){let o={flags:t,inventory:n,locationId:r};return(0,B.jsxs)(`div`,{className:Le.root,children:[(0,B.jsx)(`div`,{className:Le.hint,children:e.length>0?`調べる場所をクリックしてください`:`調べられるものはない`}),e.filter(e=>E(e.condition,o)).map(e=>(0,B.jsx)(`div`,{className:Le.area,style:{left:e.x,top:e.y,width:e.width,height:e.height},onClick:()=>i(e.id),children:(0,B.jsx)(`span`,{className:Le.label,children:e.label})},e.id)),(0,B.jsx)(`button`,{className:Le.closeBtn,onClick:a,children:`閉じる`})]})}var ze={list:`_list_jaxq_1`,item:`_item_jaxq_8`,empty:`_empty_jaxq_26`};function Be({connections:e,onMove:t,onClose:n}){return(0,B.jsx)(_e,{title:`移動先を選択`,onClose:n,children:(0,B.jsx)(`div`,{className:ze.list,children:e.length===0?(0,B.jsx)(`p`,{className:ze.empty,children:`移動できる場所がありません`}):e.map(e=>(0,B.jsx)(`button`,{className:ze.item,onClick:()=>t(e.location_id),children:e.label},e.location_id))})})}var Ve={card:`_card_ryqrj_1`,cardSelected:`_cardSelected_ryqrj_16`,icon:`_icon_ryqrj_21`,iconPlaceholder:`_iconPlaceholder_ryqrj_27`,name:`_name_ryqrj_38`};function He({item:e,selected:t,onClick:n}){let{resolveAsset:r}=V(),[i,o]=(0,a.useState)(!1),s=e.icon?r(e.icon):null;return(0,B.jsxs)(`div`,{className:`${Ve.card} ${t?Ve.cardSelected:``}`,onClick:n,children:[s&&!i?(0,B.jsx)(`img`,{className:Ve.icon,src:s,alt:e.name,onError:()=>o(!0)}):(0,B.jsx)(`div`,{className:Ve.iconPlaceholder,children:`📦`}),(0,B.jsx)(`span`,{className:Ve.name,children:e.name})]})}var Ue={grid:`_grid_1aak1_1`,empty:`_empty_1aak1_9`,detail:`_detail_1aak1_18`,detailName:`_detailName_1aak1_24`,detailDesc:`_detailDesc_1aak1_30`,actions:`_actions_1aak1_37`};function We({state:e,masterData:t,onUse:n,onClose:r}){let[i,o]=(0,a.useState)(null),s=e.inventory.map(e=>t.items[e]).filter(e=>!!e),c=i?t.items[i]:null;return(0,B.jsxs)(_e,{title:`持ち物`,onClose:r,children:[(0,B.jsx)(`div`,{className:Ue.grid,children:s.length===0?(0,B.jsx)(`p`,{className:Ue.empty,children:`何も持っていない`}):s.map(e=>(0,B.jsx)(He,{item:e,selected:e.id===i,onClick:()=>o(e.id===i?null:e.id)},e.id))}),c&&(0,B.jsxs)(`div`,{className:Ue.detail,children:[(0,B.jsx)(`div`,{className:Ue.detailName,children:c.name}),(0,B.jsx)(`div`,{className:Ue.detailDesc,children:c.description}),(0,B.jsxs)(`div`,{className:Ue.actions,children:[c.usable&&(0,B.jsx)(U,{label:`使う`,disabled:!k(c.id,e,t),onClick:()=>n(c.id)}),(0,B.jsx)(U,{label:`閉じる`,onClick:r,size:`small`})]})]})]})}var q={body:`_body_bes5q_1`,row:`_row_bes5q_8`,label:`_label_bes5q_14`,slider:`_slider_bes5q_21`,val:`_val_bes5q_27`,footer:`_footer_bes5q_34`};function Ge({onClose:e}){let{settings:t,updateSettings:n}=me();return(0,B.jsx)(_e,{title:`設定`,onClose:e,children:(0,B.jsxs)(`div`,{className:q.body,children:[(0,B.jsxs)(`div`,{className:q.row,children:[(0,B.jsx)(`label`,{className:q.label,children:`BGM 音量`}),(0,B.jsx)(`input`,{type:`range`,min:0,max:1,step:.05,value:t.bgmVolume,className:q.slider,onChange:e=>n({bgmVolume:Number(e.target.value)})}),(0,B.jsx)(`span`,{className:q.val,children:Math.round(t.bgmVolume*100)})]}),(0,B.jsxs)(`div`,{className:q.row,children:[(0,B.jsx)(`label`,{className:q.label,children:`SE 音量`}),(0,B.jsx)(`input`,{type:`range`,min:0,max:1,step:.05,value:t.seVolume,className:q.slider,onChange:e=>n({seVolume:Number(e.target.value)})}),(0,B.jsx)(`span`,{className:q.val,children:Math.round(t.seVolume*100)})]}),(0,B.jsx)(`div`,{className:q.footer,children:(0,B.jsx)(U,{label:`閉じる`,onClick:e,size:`small`})})]})})}var Ke={btn:`_btn_c2o6e_1`,menuList:`_menuList_c2o6e_22`};function qe({onGetSaveData:e,onLoad:t,onTitle:n}){let[r,i]=(0,a.useState)(!1),[o,s]=(0,a.useState)(!1),[c,l]=(0,a.useState)(!1);async function u(t){await pe().save(t,e())}return(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(`button`,{className:Ke.btn,onClick:()=>i(!0),children:`MENU`}),r&&!o&&!c&&(0,B.jsx)(_e,{title:`システムメニュー`,onClose:()=>i(!1),children:(0,B.jsxs)(`div`,{className:Ke.menuList,children:[(0,B.jsx)(U,{label:`セーブ / ロード`,onClick:()=>s(!0)}),(0,B.jsx)(U,{label:`設定`,onClick:()=>l(!0)}),(0,B.jsx)(U,{label:`タイトルへ戻る`,onClick:()=>{i(!1),n()}}),(0,B.jsx)(U,{label:`閉じる`,onClick:()=>i(!1),size:`small`})]})}),r&&c&&(0,B.jsx)(Ge,{onClose:()=>l(!1)}),r&&o&&(0,B.jsx)(ve,{onSave:u,onLoad:e=>{t(e),s(!1),i(!1)},onClose:()=>s(!1)})]})}var Je={overlay:`_overlay_3s7kx_1`,frame:`_frame_3s7kx_10`,cgFadeIn:`_cgFadeIn_3s7kx_1`,left:`_left_3s7kx_18`,right:`_right_3s7kx_23`,center:`_center_3s7kx_28`,progress:`_progress_3s7kx_38`,dot:`_dot_3s7kx_47`,dotActive:`_dotActive_3s7kx_54`},Ye=2800;function Xe({frames:e,onComplete:t}){let{resolveAsset:n}=V(),[r,i]=(0,a.useState)(0),o=(0,a.useCallback)(()=>{i(n=>n<e.length-1?n+1:(t(),n))},[e.length,t]);(0,a.useEffect)(()=>{let e=setTimeout(o,Ye);return()=>clearTimeout(e)},[r,o]);let s=e[r],c=n(s.src);return(0,B.jsxs)(`div`,{className:Je.overlay,onClick:o,children:[(0,B.jsx)(`img`,{src:c,alt:``,className:`${Je.frame} ${Je[s.position]}`},r),(0,B.jsx)(`div`,{className:Je.progress,children:e.map((e,t)=>(0,B.jsx)(`div`,{className:`${Je.dot} ${t===r?Je.dotActive:``}`},t))})]})}var J={root:`_root_1ai4y_1`,imageStage:`_imageStage_1ai4y_9`,cgFrame:`_cgFrame_1ai4y_16`,cgMontage:`_cgMontage_1ai4y_1`,cgFrameLast:`_cgFrameLast_1ai4y_25`,cgMontageHold:`_cgMontageHold_1ai4y_1`,backdropImg:`_backdropImg_1ai4y_29`,wideImg:`_wideImg_1ai4y_39`,vignette:`_vignette_1ai4y_51`,creditsLayer:`_creditsLayer_1ai4y_73`,scrollWrap:`_scrollWrap_1ai4y_84`,scrollUp:`_scrollUp_1ai4y_1`,creditMainTitle:`_creditMainTitle_1ai4y_99`,creditSection:`_creditSection_1ai4y_107`,creditName:`_creditName_1ai4y_114`,creditSpacer:`_creditSpacer_1ai4y_121`,finText:`_finText_1ai4y_125`,finFadeIn:`_finFadeIn_1ai4y_1`},Ze=12e3,Qe=6e3,$e=[{kind:`spacer`},{kind:`section`,text:`STORY & SCRIPT`},{kind:`name`,text:`Anonymous`},{kind:`spacer`},{kind:`section`,text:`CHARACTER DESIGN`},{kind:`name`,text:`Anonymous`},{kind:`spacer`},{kind:`section`,text:`VOICE ACTING`},{kind:`name`,text:`VOICEVOX`},{kind:`spacer`},{kind:`section`,text:`MUSIC`},{kind:`name`,text:`Anonymous`},{kind:`spacer`},{kind:`section`,text:`PROGRAMMING`},{kind:`name`,text:`Anonymous`},{kind:`spacer`},{kind:`section`,text:`SPECIAL THANKS`},{kind:`name`,text:`CoderDojo 赤羽`},{kind:`spacer`},{kind:`name`,text:`Thank you for playing.`}];function et({title:e,items:t,durationSec:n}){return(0,B.jsx)(`div`,{className:J.scrollWrap,style:{animationDuration:`${n}s`},children:[{kind:`mainTitle`,text:e},...t].map((e,t)=>e.kind===`mainTitle`?(0,B.jsx)(`div`,{className:J.creditMainTitle,children:e.text},t):e.kind===`section`?(0,B.jsx)(`div`,{className:J.creditSection,children:e.text},t):e.kind===`name`?(0,B.jsx)(`div`,{className:J.creditName,children:e.text},t):(0,B.jsx)(`div`,{className:J.creditSpacer},t))})}function tt({frames:e}){let{resolveAsset:t}=V(),n=e.slice(0,4),r=Ze/Math.max(n.length,1);return(0,B.jsx)(`div`,{className:J.imageStage,children:n.map((e,i)=>{let a=t(e.src);return(0,B.jsxs)(`div`,{className:`${J.cgFrame} ${i===n.length-1?J.cgFrameLast:``}`,style:{animationDelay:`${i*r}ms`,animationDuration:`${Ze}ms`},children:[(0,B.jsx)(`img`,{className:J.backdropImg,src:a,alt:``}),(0,B.jsx)(`img`,{className:J.wideImg,src:a,alt:``})]},`${e.src}-${i}`)})})}function nt({frames:e,title:t=`赤羽の一日`,onTitle:n}){let[r,i]=(0,a.useState)(1),o=e.slice(0,4);return(0,a.useEffect)(()=>{let e=setTimeout(()=>i(2),Ze),t=setTimeout(n,Ze+Qe);return()=>{clearTimeout(e),clearTimeout(t)}},[]),(0,B.jsxs)(`div`,{className:J.root,children:[(0,B.jsx)(tt,{frames:o}),(0,B.jsx)(`div`,{className:J.vignette}),(0,B.jsx)(`div`,{className:J.creditsLayer,children:(0,B.jsx)(et,{title:t,items:$e,durationSec:Ze/1e3})}),r===2&&(0,B.jsx)(`div`,{className:J.finText,children:`Fin`})]})}var Y={overlay:`_overlay_1qhfm_1`,popup:`_popup_1qhfm_11`,popIn:`_popIn_1qhfm_1`,leaving:`_leaving_1qhfm_24`,popOut:`_popOut_1qhfm_1`,header:`_header_1qhfm_38`,body:`_body_1qhfm_47`,iconBox:`_iconBox_1qhfm_53`,iconImg:`_iconImg_1qhfm_66`,iconDefault:`_iconDefault_1qhfm_72`,info:`_info_1qhfm_77`,itemName:`_itemName_1qhfm_82`,itemDesc:`_itemDesc_1qhfm_93`},rt=2500;function it({item:e,onDismiss:t}){let{resolveAsset:n}=V(),[r,i]=(0,a.useState)(!1),o=(0,a.useRef)(!1);function s(){o.current||(o.current=!0,i(!0),setTimeout(t,280))}return(0,a.useEffect)(()=>{H.playItemGetSe();let e=setTimeout(s,rt);return()=>clearTimeout(e)},[]),(0,B.jsx)(`div`,{className:Y.overlay,children:(0,B.jsxs)(`div`,{className:`${Y.popup}${r?` ${Y.leaving}`:``}`,onClick:s,children:[(0,B.jsx)(`div`,{className:Y.header,children:`✦ アイテムを手に入れた！ ✦`}),(0,B.jsxs)(`div`,{className:Y.body,children:[(0,B.jsx)(`div`,{className:Y.iconBox,children:e.icon?(0,B.jsx)(`img`,{src:n(e.icon),alt:e.name,className:Y.iconImg}):(0,B.jsx)(`span`,{className:Y.iconDefault,children:`📦`})}),(0,B.jsxs)(`div`,{className:Y.info,children:[(0,B.jsx)(`div`,{className:Y.itemName,children:e.name}),(0,B.jsx)(`div`,{className:Y.itemDesc,children:e.description})]})]})]})})}var at={root:`_root_1g6a7_1`,cgOverlay:`_cgOverlay_1g6a7_11`,cgFadeIn:`_cgFadeIn_1g6a7_1`};function ot({onLoadGame:e,onTitle:t}){let{state:n,masterData:r,advanceMessage:i,selectChoice:o,executeCommand:s,selectTalkTarget:c,completeCgSequence:l,moveToLocation:u,clickArea:d,useItem:f,closeOverlay:p,goToTitle:m,toSaveData:h}=se(),{settings:g}=me(),{resolveAsset:_}=V(),v=r.scenes[n.currentSceneId],y=r.locations[n.currentLocationId],b=v?.messages[n.currentMessageIndex],x=b?.voice_character_id,S=x?r.characters[x]??null:null,C=R(v,y,r),w=ne(n.currentLocationId,n,r),T=v?.branches?.choices??[],[E,D]=(0,a.useState)(!1),O=b?.voice_character_id??null,k=E&&n.phase===`message`,A=(0,a.useRef)(n.inventory),[j,M]=(0,a.useState)([]);(0,a.useEffect)(()=>{if(n.phase===`message`)return;let e=A.current,t=n.inventory.filter(t=>!e.includes(t));A.current=n.inventory,t.length>0&&M(e=>[...e,...t])},[n.inventory,n.phase]);let N=(0,a.useCallback)(()=>{M(e=>e.slice(1))},[]),P=(0,a.useRef)(null);return(0,a.useEffect)(()=>{let e=v?.bgm;!e||e===P.current||(P.current=e,H.playBgm(_(e),!0,g.bgmVolume))},[v?.bgm]),(0,a.useEffect)(()=>{n.phase===`title`&&(H.stopBgm(),P.current=null)},[n.phase]),(0,a.useEffect)(()=>{n.phase===`engine_transition`&&(H.stopBgm(),H.stopVoice(),P.current=null)},[n.phase]),(0,a.useEffect)(()=>()=>{H.stopBgm(),H.stopVoice()},[]),(0,a.useEffect)(()=>{let e=e=>{e.key!==`Enter`&&e.key!==` `||n.phase===`message`&&(e.preventDefault(),i())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[n.phase,i]),(0,B.jsxs)(`div`,{className:at.root,children:[(0,B.jsx)(Se,{backgroundPath:v?.background,locationName:y?.name,possessed:v?.background_effect===`possessed`||n.currentCharacters.some(e=>e.expression===`possessed`)}),n.phase!==`examine`&&n.currentCharacters.map(e=>{let t=r.characters[e.character_id];return t?(0,B.jsx)(Ce,{display:e,character:t,isSpeaking:k&&e.character_id===O},e.character_id):null}),n.phase===`message`&&v?.overlay_image&&(0,B.jsx)(`div`,{className:at.cgOverlay,style:{backgroundImage:`url(${_(v.overlay_image)})`}}),n.phase===`examine`&&(0,B.jsx)(Re,{areas:v?.clickable_areas??[],flags:n.flags,inventory:n.inventory,locationId:n.currentLocationId,onClick:d,onClose:p}),n.phase===`message`&&b&&(0,B.jsx)(Me,{message:b,speaker:S,textSpeed:g.textSpeed,onAdvance:i,onSpeakingChange:D}),n.phase===`choice`&&(0,B.jsx)(Pe,{choices:T,flags:n.flags,inventory:n.inventory,locationId:n.currentLocationId,onSelect:o}),n.phase===`talk_select`&&(0,B.jsx)(Pe,{choices:[...n.talkCandidates.map(e=>({label:r.characters[e.characterId]?.name??e.characterId,next_scene:e.sceneId,condition:null})),{label:`やめる`,next_scene:``,condition:null}],flags:n.flags,inventory:n.inventory,locationId:n.currentLocationId,onSelect:e=>e===n.talkCandidates.length?c(-1):c(e)}),n.phase===`command`&&(0,B.jsx)(Ie,{commands:C,onSelect:s}),n.phase===`map`&&(0,B.jsx)(Be,{connections:w,onMove:u,onClose:p}),n.phase===`inventory`&&(0,B.jsx)(We,{state:n,masterData:r,onUse:f,onClose:p}),n.phase===`cg_sequence`&&v?.cg_sequence&&(0,B.jsx)(Xe,{frames:v.cg_sequence,onComplete:l}),j.length>0&&n.phase!==`ending`&&r.items[j[0]]&&(0,B.jsx)(it,{item:r.items[j[0]],onDismiss:N},j[0]),n.phase!==`ending`&&(0,B.jsx)(qe,{onGetSaveData:h,onLoad:e,onTitle:m}),n.phase===`ending`&&(0,B.jsx)(nt,{frames:v?.cg_sequence??[],title:v?.ending_title,onTitle:t??m})]})}var st=[`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`,`十`],ct=4500;function lt({chapter:e,chapterIndex:t,onDismiss:n}){let r=st[t]??String(t+1);return(0,a.useEffect)(()=>{let e=setTimeout(n,ct);return()=>clearTimeout(e)},[n]),(0,a.useEffect)(()=>{let e=e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[n]),(0,B.jsxs)(`div`,{onClick:n,style:{position:`absolute`,inset:0,background:`#06060a`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,zIndex:200,cursor:`pointer`,userSelect:`none`,animation:`chapterFadeIn 0.9s ease-out both`},children:[(0,B.jsx)(`style`,{children:`
        @keyframes chapterFadeIn {
          from { opacity: 0; }
          to   { opacity: 1; }
        }
      `}),(0,B.jsx)(`div`,{style:{width:160,height:1,background:`linear-gradient(to right, transparent, rgba(204,170,102,0.5), transparent)`,marginBottom:28}}),(0,B.jsxs)(`div`,{style:{fontFamily:`serif`,fontSize:14,letterSpacing:`0.5em`,color:`rgba(204,170,102,0.65)`,marginBottom:20},children:[`第`,r,`章`]}),(0,B.jsx)(`div`,{style:{fontFamily:`serif`,fontSize:34,letterSpacing:`0.18em`,color:`#ede0c0`,textShadow:`0 0 40px rgba(204,170,102,0.25)`,marginBottom:e.subtitle?14:0},children:e.chapterTitle}),e.subtitle&&(0,B.jsx)(`div`,{style:{fontFamily:`serif`,fontSize:13,letterSpacing:`0.25em`,color:`rgba(204,170,102,0.55)`,marginTop:4},children:e.subtitle}),(0,B.jsx)(`div`,{style:{width:160,height:1,background:`linear-gradient(to right, transparent, rgba(204,170,102,0.5), transparent)`,marginTop:28}}),(0,B.jsx)(`div`,{style:{position:`absolute`,bottom:22,fontSize:11,letterSpacing:`0.08em`,color:`rgba(204,170,102,0.28)`},children:`クリック / [Enter] で続ける`})]})}var ut=`__novel_debug_start__`;function dt(){let e=()=>{let e=Math.min(window.innerWidth/800,window.innerHeight/600);return document.fullscreenElement?e:Math.min(1,e)},[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),document.addEventListener(`fullscreenchange`,t),()=>{window.removeEventListener(`resize`,t),document.removeEventListener(`fullscreenchange`,t)}},[]),t}function ft(){let[e,t]=(0,a.useState)(!!document.fullscreenElement);return(0,a.useEffect)(()=>{let e=()=>t(!!document.fullscreenElement);return document.addEventListener(`fullscreenchange`,e),()=>document.removeEventListener(`fullscreenchange`,e)},[]),{isFullscreen:e,toggle:()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()}}}function pt({onEngineTransition:e,autoStart:t,chapters:n,onNewGame:r,onStartChapter:i,onLoadGame:o,chapterId:s}){let{state:c,startNewGame:l,startDebugGame:u,goToTitle:d,debugSetFlag:f,debugSetInventory:p,debugJumpToScene:m}=se(),{loadSettings:h}=me(),g=dt(),{isFullscreen:_,toggle:v}=ft(),y=(0,a.useRef)(e);y.current=e;let b=(0,a.useRef)(!1),[x,S]=(0,a.useState)(null);function C(e,t){if(!e.chapterTitle){t();return}let r=(n??[]).findIndex(t=>t.id===e.id);S({chapter:e,index:Math.max(0,r),action:t})}function w(){if(!x)return;let e=x.action;S(null),e()}function T(){let e=(n??[])[0];e?C(e,r):r()}let E=(0,a.useCallback)(e=>{C(e,()=>i(e))},[n,i]),D=(0,a.useCallback)(()=>{let e=n??[],t=e[e.findIndex(e=>e.id===s)+1];t?C(t,()=>i(t)):d()},[n,s,i,d]);return(0,a.useEffect)(()=>{if(h(),t){l();return}let e=localStorage.getItem(ut);if(e){b.current=!0,localStorage.removeItem(ut);try{u(JSON.parse(e))}catch{}}},[]),(0,a.useEffect)(()=>{b.current&&localStorage.setItem(`__novel_debug_state__`,JSON.stringify({flags:c.flags,inventory:c.inventory,currentSceneId:c.currentSceneId,currentLocationId:c.currentLocationId,phase:c.phase}))},[c.flags,c.inventory,c.currentSceneId,c.currentLocationId,c.phase]),(0,a.useEffect)(()=>{let e=e=>{if(!(!b.current||e.key!==`__novel_debug_cmd__`||!e.newValue))try{let t=JSON.parse(e.newValue);t.type===`setFlag`?f(t.flagId,t.value):t.type===`setInventory`?p(t.inventory):t.type===`jumpToScene`&&m(t.sceneId,t.locationId)}catch{}};return window.addEventListener(`storage`,e),()=>window.removeEventListener(`storage`,e)},[f,p,m]),(0,a.useEffect)(()=>{c.phase===`engine_transition`&&c.pendingEngineTransition&&y.current?.(c.flags,c.inventory,c.pendingEngineTransition,s)},[c.phase,c.pendingEngineTransition,s]),(0,B.jsxs)(`div`,{className:`app-wrapper`,children:[(0,B.jsxs)(`div`,{className:`game-container`,style:{transform:`scale(${g})`},children:[x&&(0,B.jsx)(lt,{chapter:x.chapter,chapterIndex:x.index,onDismiss:w}),c.phase===`title`?(0,B.jsx)(be,{onNewGame:T,onLoad:o,chapters:n,onStartChapter:E}):(0,B.jsx)(ot,{onLoadGame:o,onTitle:D})]}),(0,B.jsx)(`button`,{className:`fullscreen-btn`,onClick:v,title:_?`全画面解除`:`全画面表示`,children:_?`⊠`:`⛶`})]})}function mt({masterData:e,assetsBaseUrl:t,config:n,initialFlags:r,initialInventory:i,autoStart:o,onEngineTransition:s}){let c=n.chapters??[],l=c.find(e=>e.id===(n.chapterId??`chapter1`))??c[0]??{id:n.chapterId??`chapter1`,title:`本編`,masterData:e,initialSceneId:n.initialSceneId,initialLocationId:n.initialLocationId,initialFlags:r};function u(e,t,n){return ae(e.masterData,e.initialSceneId,e.initialLocationId,{chapterId:e.id,initialFlags:t,initialInventory:n})}let[d,f]=(0,a.useState)(()=>({key:0,chapter:l,store:u({...l,initialSceneId:n.initialSceneId},r,i)}));function p(e){let t=u(e,{...e.unlockFlag?{[e.unlockFlag]:!0}:{},...e.initialFlags??{}},[]);t.getState().startNewGame(),f(n=>({key:n.key+1,chapter:e,store:t}))}function m(){p(l)}function h(e){let t=e.chapterId??`chapter1`,n=c.find(e=>e.id===t)??l,r=u(n,e.flags,e.inventory);r.getState().loadGame({...e,chapterId:n.id}),f(e=>({key:e.key+1,chapter:n,store:r}))}let g=(0,a.useCallback)((e,t,n,r)=>{s?.(e,t,n,r)},[s]);return(0,B.jsx)(le,{assetsBaseUrl:t,children:(0,B.jsx)(oe.Provider,{value:d.store,children:(0,B.jsx)(pt,{onEngineTransition:g,autoStart:o,chapters:c,onNewGame:m,onStartChapter:p,onLoadGame:h,chapterId:d.chapter.id},d.key)})})}function ht(e){return Object.fromEntries(e.map(e=>[e.id,e]))}function gt(e,t={}){let n=[];for(let r of e){let{child_scenes:e,...i}=r,a={...t,...i};n.push(a),e?.length&&n.push(...gt(e,{location_id:a.location_id,background:a.background,bgm:a.bgm}))}return n}function _t(e){let t=r.load(e.scenes),n=r.load(e.flags),i=r.load(e.items),a=r.load(e.locations),o=r.load(e.characters),s=r.load(e.commands);return{scenes:ht(gt(t.scenes)),flags:n.flags,items:ht(i.items),locations:ht(a.locations),characters:ht(o.characters),commands:ht(s.commands)}}var vt={chapter1:s,chapter2:c,chapter3:l,chapter4:u,chapter5:d},yt={};function bt(e=`chapter1`){return yt[e]??=_t({scenes:vt[e],flags:f,items:p,locations:m,characters:h,commands:g}),yt[e]}var xt={fade:400,wipe:350,flash:150,speedline:720,rift:820,cardflip:680,numberstorm:860,timing:760,none:0},St=[{value:`7`,left:`8%`,top:`14%`,size:66,delay:0,rotate:-18,color:`#fff2a8`},{value:`3`,left:`20%`,top:`72%`,size:52,delay:90,rotate:14,color:`#8be9ff`},{value:`+`,left:`34%`,top:`24%`,size:46,delay:150,rotate:-9,color:`#ff9fd5`},{value:`12`,left:`48%`,top:`68%`,size:74,delay:40,rotate:11,color:`#ffffff`},{value:`5`,left:`62%`,top:`18%`,size:58,delay:220,rotate:17,color:`#b6ff8b`},{value:`9`,left:`78%`,top:`58%`,size:68,delay:120,rotate:-13,color:`#ffd18b`},{value:`=`,left:`86%`,top:`30%`,size:48,delay:260,rotate:8,color:`#fff2a8`},{value:`21`,left:`12%`,top:`46%`,size:82,delay:300,rotate:10,color:`#ffffff`},{value:`4`,left:`42%`,top:`8%`,size:44,delay:360,rotate:-16,color:`#8be9ff`},{value:`6`,left:`70%`,top:`78%`,size:50,delay:430,rotate:18,color:`#ff9fd5`}],Ct=`
...
`;function wt({engines:e,initial:t,initialContext:n,defaultTransition:r=`none`}){let[i,o]=(0,a.useState)(n),[s,c]=(0,a.useState)(t),[l,u]=(0,a.useState)(`idle`),[d,f]=(0,a.useState)(`none`),p=(0,a.useRef)(null);function m(e,t){let n=null;if(t?n={engineId:t.engineId,config:t.config,returnEngineId:t.returnEngineId,returnConfig:t.returnConfig,returnTransition:t.returnTransition}:s.returnEngineId&&(n={engineId:s.returnEngineId,config:s.returnConfig}),!n)return;let i=(t?t.transition:s.returnTransition)??r??`none`;if(i===`none`||!(i in xt)){o(e),c(n);return}p.current={updated:e,next:n},f(i),u(`out`)}(0,a.useEffect)(()=>{if(l!==`out`)return;let e=setTimeout(()=>{p.current&&=(o(p.current.updated),c(p.current.next),null),u(`in`)},xt[d]);return()=>clearTimeout(e)},[l,d]),(0,a.useEffect)(()=>{if(l!==`in`)return;let e=setTimeout(()=>u(`idle`),xt[d]);return()=>clearTimeout(e)},[l,d]);let h=e[s.engineId];if(!h)return(0,B.jsxs)(`div`,{style:{padding:24,color:`red`},children:[`Engine not found: `,s.engineId]});let g=h.component,_=l!==`idle`,v=d===`flash`?`#fff`:d===`speedline`?[`radial-gradient(circle at 50% 50%, rgba(255,255,255,0.95) 0 5%, rgba(255,210,90,0.78) 9%, rgba(255,120,70,0.38) 18%, rgba(0,0,0,0.92) 58%)`,`repeating-linear-gradient(100deg, rgba(255,255,255,0.95) 0 8px, rgba(255,210,90,0.35) 8px 14px, rgba(0,0,0,0) 14px 34px)`,`#050505`].join(`, `):d===`rift`?[`radial-gradient(circle at 50% 50%, rgba(190,120,255,0.95) 0 4%, rgba(80,20,120,0.82) 13%, rgba(12,2,24,0.98) 54%, #000 100%)`,`repeating-conic-gradient(from 0deg, rgba(210,170,255,0.24) 0deg 7deg, rgba(0,0,0,0) 7deg 18deg)`,`#000`].join(`, `):d===`cardflip`?[`radial-gradient(circle at 50% 50%, rgba(255,245,210,0.9) 0 8%, rgba(110,45,80,0.84) 34%, rgba(12,8,22,0.98) 74%)`,`linear-gradient(90deg, rgba(255,255,255,0.20) 0 1px, transparent 1px 80px)`,`linear-gradient(0deg, rgba(255,255,255,0.16) 0 1px, transparent 1px 112px)`,`#0d0712`].join(`, `):d===`numberstorm`?[`radial-gradient(circle at 50% 46%, rgba(255,255,255,0.98) 0 6%, rgba(255,230,92,0.74) 14%, rgba(25,190,220,0.38) 33%, rgba(21,24,60,0.96) 72%)`,`repeating-linear-gradient(24deg, rgba(255,255,255,0.18) 0 2px, transparent 2px 28px)`,`repeating-linear-gradient(116deg, rgba(255,223,92,0.17) 0 2px, transparent 2px 34px)`,`#11183c`].join(`, `):d===`timing`?[`radial-gradient(circle at 50% 50%, rgba(255,246,160,0.95) 0 5%, rgba(255,80,124,0.58) 16%, rgba(18,12,32,0.96) 68%, #05050a 100%)`,`repeating-linear-gradient(90deg, rgba(255,235,120,0.28) 0 3px, transparent 3px 54px)`,`repeating-linear-gradient(0deg, rgba(255,95,135,0.16) 0 2px, transparent 2px 42px)`].join(`, `):`#000`,y=_?{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`all`,background:v,backgroundSize:d===`speedline`?`100% 100%, 220px 100%, 100% 100%`:d===`rift`?`100% 100%, 180px 180px, 100% 100%`:d===`cardflip`?`100% 100%, 80px 100%, 100% 112px, 100% 100%`:d===`numberstorm`?`100% 100%, 120px 120px, 150px 150px, 100% 100%`:d===`timing`?`100% 100%, 54px 100%, 100% 42px`:void 0,animation:`hub-${d}-${l} ${xt[d]}ms ease forwards`}:{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`none`,opacity:0};return(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(`style`,{children:Ct}),(0,B.jsx)(g,{context:i,config:s.config,onExit:m}),(0,B.jsxs)(`div`,{style:y,children:[_&&d===`speedline`&&(0,B.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#fff7c8`,fontFamily:`'Impact', 'Arial Black', sans-serif`,fontSize:96,letterSpacing:0,textShadow:`0 0 18px rgba(255,118,54,0.95), 0 8px 0 rgba(0,0,0,0.55)`,transform:l===`out`?`rotate(-5deg) scale(1.08)`:`rotate(5deg) scale(0.96)`},children:`RUN!`}),_&&d===`cardflip`&&(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:190,height:260,borderRadius:8,border:`2px solid rgba(255,245,210,0.95)`,background:`linear-gradient(145deg, rgba(255,245,210,0.96), rgba(170,80,130,0.92))`,boxShadow:`0 0 30px rgba(255,230,160,0.8), inset 0 0 0 10px rgba(70,22,48,0.32)`,transform:`translate(-50%, -50%) ${l===`out`?`rotate(-4deg)`:`rotate(4deg)`}`}}),_&&d===`numberstorm`&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:210,height:210,borderRadius:`50%`,background:`radial-gradient(circle, rgba(255,255,255,0.96) 0 18%, rgba(255,222,82,0.84) 31%, rgba(34,206,230,0.22) 56%, transparent 70%)`,boxShadow:`0 0 34px rgba(255,234,94,0.85), 0 0 72px rgba(73,220,255,0.48)`,animation:`hub-number-pulse 520ms ease-in-out infinite`}}),(0,B.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#162057`,fontFamily:`'Arial Black', 'Impact', sans-serif`,fontSize:64,letterSpacing:0,textShadow:`0 2px 0 rgba(255,255,255,0.8), 0 0 16px rgba(255,241,124,0.9)`},children:`COUNT!`}),St.map((e,t)=>(0,B.jsx)(`span`,{style:{position:`absolute`,left:e.left,top:e.top,color:e.color,fontFamily:`'Arial Black', 'Impact', sans-serif`,fontSize:e.size,lineHeight:1,letterSpacing:0,textShadow:`0 0 16px rgba(255,255,255,0.92), 0 5px 0 rgba(7,11,34,0.42)`,transform:`rotate(${e.rotate}deg)`,animation:`hub-number-fly 620ms cubic-bezier(0.2, 0.9, 0.2, 1) ${e.delay}ms both`},children:e.value},`${e.value}-${t}`))]}),_&&d===`timing`&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:260,height:260,borderRadius:`50%`,border:`5px solid rgba(255,232,112,0.86)`,boxShadow:`0 0 28px rgba(255,232,112,0.86), inset 0 0 48px rgba(255,88,132,0.38)`,animation:`hub-timing-ring 420ms ease-in-out infinite`}}),(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:16,height:330,marginLeft:-8,marginTop:-165,borderRadius:999,background:`#ff5f87`,boxShadow:`0 0 20px rgba(255,95,135,0.95)`,transformOrigin:`50% 50%`,transform:`rotate(${l===`out`?-36:36}deg)`}}),(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:560,height:14,marginLeft:-280,marginTop:-7,borderRadius:999,background:`linear-gradient(90deg, transparent, rgba(255,244,172,0.95), transparent)`,animation:`hub-timing-sweep 620ms cubic-bezier(0.2, 0.9, 0.2, 1) infinite`}}),(0,B.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#fff6b0`,fontFamily:`'Arial Black', 'Impact', sans-serif`,fontSize:70,letterSpacing:0,textShadow:`0 0 18px rgba(255,232,112,0.95), 0 7px 0 rgba(0,0,0,0.42)`},children:`TIMING!`})]})]})]})}function Tt({context:e,config:t,onExit:n}){let r=(0,a.useCallback)((r,i,a,o)=>{let s={flags:r,inventory:i,playerStats:e.playerStats};if(a.id===`__return__`){n(s);return}let c=Object.values(t.masterData.items).map(e=>({id:e.id,name:e.name,usable:e.usable,description:e.description,category:e.category})),l=a.config??{},u={},d=(e,n)=>{if(typeof e!=`string`)return;let r=t.masterData.characters[e];if(!r)return;u[`${n}Name`]=r.name;let i=r.sprites?.normal??(r.sprites?Object.values(r.sprites)[0]:void 0);i&&(u[`${n}FaceImage`]=i),r.voicevox_speaker_id&&(u[`${n}VoicevoxSpeakerId`]=r.voicevox_speaker_id)};d(l.playerCharacterId,`player`),d(l.opponentCharacterId,`opponent`);let f={masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,chapterId:o,initialLocationId:t.initialLocationId,chapters:t.chapters,exitSceneId:a.return_scene,gameoverSceneId:a.gameover_scene,gameoverBossSceneId:a.gameover_boss_scene,gameoverLandingSceneId:a.gameover_landing_scene};n(s,{engineId:a.id,transition:a.transition,config:{assetsBaseUrl:t.assetsBaseUrl,items:c,...u,...a.config??{},_novelReturn:f},returnEngineId:a.return_scene?`novel`:void 0,returnConfig:a.return_scene?{...t,chapterId:o,initialSceneId:a.return_scene,autoStart:!0}:void 0})},[e.playerStats,t,n]);return(0,B.jsx)(mt,{masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,config:{initialSceneId:t.initialSceneId,initialLocationId:t.initialLocationId,chapterId:t.chapterId,chapters:t.chapters},initialFlags:e.flags,initialInventory:e.inventory,autoStart:t.autoStart,onEngineTransition:r})}var Et={component:Tt},Dt={dungeon_01:[`###########`,`#S........#`,`#.#######.#`,`###.......#`,`###.#######`,`###.....###`,`#######.###`,`#######.###`,`#######.###`,`#######...#`,`#########X#`,`###########`],dungeon_02:[`###############`,`#S..........###`,`#.#########.###`,`###.........###`,`###.#######.###`,`###E#.........#`,`###.#.#########`,`###.#.........#`,`###.###########`,`###..........B#`,`#############X#`,`###############`],dungeon_03:[`###############`,`#S.....##.#####`,`#.#######.#####`,`#.#######.#####`,`#.#######.#####`,`#.###.#E......#`,`#.###.#.#####.#`,`#.###.#.#####.#`,`#.###.#.#####.#`,`#.......#####B#`,`#############X#`,`###############`]};function Ot(e){return{...e,maxHp:e.hp}}var kt={ghost:{id:`ghost`,name:`ゴースト`,hp:10,atk:4,def:1},bat:{id:`bat`,name:`コウモリ`,hp:6,atk:3,def:0},wraith:{id:`wraith`,name:`レイス`,hp:14,atk:5,def:2}},At={dungeon_02:[kt.ghost,kt.bat,kt.wraith],dungeon_03:[kt.ghost,kt.bat,kt.wraith]},jt={dungeon_02:{id:`maze_boss`,name:`迷宮の主`,hp:22,atk:7,def:2},dungeon_03:{id:`maze_boss`,name:`迷宮の主`,hp:22,atk:7,def:2}};function Mt(e){let t=jt[e];return t?Ot(t):null}function Nt(e){let t=At[e];return!t||t.length===0?null:Ot(t[Math.floor(Math.random()*t.length)])}function Pt(e){let t=Nt(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が現れた！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function Ft(e){let t=Mt(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が立ちはだかった！　逃げられない！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function It(e){let{battle:t}=e;if(!t)return e;let n=Math.max(1,t.enemy.atk-(t.guarding?e.playerDef*2:e.playerDef)),r=e.playerHp-n,i=[...t.log,`${t.enemy.name} の攻撃！ ケン に ${n} ダメージ！`];return r<=0?{...e,playerHp:0,battle:{...t,phase:`lose`,log:[...i,`ケン は倒れた……`],guarding:!1}}:{...e,playerHp:r,battle:{...t,phase:`select`,log:i,guarding:!1}}}function Lt(e){let{battle:t}=e;if(!t)return e;if(t.cursorIndex===3){if(e.pendingBossTilePos){let n=[...t.log,`逃げることはできない！`];return It({...e,battle:{...t,log:n,guarding:!1}})}if(Math.random()<.5)return{...e,battle:null};let n=[...t.log,`逃げられなかった！`];return It({...e,battle:{...t,log:n,guarding:!1}})}if(t.cursorIndex===1){let n=[...t.log,`ケン は身を守った！`];return It({...e,battle:{...t,log:n,guarding:!0}})}if(t.cursorIndex===2)return e;let n=Math.max(1,e.playerAtk-t.enemy.def),r=t.enemy.hp-n,i=[...t.log,`ケン の攻撃！ ${t.enemy.name} に ${n} ダメージ！`];if(r<=0){let n={...t.enemy,hp:0};return{...e,battle:{...t,enemy:n,phase:`win`,log:[...i,`${t.enemy.name} を倒した！`],guarding:!1}}}let a={...t.enemy,hp:r};return It({...e,battle:{...t,enemy:a,log:i,guarding:!1}})}function Rt(e,t){let{battle:n}=e;if(!n)return e;let r=t===`Enter`||t===` `,i=t===`ArrowUp`||t===`w`||t===`W`,a=t===`ArrowDown`||t===`s`||t===`S`;if(n.phase===`select`)return i?{...e,battle:{...n,cursorIndex:(n.cursorIndex+3)%4}}:a?{...e,battle:{...n,cursorIndex:(n.cursorIndex+1)%4}}:r?Lt(e):e;if(!r)return e;if(n.phase===`win`){if(e.pendingBossTilePos){let t=new Set(e.triggeredEvents);return t.add(e.pendingBossTilePos),{...e,battle:null,pendingBossTilePos:null,triggeredEvents:t}}return{...e,battle:null}}return n.phase===`lose`?{...e,pendingDeath:!0}:e}var zt=.2,Bt={N:{fwd:{x:0,y:-1},left:{x:-1,y:0},right:{x:1,y:0},back:{x:0,y:1}},E:{fwd:{x:1,y:0},left:{x:0,y:-1},right:{x:0,y:1},back:{x:-1,y:0}},S:{fwd:{x:0,y:1},left:{x:1,y:0},right:{x:-1,y:0},back:{x:0,y:-1}},W:{fwd:{x:-1,y:0},left:{x:0,y:1},right:{x:0,y:-1},back:{x:1,y:0}}},Vt={N:`W`,W:`S`,S:`E`,E:`N`},Ht={N:`E`,E:`S`,S:`W`,W:`N`};function Ut(e,t,n){return n<0||n>=e.length||t<0||t>=(e[n]?.length??0)?`#`:e[n][t]??`#`}function Wt(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Gt(e,t){return{x:e.x*t,y:e.y*t}}function Kt(e){for(let t=0;t<e.length;t++){let n=e[t].indexOf(`S`);if(n>=0)return{x:n,y:t}}return{x:1,y:1}}function qt(e,t,n,r){let i=Dt[e]??Dt.dungeon_01,a=r?.initialPos??Kt(i),o=r?.initialDir??`N`,s=t?.maxHp??20,c=Math.min(s,Math.max(1,t?.hp??s)),l=r?.initialVisited?new Set(r.initialVisited):new Set([`${a.x},${a.y}`]),u=r?.initialTriggeredEvents?new Set(r.initialTriggeredEvents):new Set;return{pos:a,dir:o,map:i,mapId:e,visited:l,atExit:!1,steps:0,playerHp:c,playerMaxHp:s,playerAtk:t?.atk??5,playerDef:t?.def??2,battle:null,inventory:n??[],pendingEvent:null,triggeredEvents:u,pendingDeath:!1,pendingBossTilePos:null}}function Jt(e,t,n,r){let i=e.inventory.indexOf(t);if(i===-1||r?.attackEnemy!==void 0&&!e.battle)return e;let a=[...e.inventory.slice(0,i),...e.inventory.slice(i+1)],o=[`${n}を使った！`],s=e.playerHp;if(r?.healHp===`full`?(s=e.playerMaxHp,o.push(`HPが全回復した！`)):typeof r?.healHp==`number`&&(s=Math.min(e.playerMaxHp,e.playerHp+r.healHp),o.push(`HPが ${r.healHp} 回復した！`)),e.battle&&r?.attackEnemy!==void 0){let t=e.battle.enemy,n=Math.min(r.attackEnemy,t.hp),i=Math.max(0,t.hp-r.attackEnemy);o.push(`${t.name} に ${n} の大ダメージ！`);let c={...t,hp:i};return i<=0?(o.push(`${t.name} を倒した！`),{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,phase:`win`,log:[...e.battle.log,...o]}}):{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,log:[...e.battle.log,...o]}}}if(e.battle){let t=[...e.battle.log,...o];return{...e,inventory:a,playerHp:s,battle:{...e.battle,log:t}}}return{...e,inventory:a,playerHp:s}}var Yt=new Set([`.`,`S`,`X`,`#`]);function Xt(e,t){let n=Wt(e.pos,t),r=Ut(e.map,n.x,n.y);if(r===`#`)return e;let i=`${n.x},${n.y}`,a=new Set(e.visited);a.add(i);let o=r===`X`,s={...e,pos:n,visited:a,atExit:o,steps:e.steps+1};return!o&&r===`B`&&!e.triggeredEvents.has(i)?Ft({...s,pendingBossTilePos:i}):!o&&!Yt.has(r)&&r!==`B`&&!e.triggeredEvents.has(i)?{...s,pendingEvent:r}:!o&&r!==`B`&&At[e.mapId]&&Math.random()<zt?Pt(s):s}function Zt(e){return Xt(e,Bt[e.dir].fwd)}function Qt(e){return Xt(e,Bt[e.dir].back)}function $t(e){return{...e,dir:Vt[e.dir]}}function en(e){return{...e,dir:Ht[e.dir]}}function tn(e,t){if(e.pendingDeath)return e;if(e.battle)return Rt(e,t);if(e.pendingEvent!==null||e.atExit)return e;switch(t){case`ArrowUp`:case`w`:case`W`:return Zt(e);case`ArrowDown`:case`s`:case`S`:return Qt(e);case`ArrowLeft`:case`a`:case`A`:return $t(e);case`ArrowRight`:case`d`:case`D`:return en(e);default:return e}}function nn(e,t){let{fwd:n,left:r,right:i}=Bt[e.dir],a=[!1],o=[!1],s=[!1];for(let c=1;c<=t;c++){let t=Wt(e.pos,Gt(n,c));a.push(Ut(e.map,t.x,t.y)===`#`);let l=Wt(e.pos,Gt(n,c-1));o.push(Ut(e.map,Wt(l,r).x,Wt(l,r).y)===`#`),s.push(Ut(e.map,Wt(l,i).x,Wt(l,i).y)===`#`)}return{front:a,left:o,right:s}}var rn=480,an=320,on=4,sn=[[0,0,480,320],[60,40,420,280],[120,80,360,240],[172,110,308,210],[207,128,273,192]],cn=[1,1,.78,.56,.38];function ln(e,t,n,r){return`rgb(${Math.round(e*r)},${Math.round(t*r)},${Math.round(n*r)})`}function un(e){let t=parseInt(e.replace(`#`,``),16);return[t>>16&255,t>>8&255,t&255]}function dn(e,t,n){let{front:r,left:i,right:a}=nn(t,on),[o,s,c]=un(n.wallFront),[l,u,d]=un(n.wallSide),f=e.createLinearGradient(0,0,0,an/2);f.addColorStop(0,n.ceilTop),f.addColorStop(1,n.ceilBottom),e.fillStyle=f,e.fillRect(0,0,rn,an/2);let p=e.createLinearGradient(0,an/2,0,an);p.addColorStop(0,n.floorTop),p.addColorStop(1,n.floorBottom),e.fillStyle=p,e.fillRect(0,an/2,rn,an/2);let m=on;for(let e=1;e<=on;e++)if(r[e]){m=e;break}for(let t=m;t>=1;t--){let n=cn[t]??.3,[f,p,m,h]=sn[t],[g,_,v,y]=sn[t-1];if(r[t]){e.fillStyle=ln(o,s,c,n),e.fillRect(f,p,m-f,h-p),e.strokeStyle=`rgba(0,0,0,0.45)`,e.lineWidth=1;let t=Math.max(8,Math.floor((h-p)/3));for(let n=p+t;n<h;n+=t)e.beginPath(),e.moveTo(f,n),e.lineTo(m,n),e.stroke();let r=Math.floor((h-p)/t);for(let n=0;n<r;n++){let r=n%2*Math.floor((m-f)/4),i=Math.max(6,Math.floor((m-f)/3));for(let a=f+r;a<m;a+=i)e.beginPath(),e.moveTo(a,p+n*t),e.lineTo(a,p+(n+1)*t),e.stroke()}}i[t]&&(e.fillStyle=ln(l,u,d,n),e.beginPath(),e.moveTo(g,_),e.lineTo(f,p),e.lineTo(f,h),e.lineTo(g,y),e.closePath(),e.fill(),e.strokeStyle=ln(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(f,p),e.lineTo(f,h),e.stroke()),a[t]&&(e.fillStyle=ln(l,u,d,n),e.beginPath(),e.moveTo(m,p),e.lineTo(v,_),e.lineTo(v,y),e.lineTo(m,h),e.closePath(),e.fill(),e.strokeStyle=ln(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(m,p),e.lineTo(m,h),e.stroke())}if(!r[m]&&m===on){let[t,r,i,a]=sn[on];e.fillStyle=n.ceilTop,e.fillRect(t,r,i-t,a-r)}}var fn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function pn({state:e,theme:t}){let n=(0,a.useRef)(null),r=t??fn;return(0,a.useEffect)(()=>{let t=n.current?.getContext(`2d`);t&&dn(t,e,r)},[e,r]),(0,B.jsx)(`canvas`,{ref:n,width:rn,height:an,style:{display:`block`,imageRendering:`pixelated`}})}var X=10,mn=3,hn={N:[[0,-5],[-4,4],[4,4]],E:[[5,0],[-4,-4],[-4,4]],S:[[0,5],[-4,-4],[4,-4]],W:[[-5,0],[4,-4],[4,4]]};function gn({state:e,mode:t=`full`}){let n=(0,a.useRef)(null),r=e.map[0]?.length??0,i=e.map.length,o=r*X+mn*2,s=i*X+mn*2;return(0,a.useEffect)(()=>{let a=n.current?.getContext(`2d`);if(!a)return;a.clearRect(0,0,o,s),a.fillStyle=`#0a0a0a`,a.fillRect(0,0,o,s);for(let n=0;n<i;n++)for(let i=0;i<r;i++){let r=e.map[n]?.[i]??`#`,o=`${i},${n}`,s=e.visited.has(o),c=mn+i*X,l=mn+n*X;if(t===`visited`&&!s){a.fillStyle=`#050505`,a.fillRect(c,l,X,X);continue}r===`#`?(a.fillStyle=s?`#554433`:`#2a1a0a`,a.fillRect(c,l,X,X)):(a.fillStyle=s?`#443322`:`#110a04`,a.fillRect(c,l,X,X),r===`X`&&(a.fillStyle=`#33bb55`,a.fillRect(c+2,l+2,X-4,X-4)))}let c=mn+e.pos.x*X+X/2,l=mn+e.pos.y*X+X/2,u=hn[e.dir]??hn.N;a.fillStyle=`#ffdd00`,a.beginPath(),a.moveTo(c+u[0][0],l+u[0][1]),a.lineTo(c+u[1][0],l+u[1][1]),a.lineTo(c+u[2][0],l+u[2][1]),a.closePath(),a.fill()},[e,o,s,i,r,t]),(0,B.jsx)(`canvas`,{ref:n,width:o,height:s,style:{display:`block`,imageRendering:`pixelated`}})}var _n=[`攻撃`,`防御`,`アイテム`,`逃げる`];function vn({hp:e,maxHp:t,color:n}){return(0,B.jsx)(`div`,{style:{height:8,background:`#2a2020`,borderRadius:4,overflow:`hidden`},children:(0,B.jsx)(`div`,{style:{width:`${Math.max(0,Math.min(1,t>0?e/t:0))*100}%`,height:`100%`,background:n,transition:`width 0.2s`,borderRadius:4}})})}function yn({label:e,active:t,font:n,theme:r,onHover:i,onClick:o}){let[s,c]=(0,a.useState)(!1),l=t||s;return(0,B.jsx)(`div`,{onMouseEnter:()=>{c(!0),i()},onMouseLeave:()=>c(!1),onClick:o,style:{flex:1,fontSize:13,padding:`8px 0`,background:l?r.uiBorder:`#1a1008`,color:r.uiAccent,border:`1px solid ${l?r.uiAccent:r.uiBorder}`,borderRadius:3,cursor:`pointer`,userSelect:`none`,textAlign:`center`,fontFamily:n,transition:`background 0.1s, border-color 0.1s`},children:e})}function bn({state:e,theme:t,onSelectCommand:n,onCommand:r,font:i}){let{battle:a}=e;if(!a)return null;let o=a.log.at(-1);return(0,B.jsxs)(`div`,{style:{width:`100%`,display:`flex`,flexDirection:`column`,gap:8,flexShrink:0,fontFamily:i},children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:t.uiAccent},children:[(0,B.jsx)(`span`,{children:a.enemy.name}),(0,B.jsxs)(`span`,{style:{opacity:.65},children:[`HP `,a.enemy.hp,`/`,a.enemy.maxHp]})]}),(0,B.jsx)(vn,{hp:a.enemy.hp,maxHp:a.enemy.maxHp,color:`#e05050`})]}),a.phase===`select`?(0,B.jsx)(`div`,{style:{display:`flex`,gap:6},children:_n.map((e,o)=>(0,B.jsx)(yn,{label:e,active:a.cursorIndex===o,font:i,theme:t,onHover:()=>n?.(o),onClick:()=>{n?.(o),r?.(o)}},e))}):a.phase===`win`?(0,B.jsx)(`div`,{style:{fontSize:12,color:`#d8b8ff`,opacity:.95,userSelect:`none`,textShadow:`0 0 8px rgba(180,120,255,0.65)`},children:`撃破！`}):(0,B.jsx)(`div`,{style:{fontSize:12,color:`#ff9090`,opacity:.95,userSelect:`none`},children:`倒れてしまった……`}),(0,B.jsxs)(`div`,{style:{borderTop:`1px solid ${t.uiBorder}`,paddingTop:6},children:[o&&(0,B.jsx)(`div`,{style:{fontSize:13,lineHeight:1.5,marginBottom:5,color:`#f3dfaa`,textShadow:`0 0 6px rgba(204,170,102,0.35)`},children:o}),(0,B.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2,maxHeight:74,overflow:`hidden`,background:`rgba(0,0,0,0.18)`,border:`1px solid ${t.uiBorder}`,borderRadius:3,padding:`5px 6px`},children:a.log.slice(-5).map((e,t,n)=>(0,B.jsx)(`div`,{style:{fontSize:11,lineHeight:1.35,opacity:.36+(t+1)/n.length*.5},children:e},`${e}-${t}`))})]})]})}function xn({enemy:e,assetsBaseUrl:t,defeated:n=!1,onClick:r}){let i=e.maxHp>0?e.hp/e.maxHp:1,a=.4+i*.6,o=`${t}/enemies/${e.id}.png`,s=e.id===`maze_boss`;return(0,B.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,pointerEvents:`none`},children:[(0,B.jsx)(`div`,{style:{position:`absolute`,width:s?380:250,height:s?340:220,borderRadius:`50%`,background:s?`radial-gradient(circle, rgba(80,0,0,0.80) 0%, rgba(0,0,0,0.60) 40%, transparent 70%)`:`radial-gradient(circle, rgba(0,0,0,0.70) 0%, transparent 68%)`}}),(0,B.jsx)(`img`,{src:o,alt:e.name,style:{position:`relative`,maxHeight:s?280:180,maxWidth:s?300:220,objectFit:`contain`,opacity:a,transition:`opacity 0.5s, transform 0.45s, filter 0.45s`,imageRendering:`pixelated`,transform:n?`scale(1.18) rotate(-3deg)`:void 0,pointerEvents:r&&!n?`auto`:`none`,cursor:r&&!n?`crosshair`:`default`,filter:n?`brightness(2.3) saturate(0) blur(2px) drop-shadow(0 0 28px rgba(220,180,255,0.95))`:s?`drop-shadow(0 0 18px rgba(200,0,0,${.3+i*.5}))`:void 0},title:r&&!n?`${e.name}を攻撃`:void 0,onClick:r,onError:e=>{e.target.style.display=`none`}}),n&&(0,B.jsx)(`div`,{style:{position:`absolute`,width:s?360:250,height:s?300:210,borderRadius:`50%`,background:`radial-gradient(circle, rgba(255,255,255,0.95) 0%, rgba(180,120,255,0.5) 26%, transparent 68%)`,mixBlendMode:`screen`,animation:`maze-enemy-burst 650ms ease-out forwards`}})]})}function Sn(e){if(!e)return`迷路内で特別な効果はない`;let t=[];return e.healHp===`full`?t.push(`HP全回復`):typeof e.healHp==`number`&&t.push(`HP+${e.healHp}`),typeof e.attackEnemy==`number`&&t.push(`敵に${e.attackEnemy}ダメージ`),t.length>0?t.join(` / `):`迷路内で特別な効果はない`}function Cn(e){switch(e){case`key_item`:return`大事なもの`;case`consumable`:return`消耗品`;case`tool`:return`道具`;case`misc`:return`その他`;default:return`アイテム`}}function wn(e,t,n){return e?.usable?n===`explore`&&t?.attackEnemy!==void 0?{canUse:!1,reason:`戦闘中のみ使用可`}:n===`battle`&&!t?.healHp&&t?.attackEnemy===void 0?{canUse:!1,reason:`戦闘中は効果なし`}:{canUse:!0,reason:`使用可能`}:{canUse:!1,reason:`使用できない`}}function Tn({name:e,selected:t,usable:n,count:r,theme:i,font:a,onSelect:o}){return(0,B.jsxs)(`button`,{type:`button`,onClick:o,style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,width:`100%`,fontSize:12,minHeight:30,padding:`6px 8px`,borderRadius:3,cursor:`pointer`,background:t?i.uiBorder:`transparent`,border:`1px solid ${t?i.uiAccent:i.uiBorder}`,color:n?i.uiAccent:i.uiBorder,opacity:n?1:.55,fontFamily:a,userSelect:`none`,transition:`background 0.12s, border-color 0.12s`},children:[(0,B.jsx)(`span`,{style:{overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:e}),(0,B.jsx)(`span`,{style:{fontSize:10,opacity:.65,flexShrink:0,marginLeft:6},children:r>1?`x${r}`:``})]})}function En({inventory:e,itemDefs:t,theme:n,mode:r,expanded:i=!1,itemEffects:a,selectedItemId:o,onSelect:s,onUse:c,onClose:l,notification:u,font:d}){let f=new Map(t.map(e=>[e.id,e])),p=new Map;for(let t of e)p.set(t,(p.get(t)??0)+1);let m=[...p.keys()],h=o&&p.has(o)?o:null,g=h?f.get(h):void 0,_=g?.name??h??``,v=h?a?.[h]:void 0,y=wn(g,v,r);return(0,B.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:6,minHeight:0,flex:1},children:[(0,B.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,gap:8,borderTop:`1px solid ${n.uiBorder}`,paddingTop:8,flexShrink:0,fontSize:10,color:n.uiBorder,letterSpacing:`0.08em`,fontFamily:d},children:[(0,B.jsxs)(`div`,{children:[`アイテム`,(0,B.jsx)(`span`,{style:{marginLeft:8,color:n.uiAccent,opacity:.7},children:r===`battle`?`戦闘中`:`探索中`})]}),l&&(0,B.jsx)(`button`,{type:`button`,onClick:l,style:{flexShrink:0,border:`1px solid ${n.uiBorder}`,background:`transparent`,color:n.uiAccent,borderRadius:3,padding:`4px 10px`,cursor:`pointer`,fontFamily:d,fontSize:11},children:`戻る`})]}),u&&(0,B.jsx)(`div`,{style:{fontSize:11,color:n.uiAccent,padding:`3px 6px`,background:`${n.uiBorder}55`,borderRadius:3,fontFamily:d,flexShrink:0},children:u}),m.length===0?(0,B.jsx)(`div`,{style:{fontSize:11,color:n.uiBorder,opacity:.4,padding:`2px 4px`,fontFamily:d},children:`持ち物なし`}):(0,B.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:3,flex:i?`1 1 210px`:`1 1 128px`,minHeight:i?190:112,overflow:`auto`,paddingRight:2},children:m.map(e=>{let t=f.get(e),i=a?.[e],o=wn(t,i,r);return(0,B.jsx)(Tn,{name:t?.name??e,selected:h===e,usable:o.canUse,count:p.get(e)??1,theme:n,font:d,onSelect:()=>s(e)},e)})}),(0,B.jsx)(`div`,{style:{flex:i?`0 0 190px`:`0 0 150px`,minHeight:i?190:150,border:`1px solid ${n.uiBorder}`,borderRadius:3,background:`rgba(0,0,0,0.18)`,padding:`7px 8px`,fontFamily:d,display:`flex`,flexDirection:`column`,gap:6,overflow:`hidden`},children:h?(0,B.jsxs)(B.Fragment,{children:[(0,B.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,gap:8,alignItems:`baseline`},children:[(0,B.jsx)(`strong`,{style:{color:n.uiAccent,fontSize:13,fontWeight:700},children:_}),(0,B.jsxs)(`span`,{style:{color:n.uiBorder,fontSize:10,whiteSpace:`nowrap`},children:[Cn(g?.category),` `,p.get(h)>1?`x${p.get(h)}`:``]})]}),(0,B.jsx)(`div`,{style:{color:`#e8d5aa`,fontSize:11,lineHeight:1.45,minHeight:44,overflow:`auto`,paddingRight:2},children:g?.description??`説明はない。`}),(0,B.jsxs)(`div`,{style:{color:n.uiAccent,fontSize:11,opacity:.85},children:[`効果: `,Sn(v)]}),(0,B.jsxs)(`div`,{style:{display:`flex`,gap:6,alignItems:`center`,marginTop:`auto`},children:[(0,B.jsx)(`button`,{type:`button`,disabled:!y.canUse,onClick:()=>c(h,_),style:{flex:`0 0 76px`,padding:i?`8px 0`:`6px 0`,borderRadius:3,border:`1px solid ${y.canUse?n.uiAccent:n.uiBorder}`,background:y.canUse?n.uiBorder:`transparent`,color:y.canUse?n.uiAccent:n.uiBorder,cursor:y.canUse?`pointer`:`default`,fontFamily:d,fontSize:12},children:`使う`}),(0,B.jsx)(`span`,{style:{color:y.canUse?n.uiAccent:n.uiBorder,fontSize:10,opacity:.8},children:y.reason})]})]}):(0,B.jsx)(`div`,{style:{color:n.uiBorder,opacity:.55,fontSize:11,lineHeight:1.5},children:`アイテムを選ぶと、説明と効果を確認できます。`})})]})}var Dn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function On(e){return e?{...Dn,...e}:Dn}var kn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,An={N:`北`,E:`東`,S:`南`,W:`西`};function jn(){let e=()=>Math.min(1,Math.min(window.innerWidth/800,window.innerHeight/600)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function Mn(e,t,n,r){let i=r&&n?n:t;(0,a.useEffect)(()=>{if(!i)return;let t=`${e.replace(/\/$/,``)}/${i}`,n=new Audio(t);return n.loop=!0,n.volume=.6,n.play().catch(()=>{}),()=>{n.pause(),n.currentTime=0}},[i,e])}function Nn({hp:e,maxHp:t,theme:n}){let r=Math.max(0,Math.min(1,t>0?e/t:0)),i=r>.5?`#50c050`:r>.25?`#c0a020`:`#e03030`;return(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:n.uiAccent},children:[(0,B.jsx)(`span`,{style:{letterSpacing:`0.06em`},children:`HP`}),(0,B.jsxs)(`span`,{style:{opacity:.8},children:[e,` / `,t]})]}),(0,B.jsx)(`div`,{style:{height:6,background:`#2a2020`,borderRadius:3,overflow:`hidden`},children:(0,B.jsx)(`div`,{style:{width:`${r*100}%`,height:`100%`,background:i,transition:`width 0.3s`,borderRadius:3}})})]})}function Pn(){return(0,B.jsxs)(`div`,{"aria-hidden":`true`,style:{position:`absolute`,inset:0,pointerEvents:`none`,overflow:`hidden`,zIndex:6},children:[(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`56%`,width:250,height:120,borderRadius:`50%`,background:`radial-gradient(ellipse, rgba(180,255,190,0.45) 0%, rgba(120,255,170,0.16) 45%, transparent 72%)`,boxShadow:`0 0 36px rgba(150,255,190,0.6)`,transform:`translate(-50%, -50%)`,animation:`maze-heal-aura 900ms ease-out forwards`}}),[{left:`22%`,top:`62%`,delay:`0ms`,size:8},{left:`33%`,top:`36%`,delay:`90ms`,size:5},{left:`46%`,top:`68%`,delay:`170ms`,size:7},{left:`57%`,top:`32%`,delay:`40ms`,size:6},{left:`70%`,top:`56%`,delay:`130ms`,size:9},{left:`39%`,top:`48%`,delay:`230ms`,size:5},{left:`62%`,top:`72%`,delay:`280ms`,size:6}].map((e,t)=>(0,B.jsx)(`span`,{style:{position:`absolute`,left:e.left,top:e.top,width:e.size,height:e.size,transform:`translate(-50%, -50%) rotate(45deg)`,background:`#f4ffe1`,boxShadow:`0 0 10px #d8ff95, 0 0 18px rgba(120,255,170,0.9)`,animation:`maze-heal-sparkle 780ms ease-out ${e.delay} forwards`,opacity:0}},t))]})}function Fn({label:e,theme:t,onClick:n}){let[r,i]=(0,a.useState)(!1);return(0,B.jsx)(`button`,{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),onClick:n,style:{flex:1,background:r?t.uiBorder:`#1a1008`,border:`1px solid ${r?t.uiAccent:t.uiBorder}`,color:t.uiAccent,fontFamily:kn,fontSize:12,padding:`8px 4px`,cursor:`pointer`,borderRadius:3,userSelect:`none`,textAlign:`center`,transition:`background 0.1s, border-color 0.1s`},children:e})}function In({context:e,config:t,onExit:n}){let r=jn(),[i,o]=(0,a.useState)(()=>qt(t.map,e.playerStats,e.inventory,{initialPos:t.initialPos,initialDir:t.initialDir,initialVisited:t.initialVisited,initialTriggeredEvents:t.initialTriggeredEvents})),s=On(t.theme),c=t.assetsBaseUrl??`/assets`;Mn(c,t.bgm,t.battleBgm,!!i.battle);let[l,u]=(0,a.useState)(`explore`),[d,f]=(0,a.useState)(null),[p,m]=(0,a.useState)(null),[h,g]=(0,a.useState)(!1),[_,v]=(0,a.useState)(!1),[y,b]=(0,a.useState)(0),x=(0,a.useRef)(null),S=(0,a.useRef)(i.battle),C=!!i.battle&&l===`battle`,w=(0,a.useCallback)(e=>{o(t=>tn(t,e))},[]),T=(0,a.useCallback)(()=>{u(`explore`),f(null)},[]),E=(0,a.useCallback)(()=>{!i.battle||i.battle.phase!==`select`||(g(!0),window.setTimeout(()=>g(!1),180),o(e=>!e.battle||e.battle.phase!==`select`?e:tn({...e,battle:{...e.battle,cursorIndex:0}},`Enter`)))},[i.battle]),D=(0,a.useCallback)((e,n)=>{let r=t.itemEffects?.[e];r?.attackEnemy!==void 0&&!i.battle||(r?.healHp!==void 0&&b(e=>e+1),o(t=>Jt(t,e,n,r)),f(null),i.battle?u(`explore`):(x.current&&clearTimeout(x.current),m(r?.healHp===`full`?`${n}を使った！ HP全回復！`:typeof r?.healHp==`number`?`${n}を使った！ HP+${r.healHp}！`:`${n}を使った！`),x.current=setTimeout(()=>m(null),2500)))},[t.itemEffects,i.battle]);(0,a.useEffect)(()=>{let e=e=>{if([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Enter`,` `].includes(e.key)&&e.preventDefault(),l===`battle`){e.key===`Escape`&&T();return}let t=e.key===`Enter`||e.key===` `;o(n=>n.battle?.phase===`select`&&n.battle.cursorIndex===2&&t?(u(`battle`),n):tn(n,e.key))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[T,l]),(0,a.useEffect)(()=>{i.battle||u(`explore`),(!i.battle||i.battle.phase!==`select`)&&f(null)},[i.battle]),(0,a.useEffect)(()=>{d&&!i.inventory.includes(d)&&f(null)},[d,i.inventory]),(0,a.useEffect)(()=>{let e=S.current,t=i.battle;if(t?.phase===`win`&&e?.phase!==`win`){v(!0);let e=window.setTimeout(()=>v(!1),900);return S.current=t,()=>window.clearTimeout(e)}(!t||t.phase===`select`)&&v(!1),S.current=t},[i.battle]),(0,a.useEffect)(()=>{if(i.battle?.phase!==`win`&&i.battle?.phase!==`lose`)return;let e=i.battle.phase===`win`?850:1050,t=window.setTimeout(()=>{o(e=>e.battle?.phase!==`win`&&e.battle?.phase!==`lose`?e:tn(e,`Enter`))},e);return()=>window.clearTimeout(t)},[i.battle?.phase]);let O=(0,a.useCallback)(()=>({...e,flags:{...e.flags,[`explored_${t.map}`]:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}}),[e,t.map,i.inventory,i.playerHp,i.playerMaxHp,i.playerAtk,i.playerDef]),k=(0,a.useCallback)(()=>{let e=O(),r={...e,playerStats:{...e.playerStats,hp:i.playerMaxHp}},a=t._novelReturn;a?.exitSceneId?n(r,{engineId:`novel`,config:{...a,initialSceneId:a.exitSceneId,autoStart:!0}}):n(r)},[O,t._novelReturn,n,i.playerMaxHp]);(0,a.useEffect)(()=>{if(!i.pendingDeath)return;let r=t._novelReturn;if(r){if(i.pendingBossTilePos&&r.gameoverBossSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0,flag_boss_challenged:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},[o,s]=i.pendingBossTilePos.split(`,`).map(Number),c={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn,initialPos:{x:(o??0)-1,y:s??0},initialDir:`E`,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverBossSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:c,returnTransition:`rift`})}else if(r.gameoverSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},o={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:o,returnTransition:`rift`})}}},[i.pendingDeath]),(0,a.useEffect)(()=>{if(!i.pendingEvent)return;let e=t.events?.[i.pendingEvent],r=t._novelReturn;if(!e||!r)return;let a=O(),o=`${i.pos.x},${i.pos.y}`,s={...t,initialPos:i.pos,initialDir:i.dir,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents,o]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:e,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:s,returnTransition:`rift`})},[i.pendingEvent]);let A=(0,a.useCallback)(e=>{i.atExit&&(e.key!==`Enter`&&e.key!==` `||k())},[i.atExit,k]);return(0,a.useEffect)(()=>(window.addEventListener(`keydown`,A),()=>window.removeEventListener(`keydown`,A)),[A]),(0,B.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:s.uiBg,overflow:`hidden`},children:(0,B.jsxs)(`div`,{style:{width:800,height:600,flexShrink:0,transformOrigin:`center center`,transform:`scale(${r})`,background:s.uiBg,display:`flex`,flexDirection:`column`,fontFamily:kn,color:s.uiAccent,userSelect:`none`,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`},children:[(0,B.jsx)(`style`,{children:`
        ...
        `}),(0,B.jsxs)(`div`,{style:{background:s.uiBorder,borderBottom:`1px solid ${s.uiBorder}`,padding:`4px 12px`,fontSize:13,display:`flex`,justifyContent:`space-between`,alignItems:`center`,flexShrink:0,letterSpacing:`0.06em`},children:[(0,B.jsxs)(`span`,{children:[`⚔ `,t.name??t.map]}),(0,B.jsxs)(`span`,{style:{fontSize:11,opacity:.7},children:[`歩数: `,i.steps]})]}),(0,B.jsxs)(`div`,{style:{display:`flex`,flex:1,overflow:`hidden`},children:[(0,B.jsx)(`div`,{style:{flex:`0 0 488px`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,B.jsxs)(`div`,{style:{position:`relative`},children:[(0,B.jsxs)(`div`,{style:{border:`2px solid ${s.uiBorder}`,boxShadow:`0 0 12px rgba(100,60,10,0.4)`,position:`relative`},children:[(0,B.jsx)(pn,{state:i,theme:s}),y>0&&(0,B.jsx)(Pn,{},y),i.battle&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(xn,{enemy:i.battle.enemy,assetsBaseUrl:c,defeated:_||i.battle.phase===`win`,onClick:i.battle.phase===`select`?E:void 0}),h&&(0,B.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`45%`,width:240,height:18,borderRadius:10,background:`linear-gradient(90deg, transparent, rgba(255,255,255,0.98), rgba(180,90,255,0.7), transparent)`,boxShadow:`0 0 18px rgba(220,180,255,0.9)`,pointerEvents:`none`,animation:`maze-hit-slash 180ms ease-out forwards`}})]}),!i.battle&&!i.atExit&&(0,B.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`grid`,gridTemplateColumns:`1fr 2fr 1fr`,gridTemplateRows:`1fr 1fr`},children:[(0,B.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>w(`ArrowLeft`)}),(0,B.jsx)(`div`,{title:`前進`,style:{cursor:`n-resize`},onClick:()=>w(`ArrowUp`)}),(0,B.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>w(`ArrowRight`)}),(0,B.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>w(`ArrowLeft`)}),(0,B.jsx)(`div`,{title:`後退`,style:{cursor:`s-resize`},onClick:()=>w(`ArrowDown`)}),(0,B.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>w(`ArrowRight`)})]})]}),i.atExit&&(0,B.jsx)(`div`,{onClick:k,style:{marginTop:8,background:`#1a2a0a`,border:`1px solid #44aa22`,borderRadius:4,padding:`8px 16px`,color:`#88ff44`,fontSize:14,textAlign:`center`,cursor:`pointer`,fontFamily:kn,letterSpacing:`0.04em`},children:`階段を見つけた！ [Enter] / クリックで地上へ戻る`})]})}),(0,B.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,borderLeft:`1px solid ${s.uiBorder}`,padding:`10px 10px 8px`,gap:8,overflow:`hidden`},children:[(0,B.jsx)(Nn,{hp:i.playerHp,maxHp:i.playerMaxHp,theme:s}),!C&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),(0,B.jsxs)(`div`,{style:{display:`flex`,gap:10,alignItems:`flex-start`,justifyContent:`center`},children:[(0,B.jsx)(`div`,{style:{border:`1px solid ${s.uiBorder}`},children:(0,B.jsx)(gn,{state:i,mode:t.minimapMode})}),(0,B.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:4},children:[(0,B.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`24px 24px 24px`,gridTemplateRows:`24px 24px 24px`,gap:2,textAlign:`center`},children:[[``,`N`,``].map((e,t)=>(0,B.jsx)(Ln,{label:e,dir:i.dir,theme:s},`t${t}`)),[`W`,``,`E`].map((e,t)=>(0,B.jsx)(Ln,{label:e,dir:i.dir,theme:s},`m${t}`)),[``,`S`,``].map((e,t)=>(0,B.jsx)(Ln,{label:e,dir:i.dir,theme:s},`b${t}`))]}),(0,B.jsx)(`div`,{style:{fontSize:11,color:s.uiAccent,letterSpacing:`0.05em`},children:An[i.dir]}),(0,B.jsxs)(`div`,{style:{fontSize:9,color:s.uiBorder,letterSpacing:`0.04em`},children:[`(`,i.pos.x,`,`,i.pos.y,`)`]})]})]}),(0,B.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),i.battle?(0,B.jsx)(bn,{state:i,theme:s,font:kn,onSelectCommand:e=>o(t=>!t.battle||t.battle.phase!==`select`?t:{...t,battle:{...t.battle,cursorIndex:e}}),onCommand:e=>{if(e===2){u(`battle`);return}u(`explore`),o(t=>!t.battle||t.battle.phase!==`select`?t:tn({...t,battle:{...t.battle,cursorIndex:e}},`Enter`))}}):(0,B.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,B.jsx)(`div`,{style:{display:`flex`},children:(0,B.jsx)(Fn,{label:`↑ 前進`,theme:s,onClick:()=>w(`ArrowUp`)})}),(0,B.jsxs)(`div`,{style:{display:`flex`,gap:4},children:[(0,B.jsx)(Fn,{label:`← 左`,theme:s,onClick:()=>w(`ArrowLeft`)}),(0,B.jsx)(Fn,{label:`↓ 後退`,theme:s,onClick:()=>w(`ArrowDown`)}),(0,B.jsx)(Fn,{label:`→ 右`,theme:s,onClick:()=>w(`ArrowRight`)})]})]})]}),(0,B.jsx)(En,{inventory:i.inventory,itemDefs:t.items??[],theme:s,mode:i.battle?l:`explore`,expanded:C,itemEffects:t.itemEffects,selectedItemId:d,onSelect:f,onUse:D,onClose:C?T:void 0,notification:p??void 0,font:kn})]})]})]})})}function Ln({label:e,dir:t,theme:n}){let r=e===t;return(0,B.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,background:r?n.uiBorder:e?n.uiBg:`transparent`,border:e?`1px solid ${r?n.uiAccent:n.uiBorder}`:`none`,borderRadius:2,color:r?n.uiAccent:n.uiBorder,fontWeight:r?`bold`:`normal`,fontSize:10,fontFamily:kn},children:e})}var Rn={component:In},Z=800,zn=600,Bn=50,Vn=zn-Bn*2,Q=Bn+Vn-50,$=150,Hn=42,Un=72,Wn=.0017,Gn=-.82,Kn=3e4,qn=420,Jn=100,Yn=.0048,Xn=18,Zn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,Qn=[{id:`candy_01`,type:`candy`,spawnMs:1600,laneY:356,speed:.34,size:28},{id:`pot_01`,type:`pot`,spawnMs:3300,laneY:395,speed:.38,size:46},{id:`candy_02`,type:`candy`,spawnMs:4700,laneY:318,speed:.37,size:28},{id:`candy_03`,type:`candy`,spawnMs:6600,laneY:392,speed:.42,size:30},{id:`pot_02`,type:`pot`,spawnMs:8200,laneY:342,speed:.43,size:48},{id:`candy_04`,type:`candy`,spawnMs:1e4,laneY:360,speed:.46,size:28},{id:`candy_05`,type:`candy`,spawnMs:11800,laneY:302,speed:.42,size:30},{id:`pot_03`,type:`pot`,spawnMs:13700,laneY:400,speed:.48,size:50},{id:`candy_06`,type:`candy`,spawnMs:15400,laneY:340,speed:.48,size:30},{id:`candy_07`,type:`candy`,spawnMs:17600,laneY:388,speed:.52,size:28},{id:`pot_04`,type:`pot`,spawnMs:19600,laneY:330,speed:.52,size:50},{id:`candy_08`,type:`candy`,spawnMs:21500,laneY:358,speed:.55,size:30},{id:`candy_09`,type:`candy`,spawnMs:23800,laneY:305,speed:.5,size:28},{id:`pot_05`,type:`pot`,spawnMs:26e3,laneY:390,speed:.56,size:52},{id:`candy_10`,type:`candy`,spawnMs:27800,laneY:346,speed:.58,size:30}],$n=[{id:`dog_01`,type:`dog`,spawnMs:1800,laneY:392,speed:.42,size:48},{id:`bird_01`,type:`bird`,spawnMs:3800,laneY:300,speed:.46,size:42},{id:`dog_02`,type:`dog`,spawnMs:6200,laneY:394,speed:.5,size:50},{id:`bird_02`,type:`bird`,spawnMs:8400,laneY:292,speed:.52,size:44},{id:`dog_03`,type:`dog`,spawnMs:11100,laneY:396,speed:.56,size:52},{id:`bird_03`,type:`bird`,spawnMs:13600,laneY:306,speed:.58,size:42},{id:`dog_04`,type:`dog`,spawnMs:16400,laneY:390,speed:.62,size:52},{id:`bird_04`,type:`bird`,spawnMs:19e3,laneY:298,speed:.64,size:44}],er=[{id:`dog_01`,type:`dog`,spawnMs:1500,laneY:392,speed:.34,size:48},{id:`dog_02`,type:`dog`,spawnMs:2500,laneY:392,speed:.36,size:48},{id:`bird_01`,type:`bird`,spawnMs:3400,laneY:350,speed:.38,size:42},{id:`bird_02`,type:`bird`,spawnMs:4550,laneY:346,speed:.39,size:42},{id:`dog_03`,type:`dog`,spawnMs:5600,laneY:392,speed:.4,size:50},{id:`dog_04`,type:`dog`,spawnMs:6800,laneY:392,speed:.41,size:50},{id:`bird_03`,type:`bird`,spawnMs:7800,laneY:342,speed:.42,size:44},{id:`bird_04`,type:`bird`,spawnMs:9100,laneY:352,speed:.44,size:42},{id:`dog_05`,type:`dog`,spawnMs:10300,laneY:392,speed:.46,size:52},{id:`dog_06`,type:`dog`,spawnMs:11600,laneY:392,speed:.47,size:50},{id:`bird_05`,type:`bird`,spawnMs:13e3,laneY:354,speed:.48,size:42},{id:`bird_06`,type:`bird`,spawnMs:14400,laneY:344,speed:.49,size:44},{id:`dog_07`,type:`dog`,spawnMs:15800,laneY:392,speed:.5,size:52},{id:`dog_08`,type:`dog`,spawnMs:17300,laneY:392,speed:.51,size:52},{id:`bird_07`,type:`bird`,spawnMs:18800,laneY:346,speed:.52,size:44},{id:`bird_08`,type:`bird`,spawnMs:20400,laneY:356,speed:.53,size:42},{id:`dog_09`,type:`dog`,spawnMs:22e3,laneY:392,speed:.54,size:54},{id:`dog_10`,type:`dog`,spawnMs:23500,laneY:392,speed:.55,size:52},{id:`bird_09`,type:`bird`,spawnMs:25e3,laneY:350,speed:.56,size:44},{id:`bird_10`,type:`bird`,spawnMs:26700,laneY:344,speed:.57,size:44},{id:`drop_01`,type:`bird`,spawnMs:4200,laneY:170,speed:.34,size:46,pattern:`diagonalDrop`},{id:`drop_02`,type:`bird`,spawnMs:9e3,laneY:155,speed:.38,size:48,pattern:`diagonalDrop`},{id:`drop_03`,type:`bird`,spawnMs:14800,laneY:165,speed:.43,size:48,pattern:`diagonalDrop`},{id:`drop_04`,type:`bird`,spawnMs:20700,laneY:150,speed:.48,size:50,pattern:`diagonalDrop`},{id:`drop_05`,type:`bird`,spawnMs:26200,laneY:160,speed:.52,size:50,pattern:`diagonalDrop`}],tr=[{id:`deep_dog_01`,type:`dog`,spawnMs:1400,laneY:392,speed:.42,size:50},{id:`wobble_01`,type:`bird`,spawnMs:2600,laneY:326,speed:.38,size:48,pattern:`wobble`},{id:`deep_dog_02`,type:`dog`,spawnMs:4200,laneY:392,speed:.46,size:52},{id:`wobble_02`,type:`bird`,spawnMs:5600,laneY:310,speed:.42,size:50,pattern:`wobble`},{id:`drop_deep_01`,type:`bird`,spawnMs:7200,laneY:145,speed:.44,size:48,pattern:`diagonalDrop`},{id:`wobble_03`,type:`bird`,spawnMs:8800,laneY:348,speed:.46,size:46,pattern:`wobble`},{id:`deep_dog_03`,type:`dog`,spawnMs:10400,laneY:392,speed:.52,size:54},{id:`wobble_04`,type:`bird`,spawnMs:12200,laneY:318,speed:.5,size:50,pattern:`wobble`},{id:`drop_deep_02`,type:`bird`,spawnMs:14400,laneY:150,speed:.5,size:50,pattern:`diagonalDrop`},{id:`wobble_05`,type:`bird`,spawnMs:16600,laneY:338,speed:.54,size:50,pattern:`wobble`},{id:`deep_dog_04`,type:`dog`,spawnMs:18800,laneY:392,speed:.58,size:54},{id:`wobble_06`,type:`bird`,spawnMs:21e3,laneY:314,speed:.58,size:52,pattern:`wobble`},{id:`drop_deep_03`,type:`bird`,spawnMs:23400,laneY:140,speed:.56,size:52,pattern:`diagonalDrop`},{id:`wobble_07`,type:`bird`,spawnMs:25800,laneY:344,speed:.62,size:52,pattern:`wobble`}],nr={sky:`#151827`,ground:`#2a2d32`,accent:`#f2d16b`};function rr(e){return{...nr,...e}}function ir(){let e=()=>Math.min(1,Math.min(window.innerWidth/Z,window.innerHeight/zn)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function ar(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function or(e){let[t,n]=(0,a.useState)(null),[r,i]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{if(!e){n(null),i(!1);return}let t=!1,r=new Image;return r.onload=()=>{t||(n(r),i(!1))},r.onerror=()=>{t||(n(null),i(!0))},r.src=e,()=>{t=!0}},[e]),{image:t,failed:r}}function sr(e,t,n=.28){(0,a.useEffect)(()=>{let r,i=Math.max(0,Math.min(1,n));if(t?.startsWith(`synth:`))return r=cr(i),()=>r?.();if(t){let n=new Audio(ar(e,t));return n.loop=!0,n.volume=i,n.play().catch(()=>{}),r=()=>{n.pause(),n.currentTime=0},()=>r?.()}},[e,t,n])}function cr(e){let t=window.AudioContext??window.webkitAudioContext;if(!t)return()=>{};let n=new t,r=n.createGain();r.gain.value=e,r.connect(n.destination);let i=n.createDelay();i.delayTime.value=.18;let a=n.createGain();a.gain.value=.18,i.connect(a),a.connect(i),i.connect(r);let o=[392,523.25,659.25,783.99,659.25,523.25,440,587.33],s=0,c=!1,l=()=>{if(c)return;let e=n.currentTime,t=n.createOscillator(),a=n.createGain();t.type=s%4==0?`square`:`triangle`,t.frequency.setValueAtTime(o[s%o.length],e),a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.24,e+.018),a.gain.exponentialRampToValueAtTime(1e-4,e+.16),t.connect(a),a.connect(r),a.connect(i),t.start(e),t.stop(e+.18),s+=1};n.resume().catch(()=>{}),l();let u=window.setInterval(l,135);return()=>{c=!0,window.clearInterval(u),n.close().catch(()=>{})}}function lr(){let e=window.AudioContext??window.webkitAudioContext;if(!e)return;let t=new e,n=t.currentTime,r=t.createGain(),i=t.createOscillator(),a=t.createOscillator(),o=t.createGain();r.gain.setValueAtTime(1e-4,n),r.gain.exponentialRampToValueAtTime(.22,n+.01),r.gain.exponentialRampToValueAtTime(1e-4,n+.16),r.connect(t.destination),i.type=`square`,i.frequency.setValueAtTime(220,n),i.frequency.exponentialRampToValueAtTime(680,n+.09),i.connect(r),a.type=`triangle`,a.frequency.setValueAtTime(980,n),a.frequency.exponentialRampToValueAtTime(420,n+.08),o.gain.setValueAtTime(1e-4,n),o.gain.exponentialRampToValueAtTime(.16,n+.006),o.gain.exponentialRampToValueAtTime(1e-4,n+.11),a.connect(o),o.connect(r),t.resume().catch(()=>{}),i.start(n),a.start(n),i.stop(n+.16),a.stop(n+.12),window.setTimeout(()=>void t.close().catch(()=>{}),220)}function ur(e,t,n=1){return Z+80-Math.max(0,t-e.spawnMs)*e.speed*n}function dr(e,t=e.spawnMs,n=1){if(e.pattern===`wobble`){let r=Math.max(0,t-e.spawnMs)*e.speed*n;return e.laneY+Math.sin(r*.032)*26}if(e.pattern===`diagonalDrop`){let r=Math.max(0,t-e.spawnMs)*e.speed*n;return Math.min(Q-e.size-6,e.laneY+r*.56)}return e.type===`dog`?Q-e.size:e.laneY}function fr(e,t,n=`entrance`){return t?n===`deep`?tr:er:e===`chase`?$n:Qn}function pr(e,t){return e.x<t.x+t.width&&e.x+e.width>t.x&&e.y<t.y+t.height&&e.y+e.height>t.y}function mr(e,t){let n=e.y-(Q-Un);return Q-t+n}function hr(e,t,n,r,i){let a=Math.sin(i*.012)*4;e.save(),e.translate(t+r/2,n+r/2),e.rotate(Math.sin(i*.008)*.4),e.fillStyle=`#ff7aa8`,e.beginPath(),e.ellipse(0,0,r*.42,r*.3,0,0,Math.PI*2),e.fill(),e.fillStyle=`#fff1b8`,e.fillRect(-r*.14,-r*.28+a*.03,r*.28,r*.56),e.fillStyle=`#ffd6e5`,e.beginPath(),e.moveTo(-r*.38,0),e.lineTo(-r*.62,-r*.2),e.lineTo(-r*.62,r*.2),e.closePath(),e.fill(),e.beginPath(),e.moveTo(r*.38,0),e.lineTo(r*.62,-r*.2),e.lineTo(r*.62,r*.2),e.closePath(),e.fill(),e.restore()}function gr(e,t,n,r,i){e.save(),e.translate(t+r/2,n+r/2),e.rotate(i*.012),e.fillStyle=`#59606b`,e.beginPath(),e.roundRect(-r*.42,-r*.25,r*.84,r*.58,r*.12),e.fill(),e.strokeStyle=`#d5dde8`,e.lineWidth=4,e.beginPath(),e.arc(0,-r*.32,r*.28,Math.PI,Math.PI*2),e.stroke(),e.strokeStyle=`#2c3139`,e.lineWidth=5,e.beginPath(),e.moveTo(-r*.5,-r*.08),e.lineTo(-r*.7,-r*.08),e.moveTo(r*.5,-r*.08),e.lineTo(r*.7,-r*.08),e.stroke(),e.restore()}function _r(e,t,n,r,i){let a=Math.sin(i*.02)*3;e.save(),e.translate(t+r,n),e.scale(-1,1),e.fillStyle=`#8b5a3c`,e.fillRect(r*.16,r*.34,r*.58,r*.3),e.fillStyle=`#a46a45`,e.beginPath(),e.arc(r*.74,r*.36,r*.18,0,Math.PI*2),e.fill(),e.fillStyle=`#5b3928`,e.beginPath(),e.moveTo(r*.68,r*.22),e.lineTo(r*.78,r*.02),e.lineTo(r*.84,r*.26),e.closePath(),e.fill(),e.strokeStyle=`#5b3928`,e.lineWidth=4,e.beginPath(),e.moveTo(r*.15,r*.38),e.quadraticCurveTo(-r*.05,r*.18,r*.1,r*.08),e.stroke(),e.fillStyle=`#3b2319`,e.fillRect(r*.24,r*.62,r*.1,r*.24+a),e.fillRect(r*.56,r*.62,r*.1,r*.24-a),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.8,r*.34,2.5,0,Math.PI*2),e.fill(),e.restore()}function vr(e,t,n,r,i){let a=Math.sin(i*.012)*r*.06,o=.82+Math.sin(i*.018)*.12;e.save(),e.translate(t+r/2,n+r/2+a),e.globalAlpha=.92,e.shadowColor=`rgba(255,105,145,0.62)`,e.shadowBlur=16;let s=e.createRadialGradient(0,-r*.14,r*.08,0,0,r*.58);s.addColorStop(0,`rgba(255,238,248,${o})`),s.addColorStop(.62,`rgba(255,126,164,0.72)`),s.addColorStop(1,`rgba(112,42,92,0.52)`),e.fillStyle=s,e.beginPath(),e.moveTo(-r*.36,r*.34),e.quadraticCurveTo(-r*.46,r*.02,-r*.32,-r*.22),e.quadraticCurveTo(-r*.16,-r*.5,r*.08,-r*.46),e.quadraticCurveTo(r*.42,-r*.4,r*.38,-r*.02),e.lineTo(r*.36,r*.34),e.quadraticCurveTo(r*.25,r*.24,r*.14,r*.34),e.quadraticCurveTo(r*.02,r*.44,-r*.1,r*.34),e.quadraticCurveTo(-r*.23,r*.24,-r*.36,r*.34),e.closePath(),e.fill(),e.shadowBlur=0,e.fillStyle=`#301223`,e.beginPath(),e.ellipse(-r*.13,-r*.14,r*.055,r*.085,0,0,Math.PI*2),e.ellipse(r*.12,-r*.14,r*.055,r*.085,0,0,Math.PI*2),e.fill(),e.strokeStyle=`#301223`,e.lineWidth=Math.max(2,r*.05),e.beginPath(),e.arc(0,r*.03,r*.09,.1,Math.PI-.1),e.stroke(),e.strokeStyle=`rgba(255,226,241,0.56)`,e.lineWidth=2,e.beginPath(),e.moveTo(-r*.21,-r*.31),e.quadraticCurveTo(-r*.05,-r*.43,r*.14,-r*.34),e.stroke(),e.restore()}function yr(e,t,n,r,i){let a=Math.sin(i*.024)*r*.16;e.save(),e.translate(t+r/2,n+r/2),e.fillStyle=`#3f78a8`,e.beginPath(),e.ellipse(0,0,r*.28,r*.2,0,0,Math.PI*2),e.fill(),e.fillStyle=`#72b7d2`,e.beginPath(),e.moveTo(-r*.08,-r*.06),e.quadraticCurveTo(-r*.44,-r*.36-a,-r*.5,r*.02),e.quadraticCurveTo(-r*.26,r*.06,-r*.08,r*.04),e.fill(),e.beginPath(),e.moveTo(r*.08,-r*.06),e.quadraticCurveTo(r*.44,-r*.36+a,r*.5,r*.02),e.quadraticCurveTo(r*.26,r*.06,r*.08,r*.04),e.fill(),e.fillStyle=`#f2d16b`,e.beginPath(),e.moveTo(r*.28,-r*.02),e.lineTo(r*.44,r*.04),e.lineTo(r*.28,r*.1),e.closePath(),e.fill(),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.16,-r*.06,2.4,0,Math.PI*2),e.fill(),e.restore()}function br(e,t,n){let r=Math.min(650,$+95+t*3.6),i=Q-74+Math.sin(n*.02)*3;e.save(),e.translate(r,i),e.fillStyle=`#f1d2b0`,e.fillRect(13,0,24,22),e.fillStyle=`#2b2f39`,e.fillRect(8,20,34,36),e.fillStyle=`#e6533f`,e.fillRect(4,28,42,10),e.fillStyle=`#151827`,e.fillRect(12,54,10,24),e.fillRect(30,54,10,24),e.fillStyle=`#f2d16b`,e.fillRect(17,8,4,4),e.fillRect(29,8,4,4),e.restore()}function xr(e,t,n,r,i=1){let a=dr(t,r,i);t.pattern===`wobble`?vr(e,n,a,t.size,r):t.type===`candy`?hr(e,n,a,t.size,r):t.type===`pot`?gr(e,n,a,t.size,r):t.type===`dog`?_r(e,n,a,t.size,r):yr(e,n,a,t.size,r)}function Sr(e,t,n){let r=e.createLinearGradient(0,Bn,0,Q);r.addColorStop(0,`#26303a`),r.addColorStop(.45,`#303845`),r.addColorStop(1,`#171b22`),e.fillStyle=r,e.fillRect(0,Bn,Z,Vn),e.fillStyle=`rgba(255,245,205,0.12)`;for(let n=0;n<6;n+=1){let r=(n*170-t*.18%170+Z)%Z;e.beginPath(),e.ellipse(r+72,92,42,8,0,0,Math.PI*2),e.fill()}for(let r=0;r<8;r+=1){let i=(r*150-t*.42%150+Z)%Z,a=142+r%2*34;e.fillStyle=`#151922`,e.fillRect(i,a,88,74),e.strokeStyle=r%3==0?n.accent:`#c7b487`,e.lineWidth=6,e.strokeRect(i+3,a+3,82,68),e.fillStyle=r%2==0?`#58677a`:`#6b5c7a`,e.fillRect(i+19,a+22,50,28),e.fillStyle=`rgba(255,255,255,0.32)`,e.fillRect(i+24,a+57,40,5)}for(let n=0;n<6;n+=1){let r=(n*210-t*.72%210+Z)%Z;e.fillStyle=`rgba(9,10,16,0.42)`,e.fillRect(r+8,Q-74,92,10),e.fillStyle=`#28313a`,e.fillRect(r,Q-106,108,44),e.fillStyle=`rgba(180,230,255,0.22)`,e.fillRect(r+8,Q-98,92,25),e.strokeStyle=`rgba(230,245,255,0.38)`,e.lineWidth=2,e.strokeRect(r+8,Q-98,92,25)}e.fillStyle=n.ground,e.fillRect(0,Q,Z,zn-Q),e.fillStyle=`#1d2227`;for(let n=0;n<20;n+=1){let r=(n*52-t%52+Z)%Z;e.fillRect(r,Q+18,32,4),e.fillRect(r+14,Q+52,38,4)}e.fillStyle=`rgba(242,209,107,0.32)`,e.fillRect(0,Q-4,Z,4)}function Cr(e,t,n){let r=n-t.defeatedAtMs,i=Math.min(1,r/650),a=t.x+i*84,o=t.y-Math.sin(i*Math.PI)*116+i*28;e.save(),e.globalAlpha=1-i*.25,e.translate(a+t.size/2,o+t.size/2),e.rotate(i*Math.PI*2.3),e.scale(1+i*.24,Math.max(.2,1-i*.78)),t.pattern===`wobble`?vr(e,-t.size/2,-t.size/2,t.size,n):t.type===`dog`?_r(e,-t.size/2,-t.size/2,t.size,n):t.type===`bird`?yr(e,-t.size/2,-t.size/2,t.size,n):t.type===`pot`?gr(e,-t.size/2,-t.size/2,t.size,n):hr(e,-t.size/2,-t.size/2,t.size,n),e.restore(),e.fillStyle=`rgba(242,209,107,${1-i})`;for(let n=0;n<5;n+=1){let r=i*Math.PI*2+n*1.25;e.fillRect(t.x+t.size/2+Math.cos(r)*(18+i*42),t.y+t.size/2+Math.sin(r)*(12+i*32),6,6)}}function wr(e,t,n,r,i){let a=Math.min(1,t.elapsedMs/n.durationMs),o=n.mode===`chase`,s=fr(n.mode,n.stompEnemies,n.enemySet),c=t.worldElapsedMs*.18,l=t.elapsedMs<t.penaltyUntilMs,u=t.gameOverAtMs===null?null:Math.min(1,(t.elapsedMs-t.gameOverAtMs)/850),d=t.clearRunAtMs===null?null:Math.min(1,(t.elapsedMs-t.clearRunAtMs)/950);if(e.fillStyle=`#000`,e.fillRect(0,0,Z,zn),n.stompEnemies)Sr(e,c,r);else if(i.backgroundImage){let t=i.backgroundImage.width*(Vn/i.backgroundImage.height),n=Math.max(1,i.backgroundLoopWidth,t),r=n*(i.backgroundImage.height/i.backgroundImage.width),a=Bn+(r>Vn?(Vn-r)/2:0),o=-(c*.65%n);for(let t=o-n;t<Z+n;t+=n)e.drawImage(i.backgroundImage,t,a,n,r)}else{let t=e.createLinearGradient(0,0,0,Q);t.addColorStop(0,r.sky),t.addColorStop(1,`#090a12`),e.fillStyle=t,e.fillRect(0,Bn,Z,Vn),e.fillStyle=`rgba(255,255,255,0.12)`;for(let t=0;t<6;t+=1){let n=(t*180-c*.18%180+Z)%Z;e.fillRect(n,120+t%2*34,82,10)}e.fillStyle=`#202431`;for(let t=0;t<9;t+=1){let n=(t*130-c*.48%130+Z)%Z,r=78+t%3*34;e.fillRect(n,Q-r,72,r),e.fillStyle=`rgba(242,209,107,0.22)`,e.fillRect(n+16,Q-r+18,10,16),e.fillRect(n+44,Q-r+46,10,16),e.fillStyle=`#202431`}}if(!i.backgroundImage){e.fillStyle=r.ground,e.fillRect(0,Q,Z,zn-Q),e.fillStyle=`#11131a`;for(let t=0;t<18;t+=1){let n=(t*58-c%58+Z)%Z;e.fillRect(n,Q+18,34,4)}for(let t=0;t<7;t+=1){let n=(t*190-c*.95%190+Z)%Z,i=28+t%2*18;e.fillStyle=`#342739`,e.fillRect(n,Q-i,38,i),e.fillStyle=r.accent,e.fillRect(n+8,Q-i-8,22,8)}}let f=t.grounded?Math.sin(t.elapsedMs*.018)*3:0,p=t.y+f,m=l?-34+Math.sin(t.elapsedMs*.08)*8:0;if(!i.playerImageEnabled){let n=u===null?0:-36-u*118,i=u===null?0:-Math.sin(u*Math.PI)*132+u*82,a=d===null?0:d*(Z-$+120),o=d===null?0:Math.sin(t.elapsedMs*.045)*5;e.save(),e.translate($+m+n+a+Hn/2,p+i+o+Un/2),e.rotate(u===null?0:-u*Math.PI*1.4),e.translate(-($+m+Hn/2),-(p+o+Un/2)),e.fillStyle=`#f1f3f5`,e.fillRect($+m+10,p,22,22),e.fillStyle=r.accent,e.fillRect($+m,p+24,Hn,36),e.fillStyle=`#11131a`,e.fillRect($+m+6,p+58,12,24),e.fillRect($+m+25,p+58,12,24),e.fillStyle=`#f1f3f5`,e.fillRect($+m+Hn,p+30,20,10),e.restore()}o&&!i.opponentImageEnabled&&br(e,t.chaseDistance,t.elapsedMs);for(let r of s){if(t.collectedIds.includes(r.id)||t.hitIds.includes(r.id))continue;let i=ur(r,t.worldElapsedMs,n.objectSpeedMultiplier);i<-100||i>Z+120||xr(e,r,i,t.worldElapsedMs,n.objectSpeedMultiplier)}for(let n of t.defeated)Cr(e,n,t.elapsedMs);if(e.fillStyle=`rgba(0,0,0,0.35)`,e.fillRect(24,24,752,56),e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,58,712,8),e.fillStyle=r.accent,e.fillRect(44,58,712*a,8),o){let r=1-Math.min(1,Math.max(0,t.chaseDistance/n.chaseStartDistance));e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,70,712,6),e.fillStyle=`#ff8f70`,e.fillRect(44,70,712*r,6)}if(e.fillStyle=`#f7f2dc`,e.font=`20px ${Zn}`,e.fillText(n.name??(o?`公園の追跡劇`:`アーケード街の死闘`),44,48),e.font=`14px ${Zn}`,e.fillText(`${Math.ceil((n.durationMs-t.elapsedMs)/1e3)}秒`,708,48),e.fillText(o?`距離 ${Math.ceil(t.chaseDistance)}`:`${n.stompEnemies?`撃破`:`アメ`} ${t.score}`,610,48),n.stompEnemies){let r=Math.max(0,n.lives-t.penaltyCount);e.font=`22px ${Zn}`;for(let t=0;t<n.lives;t+=1)e.fillStyle=t<r?`#ff6f91`:`rgba(255,255,255,0.24)`,e.fillText(`♥`,44+t*28,105)}l&&(e.fillStyle=`rgba(120,0,0,0.7)`,e.fillRect(300,92,200,32),e.fillStyle=`#fff4e8`,e.font=`16px ${Zn}`,e.fillText(n.stompEnemies?`ミス！`:o?`追いつけない！`:`鍋に当たった！`,n.stompEnemies?376:o?348:344,114));let h=[i.backgroundImageConfigured&&i.backgroundImageFailed?`background image not found`:null,i.playerImageConfigured&&i.playerImageFailed?`player image not found`:null,i.opponentImageConfigured&&i.opponentImageFailed?`opponent image not found`:null].filter(Boolean);h.length>0&&(e.fillStyle=`rgba(120,0,0,0.72)`,e.fillRect(24,92,360,30),e.fillStyle=`#fff4e8`,e.font=`13px ${Zn}`,e.fillText(h.join(` / `),38,112))}function Tr({context:e,config:t,onExit:n}){let r=(0,a.useRef)(null),i=t.mode??`collect`,o=Math.max(1e3,t.durationMs||Kn),s=Math.max(1,t.chaseStartDistance??Jn),c=Math.max(.001,t.chaseCatchRate??Yn),l=Math.max(0,t.chaseHitDistancePenalty??Xn),u=(0,a.useRef)({elapsedMs:0,worldElapsedMs:0,y:Q-Un,velocityY:0,grounded:!0,score:0,penaltyCount:0,penaltyUntilMs:0,scrollFreezeUntilMs:0,chaseDistance:s,collectedIds:[],hitIds:[],defeated:[],gameOverAtMs:null,clearRunAtMs:null}),d=(0,a.useRef)(null),f=(0,a.useRef)(!1),[p,m]=(0,a.useState)(0),h=ir(),g=(0,a.useMemo)(()=>rr(t.theme),[t.theme]),_=t.stageId||`default`,v=ar(t.assetsBaseUrl,t.backgroundImage),y=ar(t.assetsBaseUrl,t.playerImage),b=ar(t.assetsBaseUrl,t.opponentImage);sr(t.assetsBaseUrl,t.bgm,t.bgmVolume);let x=or(v),S=or(y),C=or(b),w=Math.max(1,t.backgroundLoopWidth??Z),T=Math.max(1,t.playerWidth??74),E=Math.max(1,t.playerHeight??104),D=Math.max(1,t.opponentWidth??58),O=Math.max(1,t.opponentHeight??84),k=Math.max(.1,t.objectSpeedMultiplier??1),A=t.stompEnemies??!1,j=t.enemySet??`entrance`,M=Math.max(1,t.lives??3),N=(0,a.useCallback)(()=>{let e=u.current;e.grounded&&(u.current={...e,velocityY:Gn,grounded:!1})},[]),P=(0,a.useCallback)(t=>{if(f.current)return;f.current=!0;let r=u.current;n({...e,flags:{...e.flags,cleared_runner_action:!0,[`cleared_runner_action_${_}`]:!0,runner_action_score:r.score,[`runner_action_score_${_}`]:r.score,runner_action_penalties:r.penaltyCount,[`runner_action_penalties_${_}`]:r.penaltyCount,runner_action_result:t,[`runner_action_result_${_}`]:t,runner_action_distance:Math.ceil(r.chaseDistance),[`runner_action_distance_${_}`]:Math.ceil(r.chaseDistance)},playerStats:{...e.playerStats,runnerScore:r.score,runnerPenalties:r.penaltyCount,runnerDistance:Math.ceil(r.chaseDistance)}})},[e,n,_]);(0,a.useEffect)(()=>{let e=e=>{e.key!==` `&&e.key!==`Enter`||(e.preventDefault(),N())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[N]),(0,a.useEffect)(()=>{let e=0,n=a=>{let f=d.current??a,p=Math.min(40,a-f);d.current=a;let h=u.current,_=h.gameOverAtMs!==null||h.clearRunAtMs!==null?h.elapsedMs+p:Math.min(o,h.elapsedMs+p);if(h.gameOverAtMs!==null){let a={...h,elapsedMs:_,defeated:h.defeated.filter(e=>_-e.defeatedAtMs<700)};u.current=a;let c=r.current?.getContext(`2d`);c&&wr(c,a,{durationMs:o,mode:i,chaseStartDistance:s,objectSpeedMultiplier:k,stompEnemies:A,lives:M,name:t.name,enemySet:j},g,{backgroundImage:x.image,backgroundImageConfigured:!!v,backgroundImageFailed:x.failed,backgroundLoopWidth:w,playerImageEnabled:!!y&&!S.failed,playerImageConfigured:!!y,playerImageFailed:S.failed,opponentImageEnabled:!!b&&!C.failed,opponentImageConfigured:!!b,opponentImageFailed:C.failed,playerWidth:T,playerHeight:E}),m(_),_-h.gameOverAtMs>=850?P(`lose`):e=requestAnimationFrame(n);return}if(h.clearRunAtMs!==null){let a={...h,elapsedMs:_,worldElapsedMs:Math.min(o+950,h.worldElapsedMs+p),defeated:h.defeated.filter(e=>_-e.defeatedAtMs<700)};u.current=a;let c=r.current?.getContext(`2d`);c&&wr(c,a,{durationMs:o,mode:i,chaseStartDistance:s,objectSpeedMultiplier:k,stompEnemies:A,lives:M,name:t.name,enemySet:j},g,{backgroundImage:x.image,backgroundImageConfigured:!!v,backgroundImageFailed:x.failed,backgroundLoopWidth:w,playerImageEnabled:!!y&&!S.failed,playerImageConfigured:!!y,playerImageFailed:S.failed,opponentImageEnabled:!!b&&!C.failed,opponentImageConfigured:!!b,opponentImageFailed:C.failed,playerWidth:T,playerHeight:E}),m(_),_-h.clearRunAtMs>=950?P(`complete`):e=requestAnimationFrame(n);return}let D=h.elapsedMs<h.scrollFreezeUntilMs?0:p,O=Math.min(o,h.worldElapsedMs+D),N=i===`chase`?Math.max(0,h.chaseDistance-D*c):h.chaseDistance,F=h.velocityY+Wn*p,I=h.y+F*p,ee=!1,L=Q-Un;I>=L&&(I=L,F=0,ee=!0);let R={...h,elapsedMs:_,worldElapsedMs:O,chaseDistance:N,y:I,velocityY:F,grounded:ee},te=fr(i,A,j),ne=_<R.penaltyUntilMs,re=Math.max(24,Math.min(T,74)-12),ie=Math.max(48,Math.min(E,104)-8),z={x:$+(ne?-34:0)+8,y:mr(R,E)+4,width:re,height:ie};for(let e of te){if(R.collectedIds.includes(e.id)||R.hitIds.includes(e.id))continue;let t=ur(e,O,k);if(t<-100||t>Z+120)continue;let n={x:t,y:dr(e,O,k),width:e.size,height:e.size};if(!pr(z,n))continue;let r=A&&(e.type===`dog`||e.type===`bird`)&&R.velocityY>0&&z.y+z.height<=n.y+n.height*.48;if(e.type===`candy`||r)r&&lr(),R={...R,score:R.score+1,collectedIds:[...R.collectedIds,e.id],defeated:r?[...R.defeated,{id:e.id,type:e.type,pattern:e.pattern,x:t,y:dr(e,O,k),size:e.size,defeatedAtMs:_}]:R.defeated,velocityY:r?Gn*.62:R.velocityY,grounded:!1};else{if(ne)continue;let t=R.penaltyCount+1;if(R={...R,score:Math.max(0,R.score-2),penaltyCount:t,penaltyUntilMs:_+900,scrollFreezeUntilMs:_+qn,chaseDistance:i===`chase`?Math.min(s,R.chaseDistance+l):R.chaseDistance,hitIds:[...R.hitIds,e.id]},A&&t>=M){R={...R,gameOverAtMs:_,scrollFreezeUntilMs:_+900};break}}}R={...R,defeated:R.defeated.filter(e=>_-e.defeatedAtMs<700)},u.current=R;let ae=r.current?.getContext(`2d`);if(ae&&wr(ae,R,{durationMs:o,mode:i,chaseStartDistance:s,objectSpeedMultiplier:k,stompEnemies:A,lives:M,name:t.name,enemySet:j},g,{backgroundImage:x.image,backgroundImageConfigured:!!v,backgroundImageFailed:x.failed,backgroundLoopWidth:w,playerImageEnabled:!!y&&!S.failed,playerImageConfigured:!!y,playerImageFailed:S.failed,opponentImageEnabled:!!b&&!C.failed,opponentImageConfigured:!!b,opponentImageFailed:C.failed,playerWidth:T,playerHeight:E}),m(_),i===`chase`&&R.chaseDistance<=0){P(`win`);return}if(_>=o){i===`chase`?P(`lose`):(u.current={...R,clearRunAtMs:_},e=requestAnimationFrame(n));return}e=requestAnimationFrame(n)};return e=requestAnimationFrame(n),()=>cancelAnimationFrame(e)},[x.failed,x.image,v,w,c,l,s,o,P,i,C.failed,C.image,b,k,S.failed,S.image,E,y,T,_,A,j,M,t.name,g]);let F=Math.min(1,p/o),I=u.current,ee=I.elapsedMs<I.penaltyUntilMs,L=I.gameOverAtMs===null?null:Math.min(1,(I.elapsedMs-I.gameOverAtMs)/850),R=I.clearRunAtMs===null?null:Math.min(1,(I.elapsedMs-I.clearRunAtMs)/950),te=I.grounded?Math.sin(I.elapsedMs*.018)*3:0,ne=ee?-34+Math.sin(I.elapsedMs*.08)*8:0,re=L===null?0:-36-L*118,ie=L===null?0:-Math.sin(L*Math.PI)*132+L*82,z=R===null?0:R*(Z-$+120),ae=R===null?0:Math.sin(I.elapsedMs*.045)*5,oe=$+ne+re+z,se=mr(I,E)+te+ie+ae,ce=!!y&&!S.failed,le=Math.min(650,$+95+I.chaseDistance*3.6),V=Q-O+Math.sin(I.elapsedMs*.02)*3,ue=i===`chase`&&!!b&&!C.failed;return(0,B.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#05060a`,overflow:`hidden`},children:(0,B.jsxs)(`div`,{style:{width:Z,height:zn,flexShrink:0,transform:`scale(${h})`,transformOrigin:`center center`,position:`relative`,background:g.sky,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`,fontFamily:Zn},onMouseDown:N,onTouchStart:e=>{e.preventDefault(),N()},children:[(0,B.jsx)(`canvas`,{ref:r,width:Z,height:zn,style:{display:`block`}}),ce&&(0,B.jsx)(`img`,{src:y,alt:``,draggable:!1,style:{position:`absolute`,left:oe,top:se,width:T,height:E,transform:L===null?void 0:`rotate(${-L*1.4}turn)`,transformOrigin:`50% 55%`,pointerEvents:`none`,userSelect:`none`}}),ue&&(0,B.jsx)(`img`,{src:b,alt:``,draggable:!1,style:{position:`absolute`,left:le,top:V,width:D,height:O,pointerEvents:`none`,userSelect:`none`}}),(0,B.jsxs)(`div`,{style:{position:`absolute`,left:24,right:24,bottom:22,display:`flex`,alignItems:`center`,justifyContent:`space-between`,color:`#f7f2dc`,fontSize:14,textShadow:`0 2px 6px rgba(0,0,0,0.8)`,pointerEvents:`none`},children:[(0,B.jsx)(`span`,{children:t.name??`Runner Action`}),(0,B.jsx)(`span`,{children:`Space / Enter / Click`}),(0,B.jsxs)(`span`,{children:[Math.round(F*100),`%`]})]})]})})}var Er={component:Tr},Dr=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,Or=800,kr=600,Ar=148,jr=36,Mr=130,Nr=kr-jr-Mr,Pr=120,Fr=[{symbol:`飴`,color:`#f4a260`},{symbol:`花`,color:`#f48fb1`},{symbol:`星`,color:`#fff176`},{symbol:`月`,color:`#ce93d8`},{symbol:`家`,color:`#80cbc4`},{symbol:`鐘`,color:`#80deea`},{symbol:`鳥`,color:`#a5d6a7`},{symbol:`波`,color:`#64b5f6`}],Ir=[`どれかな……`,`えーと……`,`うーん……`],Lr=[`……`,`ふむ……`,`どれかな`],Rr=[`やった！`,`そろった！`,`ふふ`],zr=[`いただき`,`ふふふ`,`そうそう`],Br=[`あれ……`,`ちがった`,`うーん`],Vr=[`おや`,`むむ……`,`ちがったか`];async function Hr(e){let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-1`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}function Ur(e){let t=(0,a.useRef)(null);return{speak:(0,a.useCallback)(async(n,r)=>{let i=await Hr(`${n}_${r}`),a=`${(e??`/assets`).replace(/\/$/,``)}/voicevox/${i}.wav`,o=(await fetch(a,{method:`HEAD`}).catch(()=>null))?.ok?a:null;if(!o)try{let e=await fetch(`http://localhost:50021/audio_query?text=${encodeURIComponent(n)}&speaker=${r}`,{method:`POST`}).then(e=>e.json()),t=await fetch(`http://localhost:50021/synthesis?speaker=${r}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}).then(e=>e.arrayBuffer()).catch(()=>null);t&&(o=URL.createObjectURL(new Blob([t],{type:`audio/wav`})))}catch{}if(!o)return;t.current&&t.current.pause();let s=new Audio(o);t.current=s,s.play().catch(()=>{})},[e]),stop:(0,a.useCallback)(()=>{t.current&&=(t.current.pause(),null)},[])}}function Wr(){let e=()=>Math.min(1,Math.min(window.innerWidth/Or,window.innerHeight/kr)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function Gr(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function Kr(e){let t=[];for(let n=0;n<e;n++)t.push({id:n*2,pairId:n}),t.push({id:n*2+1,pairId:n});return{cards:Gr(t),flipped:[],matched:[],matchedBy:{},currentTurn:`player`,seen:{},playerPairs:0,opponentPairs:0,turns:0,phase:`playing`,lastEvent:`turn_start`,eventId:0}}var qr=4,Jr=110,Yr=140,Xr=14,Zr=14;function Qr(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function $r(e){return e.length===0?null:e[Math.floor(Math.random()*e.length)]}function ei(e,t=`normal`){let n=t===`weak`?.18:.45,r=t===`weak`?.08:.25,i=e.cards.filter(t=>!e.matched.includes(t.pairId)&&!e.flipped.includes(t.id));if(i.length===0)return null;if(e.flipped.length===1){let t=e.cards.find(t=>t.id===e.flipped[0]),r=i.find(e=>t&&e.pairId===t.pairId);return r&&Math.random()<n?r.id:$r(i)?.id??null}let a=new Map;for(let t of i)e.seen[t.id]===t.pairId&&a.set(t.pairId,[...a.get(t.pairId)??[],t.id]);let o=[...a.values()].find(e=>e.length>=2);return o&&Math.random()<r?o[0]:$r(i)?.id??null}function ti({side:e,name:t,faceSrc:n,score:r,active:i}){let a=e===`left`?`#fff176`:`#80deea`,o=Nr-96;return(0,B.jsxs)(`div`,{style:{position:`absolute`,top:jr,[e]:0,width:Ar,height:Nr,overflow:`hidden`,background:i?`rgba(${e===`left`?`255,241,118`:`128,222,234`},0.06)`:`rgba(6,6,18,0.65)`,borderRight:e===`left`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,borderLeft:e===`right`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,transition:`background 0.4s, border-color 0.4s`,zIndex:3},children:[(0,B.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:o,overflow:`hidden`},children:[n?(0,B.jsx)(`img`,{src:n,alt:``,draggable:!1,style:{display:`block`,width:`100%`,height:`100%`,objectFit:`contain`,objectPosition:`bottom center`,filter:i?`none`:`brightness(0.55) saturate(0.6)`,transition:`filter 0.4s`}}):(0,B.jsx)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:56,color:`#1e2040`},children:e===`left`?`🎮`:`🤖`}),(0,B.jsx)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:60,background:`linear-gradient(to top, ${i?e===`left`?`rgba(18,16,2,0.96)`:`rgba(2,16,18,0.96)`:`rgba(6,6,18,0.96)`} 0%, transparent 100%)`,pointerEvents:`none`}})]}),(0,B.jsxs)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:96,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:4,borderTop:`1px solid ${i?`${a}44`:`rgba(36,40,68,0.5)`}`,background:i?e===`left`?`rgba(22,18,2,0.92)`:`rgba(2,18,22,0.92)`:`rgba(6,6,18,0.92)`,transition:`background 0.4s, border-color 0.4s`},children:[(0,B.jsx)(`div`,{style:{fontSize:48,lineHeight:1,color:i?a:`#4a5090`,fontVariantNumeric:`tabular-nums`,textShadow:i?`0 0 24px ${a}55`:`none`,transition:`color 0.4s, text-shadow 0.4s`},children:r}),(0,B.jsx)(`div`,{style:{fontSize:10,color:`#3c4278`,letterSpacing:`0.08em`},children:`取得ペア`}),(0,B.jsx)(`div`,{style:{fontSize:11,color:i?`#c5cae9`:`#4a5090`,letterSpacing:`0.05em`,maxWidth:Ar-16,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`,textAlign:`center`,transition:`color 0.4s`},children:t})]}),i&&(0,B.jsx)(`div`,{style:{position:`absolute`,top:10,...e===`left`?{right:10}:{left:10},color:a,fontSize:14,opacity:.9},children:e===`left`?`▶`:`◀`})]})}function ni({speakerName:e,speakerSide:t,text:n}){return(0,B.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,bottom:0,height:Mr,background:`rgba(6,6,20,0.92)`,borderTop:`1px solid rgba(46,50,88,0.7)`,zIndex:10},children:[e&&(0,B.jsx)(`div`,{style:{position:`absolute`,top:-30,...t===`right`?{right:Ar+20}:{left:Ar+20},background:`rgba(6,6,20,0.94)`,border:`1px solid rgba(46,50,88,0.7)`,borderBottom:`none`,padding:`5px 20px`,fontSize:13,color:`#c5cae9`,letterSpacing:`0.1em`},children:e}),(0,B.jsx)(`div`,{style:{position:`absolute`,top:18,left:Ar+24,right:Ar+24,bottom:14,color:`#e8eaf6`,fontSize:15,lineHeight:1.9,letterSpacing:`0.08em`,overflow:`hidden`},children:n??``})]})}function ri({context:e,config:t,onExit:n}){let r=t.mode??`solo`,i=r===`duel`,o=t.opponentSkill??`normal`,s=t.pairs??6,c=t.maxTurns??20,l=Math.ceil(s*2/qr),u=i?Pr:Yr,d=qr*Jr+(qr-1)*Xr,f=l*u+(l-1)*Zr,p=Math.round((Or-d)/2),m=i?jr+Math.round((Nr-f)/2):Math.round((kr-f)/2)+16,h=Wr(),{speak:g,stop:_}=Ur(t.assetsBaseUrl),[v,y]=(0,a.useState)(()=>Kr(s)),b=(0,a.useRef)(!1),[x,S]=(0,a.useState)(()=>{if(r!==`duel`)return null;let e=$r(t.playerDialogue?.length?t.playerDialogue:Ir);return e?{speaker:`player`,text:e}:null});(0,a.useEffect)(()=>{if(v.phase!==`win`&&v.phase!==`lose`)return;let r=v.phase===`win`,i=setTimeout(()=>{n({...e,flags:{...e.flags,[`memory_game_result_${t.stageId}`]:r?`win`:`lose`,[`memory_game_player_pairs_${t.stageId}`]:v.playerPairs,[`memory_game_opponent_pairs_${t.stageId}`]:v.opponentPairs}})},2500);return()=>clearTimeout(i)},[v.phase]),(0,a.useEffect)(()=>{if(!x||!i)return;let e=x.speaker===`player`?t.playerVoicevoxSpeakerId:t.opponentVoicevoxSpeakerId;if(e!=null)return g(x.text,e),_},[x]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`){S(null);return}let e=v.currentTurn,n;switch(v.lastEvent){case`match`:n=e===`opponent`?t.opponentMatchDialogue?.length?t.opponentMatchDialogue:zr:t.playerMatchDialogue?.length?t.playerMatchDialogue:Rr;break;case`mismatch`:n=e===`opponent`?t.opponentMissDialogue?.length?t.opponentMissDialogue:Vr:t.playerMissDialogue?.length?t.playerMissDialogue:Br;break;default:n=e===`opponent`?t.opponentDialogue?.length?t.opponentDialogue:Lr:t.playerDialogue?.length?t.playerDialogue:Ir}let r=$r(n);S(r?{speaker:e,text:r}:null)},[v.eventId,i,v.phase]);let C=(0,a.useCallback)(e=>{b.current||y(t=>{if(t.phase!==`playing`)return t;let n=t.cards.find(t=>t.id===e);if(!n||t.matched.includes(n.pairId)||t.flipped.includes(e)||t.flipped.length>=2)return t;let r=[...t.flipped,e],a={...t.seen,[e]:n.pairId};if(r.length<2)return{...t,flipped:r,seen:a};let[o,c]=r,l=t.cards.find(e=>e.id===o),u=t.cards.find(e=>e.id===c),d=l.pairId===u.pairId,f=t.turns+1,p=i?t.currentTurn:`player`;if(d){let e=[...t.matched,l.pairId],n=t.playerPairs+ +(p===`player`),r=t.opponentPairs+ +(p===`opponent`),o=e.length===s,c=i?n>r:!0;return{...t,flipped:[],matched:e,matchedBy:{...t.matchedBy,[l.pairId]:p},seen:a,playerPairs:n,opponentPairs:r,turns:f,phase:o?c?`win`:`lose`:`playing`,lastEvent:`match`,eventId:t.eventId+1}}return{...t,flipped:r,seen:a,turns:f,lastEvent:`mismatch`,eventId:t.eventId+1}})},[i,s,c]),w=(0,a.useCallback)(e=>{i&&v.currentTurn!==`player`||C(e)},[i,C,v.currentTurn]);(0,a.useEffect)(()=>{if(v.flipped.length!==2)return;let[e,t]=v.flipped,n=v.cards.find(t=>t.id===e),r=v.cards.find(e=>e.id===t);if(n.pairId===r.pairId)return;b.current=!0;let a=setTimeout(()=>{y(e=>({...e,flipped:[],currentTurn:i?e.currentTurn===`player`?`opponent`:`player`:e.currentTurn,phase:!i&&c>0&&e.turns>=c?`lose`:e.phase,lastEvent:`turn_start`,eventId:e.eventId+1})),b.current=!1},900);return()=>{clearTimeout(a),b.current=!1}},[v.flipped]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`||v.currentTurn!==`opponent`||b.current)return;let e=v.flipped.length===0?650:820,t=setTimeout(()=>{let e=ei(v,o);e!==null&&C(e)},e);return()=>clearTimeout(t)},[i,o,C,v]);let T=c>0?c-v.turns:null,E=T!==null&&T<=5,D=Qr(t.assetsBaseUrl,t.playerFaceImage),O=Qr(t.assetsBaseUrl,t.opponentFaceImage),k=t.playerName??`こちら`,A=t.opponentName??`相手`,j=Qr(t.assetsBaseUrl,t.backgroundImage),M=x?x.speaker===`player`?k:A:null,N=x?x.speaker===`player`?`left`:`right`:null;return(0,B.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#0a0a14`,overflow:`hidden`},children:(0,B.jsxs)(`div`,{style:{width:Or,height:kr,position:`relative`,userSelect:`none`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${h})`,fontFamily:Dr,...j?{backgroundImage:`url(${j})`,backgroundSize:`cover`,backgroundPosition:`center`}:{background:`linear-gradient(150deg, #0d0d1a 0%, #0a0a14 60%, #0e0a1c 100%)`}},children:[j&&(0,B.jsx)(`div`,{style:{position:`absolute`,inset:0,background:`rgba(4,4,12,0.56)`,pointerEvents:`none`}}),(0,B.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:jr,display:`flex`,alignItems:`center`,justifyContent:`center`,zIndex:4,borderBottom:`1px solid rgba(36,40,68,0.5)`,background:`rgba(6,6,20,0.7)`},children:[(0,B.jsx)(`span`,{style:{color:`#c5cae9`,fontSize:15,letterSpacing:`0.14em`},children:t.title??`神経衰弱`}),!i&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsxs)(`span`,{style:{position:`absolute`,left:20,color:`#8bc34a`,fontSize:13},children:[v.matched.length,` / `,s,` ペア`]}),(0,B.jsx)(`span`,{style:{position:`absolute`,right:20,color:E?`#ef9a9a`:`#4a4d62`,fontSize:13},children:c>0?`残り ${T} 手`:`${v.turns} 手`})]})]}),i&&(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(ti,{side:`left`,name:k,faceSrc:D,score:v.playerPairs,active:v.currentTurn===`player`&&v.phase===`playing`}),(0,B.jsx)(ti,{side:`right`,name:A,faceSrc:O,score:v.opponentPairs,active:v.currentTurn===`opponent`&&v.phase===`playing`})]}),v.cards.map((e,t)=>{let n=t%qr,r=Math.floor(t/qr),a=p+n*(Jr+Xr),o=m+r*(u+Zr),s=v.flipped.includes(e.id)||v.matched.includes(e.pairId),c=v.matched.includes(e.pairId),l=Fr[e.pairId%Fr.length],d=(c?v.matchedBy[e.pairId]:void 0)===`opponent`?`#80deea`:l.color;return(0,B.jsx)(`div`,{onClick:()=>w(e.id),style:{position:`absolute`,left:a,top:o,width:Jr,height:u,borderRadius:10,cursor:s||i&&v.currentTurn!==`player`||b.current?`default`:`pointer`,background:s?`#141426`:`#0c0c1c`,border:c?`2px solid ${d}88`:s?`2px solid #3a3a5a`:`2px solid #1c1c30`,display:`flex`,alignItems:`center`,justifyContent:`center`,boxShadow:c?`0 0 20px ${d}36, 0 2px 8px rgba(0,0,0,0.55)`:s?`0 4px 14px rgba(0,0,0,0.65)`:`0 2px 6px rgba(0,0,0,0.45)`,transition:`background 0.12s, border-color 0.12s, box-shadow 0.2s`,zIndex:2},children:s?(0,B.jsx)(`span`,{style:{fontSize:i?44:52,color:c?`${l.color}80`:l.color,lineHeight:1},children:l.symbol}):(0,B.jsx)(`span`,{style:{fontSize:24,color:`#1c1e38`},children:`✦`})},e.id)}),i&&v.phase===`playing`&&(0,B.jsx)(ni,{speakerName:M,speakerSide:N,text:x?.text??null}),v.phase===`win`&&(0,B.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,B.jsx)(`div`,{style:{fontSize:46,color:`#fff176`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(255,241,118,0.45)`},children:`勝　利`}),(0,B.jsx)(`div`,{style:{fontSize:16,color:`#c5cae9`,letterSpacing:`0.08em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`${v.turns} 手でクリア`})]}),v.phase===`lose`&&(0,B.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,B.jsx)(`div`,{style:{fontSize:46,color:`#ef9a9a`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(239,154,154,0.35)`},children:`惜　敗`}),(0,B.jsx)(`div`,{style:{fontSize:16,color:`#667`,letterSpacing:`0.06em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`もう一度チャレンジしてください`})]})]})})}var ii={component:ri},ai=800,oi=600,si=`'Hiragino Kaku Gothic ProN', 'Meiryo', 'Yu Gothic', sans-serif`,ci=3,li=`
...
`,ui={easy:{count:3,min:1,max:9,flashMs:800,blankMs:150,negatives:0},normal:{count:4,min:3,max:20,flashMs:600,blankMs:120,negatives:1},hard:{count:5,min:5,max:50,flashMs:400,blankMs:100,negatives:2}};function di(e,t){return Math.floor(Math.random()*(t-e+1))+e}function fi(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function pi(e){let{count:t,min:n,max:r,negatives:i}=ui[e];for(;;){let e=[di(n,r)];for(let a=1;a<t;a++){let t=i>0&&a<=i&&Math.random()<.45;e.push(di(n,r)*(t?-1:1))}let a=e.reduce((e,t)=>e+t,0);if(a>0)return{nums:e,answer:a}}}function mi(e){let t=new Set([e]);for(let n of fi([3,7,12,18,25])){if(t.size>=4)break;let r=e+(Math.random()<.5?n:-n);r>0&&r!==e&&t.add(r)}let n=1;for(;t.size<4;)t.add(e+n),t.add(e-n),n++;return fi([...t].slice(0,4))}function hi(e){let t=pi(e);return{phase:`countdown`,countdown:5,round:0,problem:t,flashIdx:0,choices:mi(t.answer),selected:null,isCorrect:null,score:0,seq:0}}function gi(){let e=()=>Math.min(1,Math.min(window.innerWidth/ai,window.innerHeight/oi)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function _i(){(0,a.useEffect)(()=>{let e=document.createElement(`style`);return e.setAttribute(`data-fc`,`1`),e.textContent=li,document.head.appendChild(e),()=>{document.head.removeChild(e)}},[])}function vi({context:e,config:t,onExit:n}){let r=t.difficulty??`easy`,i=t.rounds??5,o=ui[r],s=gi();_i();let[c,l]=(0,a.useState)(()=>hi(r)),u=(0,a.useRef)(0),d=(0,a.useCallback)(()=>(u.current+=1,u.current),[]);(0,a.useEffect)(()=>{if(c.phase!==`countdown`)return;let e=d(),t=c.countdown===0?700:460,n=setTimeout(()=>{u.current===e&&(c.countdown>0?l(e=>({...e,countdown:e.countdown-1,seq:e.seq+1})):l(e=>({...e,phase:`flash`,flashIdx:0,seq:e.seq+1})))},t);return()=>clearTimeout(n)},[c.phase,c.countdown,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`flash`)return;let e=d(),t=setTimeout(()=>{u.current===e&&(c.flashIdx+1<c.problem.nums.length?l(e=>({...e,phase:`blank`,seq:e.seq+1})):l(e=>({...e,phase:`answer`,selected:null,isCorrect:null,seq:e.seq+1})))},o.flashMs);return()=>clearTimeout(t)},[c.phase,c.flashIdx,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`blank`)return;let e=d(),t=setTimeout(()=>{u.current===e&&l(e=>({...e,phase:`flash`,flashIdx:e.flashIdx+1,seq:e.seq+1}))},o.blankMs);return()=>clearTimeout(t)},[c.phase,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`feedback`)return;let e=d(),t=setTimeout(()=>{if(u.current!==e)return;let t=c.round+1;if(t>=i)l(e=>({...e,phase:`result`,seq:e.seq+1}));else{let e=pi(r);l(n=>({...n,phase:`countdown`,countdown:5,round:t,problem:e,flashIdx:0,choices:mi(e.answer),selected:null,isCorrect:null,seq:n.seq+1}))}},1400);return()=>clearTimeout(t)},[c.phase,c.round,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`result`)return;let t=d(),r=setTimeout(()=>{u.current===t&&n({...e,flags:{...e.flags,flash_calc_score:c.score,flash_calc_rounds:i,flash_calc_passed:c.score>ci},playerStats:{...e.playerStats,flash_calc_score:c.score}})},3500);return()=>clearTimeout(r)},[c.phase]);let f=(0,a.useCallback)(e=>{if(c.phase!==`answer`)return;let t=e===c.problem.answer;l(n=>({...n,phase:`feedback`,selected:e,isCorrect:t,score:t?n.score+1:n.score,seq:n.seq+1}))},[c.phase,c.problem.answer]),p=c.problem.nums[c.flashIdx],m=c.phase===`flash`?`flash-${c.flashIdx}`:c.phase;return(0,B.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#02020a`,overflow:`hidden`},children:(0,B.jsxs)(`div`,{style:{width:ai,height:oi,position:`relative`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${s})`,fontFamily:si,background:[`repeating-linear-gradient(0deg,transparent,transparent 49px,rgba(0,240,255,0.04) 49px,rgba(0,240,255,0.04) 50px)`,`repeating-linear-gradient(90deg,transparent,transparent 49px,rgba(0,240,255,0.04) 49px,rgba(0,240,255,0.04) 50px)`,`linear-gradient(155deg,#07071a 0%,#040409 55%,#07040f 100%)`].join(`,`),userSelect:`none`,animation:`fcMountIn 0.55s ease-out`},children:[(0,B.jsx)(`div`,{style:{position:`absolute`,inset:0,zIndex:40,pointerEvents:`none`,background:`repeating-linear-gradient(0deg,rgba(0,0,0,0.08),rgba(0,0,0,0.08) 1px,transparent 1px,transparent 4px)`,backgroundSize:`100% 4px`,animation:`fcScan 4s linear infinite`}}),(0,B.jsx)(yi,{top:10,left:10}),(0,B.jsx)(yi,{top:10,right:10}),(0,B.jsx)(yi,{bottom:10,left:10}),(0,B.jsx)(yi,{bottom:10,right:10}),(0,B.jsx)(bi,{round:c.round,totalRounds:i,score:c.score}),(0,B.jsx)(Si,{phase:c.phase,countdown:c.countdown,currentNum:p,isNeg:typeof p==`number`&&p<0,flashIdx:c.flashIdx,totalNums:c.problem.nums.length,isCorrect:c.isCorrect,correctAnswer:c.problem.answer,selected:c.selected},m),(c.phase===`answer`||c.phase===`feedback`)&&(0,B.jsx)(wi,{choices:c.choices,selected:c.selected,correct:c.problem.answer,onSelect:f,disabled:c.phase===`feedback`}),c.phase===`result`&&(0,B.jsx)(Ti,{score:c.score,total:i})]})})}function yi({top:e,bottom:t,left:n,right:r}){return(0,B.jsx)(`div`,{style:{position:`absolute`,top:e,bottom:t,left:n,right:r,width:28,height:28,zIndex:3,pointerEvents:`none`,borderTop:e===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderBottom:t===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderLeft:n===void 0?void 0:`1px solid rgba(0,240,255,0.4)`,borderRight:r===void 0?void 0:`1px solid rgba(0,240,255,0.4)`}})}function bi({round:e,totalRounds:t,score:n}){return(0,B.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:44,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`rgba(3,3,14,0.92)`,borderBottom:`1px solid rgba(0,240,255,0.15)`,zIndex:5},children:[(0,B.jsx)(`span`,{style:{color:`#6878b0`,fontSize:12,letterSpacing:`0.55em`,textTransform:`uppercase`},children:`Flash\xA0Calc`}),(0,B.jsxs)(`span`,{style:{position:`absolute`,left:40,color:`#283050`,fontSize:12,letterSpacing:`0.12em`,fontVariantNumeric:`tabular-nums`},children:[(0,B.jsx)(`span`,{style:{color:`#304070`},children:`RND`}),` `,(0,B.jsx)(`span`,{style:{color:`#4060a0`},children:e+1}),` `,(0,B.jsxs)(`span`,{style:{color:`#202840`},children:[`/ `,t]})]}),(0,B.jsxs)(`span`,{style:{position:`absolute`,right:40,display:`flex`,alignItems:`center`,gap:8,fontVariantNumeric:`tabular-nums`},children:[(0,B.jsx)(`span`,{style:{color:`#283050`,fontSize:11,letterSpacing:`0.12em`},children:`SCORE`}),(0,B.jsx)(`span`,{style:{color:`#40c070`,fontSize:18,fontWeight:700,textShadow:`0 0 12px rgba(60,200,100,0.5)`},children:n})]})]})}var xi={position:`absolute`,left:0,right:0,top:44,bottom:150,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`};function Si({phase:e,countdown:t,currentNum:n,isNeg:r,flashIdx:i,totalNums:a,isCorrect:o,correctAnswer:s,selected:c}){if(e===`result`)return null;if(e===`countdown`){let e=t===0?0:6-t,n=t===0;return(0,B.jsxs)(`div`,{style:{...xi,animation:`fcPhaseIn 0.22s ease-out`,gap:0},children:[(0,B.jsx)(`div`,{style:{fontSize:11,letterSpacing:`0.55em`,color:`#2a3060`,textTransform:`uppercase`,marginBottom:24},children:n?`Start`:`Ready`}),(0,B.jsx)(`div`,{style:{background:`radial-gradient(ellipse at 50% 30%, #0c0a1e, #060410)`,border:`1px solid rgba(60,40,110,0.55)`,borderRadius:16,padding:`26px 40px`,display:`flex`,gap:30,boxShadow:`inset 0 0 80px rgba(0,0,0,0.85), 0 4px 40px rgba(0,0,0,0.6)`},children:Array.from({length:5},(t,n)=>{let r=n<e;return(0,B.jsx)(`div`,{style:{width:56,height:56,borderRadius:`50%`,background:r?`radial-gradient(circle at 38% 32%, #ff6050 0%, #cc0000 55%, #800000 100%)`:`radial-gradient(circle at 38% 32%, #1e0c0c 0%, #0e0404 100%)`,border:`3px solid ${r?`#ff4030`:`#1a0808`}`,boxShadow:r?`0 0 22px #ff0000, 0 0 50px rgba(255,0,0,0.55), 0 0 90px rgba(255,0,0,0.25), inset 0 2px 8px rgba(255,180,160,0.25)`:`inset 0 2px 6px rgba(0,0,0,0.9)`,animation:r?`fcLightOn 1.6s ease-in-out infinite`:`none`,transition:`background 0.12s, border-color 0.12s, box-shadow 0.15s`}},n)})}),n?(0,B.jsx)(`div`,{style:{fontSize:86,color:`#00ff60`,letterSpacing:`0.1em`,marginTop:28,textShadow:`0 0 28px #00ff60, 0 0 60px rgba(0,255,96,0.6), 0 0 120px rgba(0,255,96,0.3)`,animation:`fcGoFlash 0.38s cubic-bezier(0.17,0.89,0.32,1.27)`},children:`GO！`}):(0,B.jsx)(`div`,{style:{fontSize:12,color:`#252548`,letterSpacing:`0.14em`,marginTop:22},children:`集中してください`})]})}if(e===`flash`){let e=r?`−${Math.abs(n)}`:`${n}`,t=r?`#ff7878`:`#d8eeff`,o=r?`rgba(255,80,80,0.65)`:`rgba(80,180,255,0.7)`;return(0,B.jsxs)(`div`,{style:{...xi,gap:0},children:[(0,B.jsx)(Ci,{total:a,done:i,active:i}),(0,B.jsx)(`div`,{style:{fontSize:118,color:t,lineHeight:1,fontWeight:700,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 40px ${o}, 0 0 90px ${o.replace(`0.7`,`0.35`)}`,animation:`fcNumPop 0.2s cubic-bezier(0.17,0.89,0.32,1.27)`,letterSpacing:`0.04em`},children:e})]})}return e===`blank`?(0,B.jsx)(`div`,{style:{...xi},children:(0,B.jsx)(Ci,{total:a,done:i+1,active:null})}):e===`answer`?(0,B.jsxs)(`div`,{style:{...xi,gap:14,animation:`fcPhaseIn 0.25s ease-out`},children:[(0,B.jsx)(`div`,{style:{fontSize:88,color:`#3a4888`,textShadow:`0 0 24px rgba(60,80,180,0.4)`,lineHeight:1},children:`?`}),(0,B.jsx)(`div`,{style:{fontSize:13,color:`#2c2c54`,letterSpacing:`0.18em`},children:`こたえを　えらんでね`})]}):e===`feedback`?o?(0,B.jsxs)(`div`,{style:{...xi,gap:12,animation:`fcCorrect 0.42s ease-out`},children:[(0,B.jsx)(`div`,{style:{fontSize:60,color:`#50ff8c`,textShadow:`0 0 28px rgba(80,255,140,0.7), 0 0 60px rgba(80,255,140,0.35)`,letterSpacing:`0.08em`},children:`せいかい！`}),(0,B.jsx)(`div`,{style:{fontSize:42,color:`#a0ffcc`,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 16px rgba(80,255,140,0.4)`},children:s})]}):(0,B.jsxs)(`div`,{style:{...xi,gap:10,animation:`fcWrong 0.48s ease-out`},children:[(0,B.jsx)(`div`,{style:{fontSize:60,color:`#ff5555`,textShadow:`0 0 28px rgba(255,60,60,0.7)`,letterSpacing:`0.08em`},children:`ざんねん`}),(0,B.jsxs)(`div`,{style:{fontSize:18,color:`#7a3a5a`,letterSpacing:`0.1em`},children:[`こたえは\xA0`,(0,B.jsx)(`span`,{style:{color:`#c06080`,fontVariantNumeric:`tabular-nums`},children:s})]}),c!==null&&(0,B.jsxs)(`div`,{style:{fontSize:13,color:`#3a2030`},children:[`あなたは `,c,` と答えました`]})]}):null}function Ci({total:e,done:t,active:n}){return(0,B.jsx)(`div`,{style:{display:`flex`,gap:14,marginBottom:28},children:Array.from({length:e},(e,r)=>{let i=r<t,a=r===n;return(0,B.jsx)(`div`,{style:{width:10,height:10,borderRadius:2,background:a?`#00f0ff`:i?`rgba(0,200,255,0.45)`:`rgba(24,24,50,0.7)`,boxShadow:a?`0 0 10px #00f0ff, 0 0 22px rgba(0,240,255,0.5)`:i?`0 0 4px rgba(0,200,255,0.3)`:`none`,transition:`background 0.15s, box-shadow 0.15s`}},r)})})}function wi({choices:e,selected:t,correct:n,onSelect:r,disabled:i}){return(0,B.jsx)(`div`,{style:{position:`absolute`,left:36,right:36,bottom:36,height:104,display:`flex`,gap:18,alignItems:`stretch`},children:e.map(e=>{let a=`rgba(10,8,28,0.92)`,o=`1px solid rgba(0,180,220,0.18)`,s=`#8898cc`,c=`none`,l=`none`;return i&&t!==null&&(e===n?(a=`rgba(20,60,35,0.95)`,o=`1px solid rgba(80,255,140,0.55)`,s=`#80ffb8`,c=`0 0 28px rgba(60,220,110,0.35)`,l=`fcCorrect 0.4s ease-out`):e===t&&(a=`rgba(60,18,22,0.95)`,o=`1px solid rgba(255,80,80,0.5)`,s=`#ff7070`,c=`0 0 18px rgba(255,60,60,0.3)`)),(0,B.jsx)(`button`,{className:`fc-btn`,onClick:()=>!i&&r(e),disabled:i,style:{flex:1,height:`100%`,background:a,border:o,borderRadius:10,color:s,fontSize:38,fontFamily:si,fontVariantNumeric:`tabular-nums`,fontWeight:700,boxShadow:c,animation:l,letterSpacing:`0.04em`},children:e},e)})})}function Ti({score:e,total:t}){let n=e>ci,r=e===t,i=r?`#fff080`:n?`#60ff90`:`#ff6060`,a=r?`パーフェクト！`:n?`よくできました！`:`ざんねん…`;return(0,B.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(2,2,12,0.94)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:0,animation:`fcResultIn 0.5s cubic-bezier(0.17,0.89,0.32,1.27)`},children:[(0,B.jsx)(`div`,{style:{fontSize:11,letterSpacing:`0.55em`,color:`#242448`,textTransform:`uppercase`,marginBottom:32},children:`Result`}),(0,B.jsx)(`div`,{style:{fontSize:46,color:i,letterSpacing:`0.14em`,textShadow:`0 0 36px ${i}88, 0 0 70px ${i}44`,marginBottom:24},children:a}),(0,B.jsxs)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:14},children:[(0,B.jsx)(`span`,{style:{fontSize:92,color:i,fontVariantNumeric:`tabular-nums`,fontWeight:700,textShadow:`0 0 50px ${i}66, 0 0 100px ${i}33`},children:e}),(0,B.jsxs)(`span`,{style:{fontSize:28,color:`#242448`},children:[`/ `,t]})]}),!n&&(0,B.jsx)(`div`,{style:{fontSize:15,color:`#4a2840`,letterSpacing:`0.12em`,marginTop:20},children:`4もん以上せいかいしてね`})]})}var Ei={component:vi},Di=800,Oi=600,ki=`'Hiragino Kaku Gothic ProN', 'Meiryo', 'Yu Gothic', sans-serif`,Ai=[`●`,`◆`,`▲`,`★`,`✚`,`■`,`⬟`,`✦`],ji=[`#f4c95d`,`#7dd3fc`,`#f0abfc`,`#86efac`,`#fca5a5`,`#c4b5fd`],Mi=`
