...
`,u=`scenes:
  ...
  - id: scene_ch4_start
    ...
    messages:
      - text: 第4章
        voice_character_id: null
      - text: アメちゃん大会から、数日が経った。
        voice_character_id: null
      - text: 団地の広場に出ると、見慣れた顔がふたつ、仲良さそうに並んでいた。
        voice_character_id: null
    next_scene: scene_ch4_boy_and_obachan_chat
  ...
  - id: scene_danchi_morning
    ...
    branches:
      ...
      choices:
        - condition:
            flag: flag_ch4_flash_calc_done
            value: true
          next_scene: scene_ch4_ending
        - condition:
            flag: flag_ch4_ken_offered_help
            value: true
          next_scene: scene_ch4_flash_calc_start
        - condition:
            flag: flag_ch4_boy_troubled_seen
            value: true
          next_scene: scene_ch4_ken_offers_help
        - condition: null
          next_scene: scene_ch4_boy_and_obachan_chat
  ...
  - id: scene_coderdojo_default
    ...
    bgm: audio/bgm/station.mp3
    messages:
      - text: 今日はCoderDojoの日じゃない。
        voice_character_id: null
    next_scene: null

  - id: scene_ichibangai_default
    location_id: loc_ichibangai
    background: backgrounds/ichibangai.jpg
    bgm: audio/bgm/station.mp3
    messages:
      - text: 一番街の入口。今日は用事はない。
        voice_character_id: null
    next_scene: null
  ...
  - id: scene_park_default
    ...
    bgm: audio/bgm/danchi.mp3
    messages:
      - text: 公園。今日はここではなく、団地の広場の方が騒がしい。
        voice_character_id: null
    next_scene: null
  ...
  - id: scene_slope_default
    ...
    bgm: audio/bgm/danchi.mp3
    messages:
      - text: 団地への坂道。今は上に戻るより、広場の方が気になる。
        voice_character_id: null
    next_scene: null
  ...
  # 第4章　本編
  # ============================================================
  - id: scene_ch4_boy_and_obachan_chat
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    characters:
      ...
      - character_id: char_obachan
        ...
        expression: normal
    messages:
      - text: 広場では、アメ好き少年と田村のおばちゃんが並んでベンチに座っていた。
        voice_character_id: null
      - text: 「あのアメちゃん大会、ほんまに楽しかったな！」
        voice_character_id: char_obachan
      - text: 「うん！　おばちゃん走るの速かった！」
        voice_character_id: char_candy_kid
      - text: 「あんたに言われとうなかったわ」
        voice_character_id: char_obachan
      - text: ふたりはころころ笑っている。あのアメちゃん大会からすっかり仲良しになったようだ。
        voice_character_id: null
    next_scene: scene_ch4_boy_troubled

  - id: scene_ch4_boy_troubled
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    flags_set:
    ...
    characters:
      ...
      - character_id: char_obachan
        ...
        expression: normal
    messages:
      - text: そのとき、少年の顔が少し曇った。
        voice_character_id: null
      - text: 「……でも、学校のテスト、めっちゃ悪くて。お父さんとお母さんにものすごく怒られた」
        voice_character_id: char_candy_kid
      - text: 「あらまあ。何点やったん？」
        voice_character_id: char_obachan
      - text: 「……さんじゅってん」
      ...
      - text: 「それはお父さんも怒るわな」
        voice_character_id: char_obachan
      - text: 「もっと勉強しろって……ゲームも取り上げられた」
        voice_character_id: char_candy_kid
      - text: ケンは横で話を聞いていた。
        voice_character_id: null
    next_scene: scene_ch4_ken_offers_help

  - id: scene_ch4_ken_offers_help
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    flags_set:
    ...
    messages:
      ...
      - text: 「ケン兄ちゃんが？」
        voice_character_id: char_candy_kid
      - text: 「フラッシュ暗算って知ってるか？　数字が一瞬だけパッと出てきて、頭の中で足したり引いたりするやつ」
        voice_character_id: char_hero
      - text: 「……ゲームみたいなの？」
        voice_character_id: char_candy_kid
      - text: 「ゲームだよ。でもやってると頭が鍛えられる。算数も速くなるぞ」
        voice_character_id: char_hero
      - text: 「ほんまかいな」
        voice_character_id: char_obachan
      - text: 少年の目がきらりと光った。
  ...
  - id: scene_ch4_flash_calc_start
    ...
    next_engine:
      ...
      config:
        difficulty: easy
        rounds: 5
      return_scene: scene_ch4_after_flash_calc

  # ゲーム終了後のディスパッチャー（flash_calc_passed フラグで分岐）
  - id: scene_ch4_after_flash_calc
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    messages: []
    branches:
      ...
      choices:
        - condition:
            ...
            value: true
          next_scene: scene_ch4_flash_calc_pass
        - condition: null
          next_scene: scene_ch4_flash_calc_fail

  # 合格（4問以上正解）
  - id: scene_ch4_flash_calc_pass
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    flags_set:
    ...
    messages:
      - text: ゲームが終わった。
        voice_character_id: null
      - text: 「……なんか、楽しかった！　もう一回やりたい！」
        voice_character_id: char_candy_kid
      - text: 「ちゃんと答えられてたじゃないか。続けてたら算数も得意になるぞ」
        voice_character_id: char_hero
      - text: 「ほんまかいな」
        voice_character_id: char_obachan
      - text: 少年は照れくさそうに笑った。
  ...
  # 不合格（3問以下）→ ケンに励まされて再挑戦
  - id: scene_ch4_flash_calc_fail
    location_id: loc_danchi
    background: backgrounds/danchimae.jpg
    bgm: audio/bgm/danchi.mp3
    characters:
    ...
    messages:
      - text: ゲームが終わった。
        voice_character_id: null
      - text: 「……むずかしかった。全然わからんかった」
        voice_character_id: char_candy_kid
      - text: 「最初はそんなもんだ。数字を目で追うのに慣れてないだけだよ」
        voice_character_id: char_hero
      - text: 「もう一回やってみ。さっきより絶対できるから」
        voice_character_id: char_hero
      - text: 少年は唇を結んで、もう一度うなずいた。
        voice_character_id: null
    next_engine:
      id: flash_calc
      config:
  ...
  - id: scene_ch4_ending
    ...
    flags_set:
      - flag: flag_ch4_cleared
        value: true
    messages:
      - text: 赤羽の団地に、夕暮れが近づいてきた。
        voice_character_id: null
      - text: 少年はアメちゃんをひとつ口に放り込んで、また来るな、と手を振った。
        voice_character_id: null
      - text: 今日も、ここでは小さなドラマが生まれている。
        voice_character_id: null
    game_end: true
`,d=`flags:
  - id: flag_hero_name
  ...
  - id: flag_ch4_boy_troubled_seen
    type: boolean
    default: false
    description: "少年がテストで怒られた話を聞いた"

  - id: flag_ch4_ken_offered_help
    type: boolean
    default: false
    description: "ケンが少年にフラッシュ暗算を教えると申し出た"

  - id: flag_ch4_flash_calc_done
    type: boolean
    default: false
    description: "フラッシュ暗算ゲームを一度プレイした"
...
`;function xt({engines:e,initial:t,initialContext:n,defaultTransition:r=`none`}){let[i,o]=(0,a.useState)(n),[s,c]=(0,a.useState)(t),[l,u]=(0,a.useState)(`idle`),[d,f]=(0,a.useState)(`none`),p=(0,a.useRef)(null);function m(e,t){let n=null;if(t?n={engineId:t.engineId,config:t.config,returnEngineId:t.returnEngineId,returnConfig:t.returnConfig,returnTransition:t.returnTransition}:s.returnEngineId&&(n={engineId:s.returnEngineId,config:s.returnConfig}),!n)return;let i=(t?t.transition:s.returnTransition)??r??`none`;if(i===`none`||!(i in yt)){o(e),c(n);return}p.current={updated:e,next:n},f(i),u(`out`)}(0,a.useEffect)(()=>{if(l!==`out`)return;let e=setTimeout(()=>{p.current&&=(o(p.current.updated),c(p.current.next),null),u(`in`)},yt[d]);return()=>clearTimeout(e)},[l,d]),(0,a.useEffect)(()=>{if(l!==`in`)return;let e=setTimeout(()=>u(`idle`),yt[d]);return()=>clearTimeout(e)},[l,d]);let h=e[s.engineId];if(!h)return(0,I.jsxs)(`div`,{style:{padding:24,color:`red`},children:[`Engine not found: `,s.engineId]});let g=h.component,_=l!==`idle`,v=d===`flash`?`#fff`:d===`speedline`?[`radial-gradient(circle at 50% 50%, rgba(255,255,255,0.95) 0 5%, rgba(255,210,90,0.78) 9%, rgba(255,120,70,0.38) 18%, rgba(0,0,0,0.92) 58%)`,`repeating-linear-gradient(100deg, rgba(255,255,255,0.95) 0 8px, rgba(255,210,90,0.35) 8px 14px, rgba(0,0,0,0) 14px 34px)`,`#050505`].join(`, `):d===`rift`?[`radial-gradient(circle at 50% 50%, rgba(190,120,255,0.95) 0 4%, rgba(80,20,120,0.82) 13%, rgba(12,2,24,0.98) 54%, #000 100%)`,`repeating-conic-gradient(from 0deg, rgba(210,170,255,0.24) 0deg 7deg, rgba(0,0,0,0) 7deg 18deg)`,`#000`].join(`, `):d===`cardflip`?[`radial-gradient(circle at 50% 50%, rgba(255,245,210,0.9) 0 8%, rgba(110,45,80,0.84) 34%, rgba(12,8,22,0.98) 74%)`,`linear-gradient(90deg, rgba(255,255,255,0.20) 0 1px, transparent 1px 80px)`,`linear-gradient(0deg, rgba(255,255,255,0.16) 0 1px, transparent 1px 112px)`,`#0d0712`].join(`, `):`#000`,y=_?{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`all`,background:v,backgroundSize:d===`speedline`?`100% 100%, 220px 100%, 100% 100%`:d===`rift`?`100% 100%, 180px 180px, 100% 100%`:d===`cardflip`?`100% 100%, 80px 100%, 100% 112px, 100% 100%`:void 0,animation:`hub-${d}-${l} ${yt[d]}ms ease forwards`}:{position:`fixed`,inset:0,zIndex:9999,pointerEvents:`none`,opacity:0};return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`style`,{children:bt}),(0,I.jsx)(g,{context:i,config:s.config,onExit:m}),(0,I.jsxs)(`div`,{style:y,children:[_&&d===`speedline`&&(0,I.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#fff7c8`,fontFamily:`'Impact', 'Arial Black', sans-serif`,fontSize:96,letterSpacing:0,textShadow:`0 0 18px rgba(255,118,54,0.95), 0 8px 0 rgba(0,0,0,0.55)`,transform:l===`out`?`rotate(-5deg) scale(1.08)`:`rotate(5deg) scale(0.96)`},children:`RUN!`}),_&&d===`cardflip`&&(0,I.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`50%`,width:190,height:260,borderRadius:8,border:`2px solid rgba(255,245,210,0.95)`,background:`linear-gradient(145deg, rgba(255,245,210,0.96), rgba(170,80,130,0.92))`,boxShadow:`0 0 30px rgba(255,230,160,0.8), inset 0 0 0 10px rgba(70,22,48,0.32)`,transform:`translate(-50%, -50%) ${l===`out`?`rotate(-4deg)`:`rotate(4deg)`}`}})]})]})}function St({context:e,config:t,onExit:n}){let r=(0,a.useCallback)((r,i,a,o)=>{let s={flags:r,inventory:i,playerStats:e.playerStats};if(a.id===`__return__`){n(s);return}let c=Object.values(t.masterData.items).map(e=>({id:e.id,name:e.name,usable:e.usable})),l=a.config??{},u={},d=(e,n)=>{if(typeof e!=`string`)return;let r=t.masterData.characters[e];if(!r)return;u[`${n}Name`]=r.name;let i=r.sprites?.normal??(r.sprites?Object.values(r.sprites)[0]:void 0);i&&(u[`${n}FaceImage`]=i),r.voicevox_speaker_id&&(u[`${n}VoicevoxSpeakerId`]=r.voicevox_speaker_id)};d(l.playerCharacterId,`player`),d(l.opponentCharacterId,`opponent`);let f={masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,chapterId:o,initialLocationId:t.initialLocationId,chapters:t.chapters,exitSceneId:a.return_scene,gameoverSceneId:a.gameover_scene,gameoverBossSceneId:a.gameover_boss_scene,gameoverLandingSceneId:a.gameover_landing_scene};n(s,{engineId:a.id,transition:a.transition,config:{assetsBaseUrl:t.assetsBaseUrl,items:c,...u,...a.config??{},_novelReturn:f},returnEngineId:a.return_scene?`novel`:void 0,returnConfig:a.return_scene?{...t,chapterId:o,initialSceneId:a.return_scene,autoStart:!0}:void 0})},[e.playerStats,t,n]);return(0,I.jsx)(ft,{masterData:t.masterData,assetsBaseUrl:t.assetsBaseUrl,config:{initialSceneId:t.initialSceneId,initialLocationId:t.initialLocationId,chapterId:t.chapterId,chapters:t.chapters},initialFlags:e.flags,initialInventory:e.inventory,autoStart:t.autoStart,onEngineTransition:r})}var Ct={component:St},wt={dungeon_01:[`###########`,`#S........#`,`#.#######.#`,`###.......#`,`###.#######`,`###.....###`,`#######.###`,`#######.###`,`#######.###`,`#######...#`,`#########X#`,`###########`],dungeon_02:[`###############`,`#S..........###`,`#.#########.###`,`###.........###`,`###.#######.###`,`###E#.........#`,`###.#.#########`,`###.#.........#`,`###.###########`,`###..........B#`,`#############X#`,`###############`]};function Tt(e){return{...e,maxHp:e.hp}}var Et={ghost:{id:`ghost`,name:`ゴースト`,hp:10,atk:4,def:1},bat:{id:`bat`,name:`コウモリ`,hp:6,atk:3,def:0},wraith:{id:`wraith`,name:`レイス`,hp:14,atk:5,def:2}},Dt={dungeon_02:[Et.ghost,Et.bat,Et.wraith]},Ot={dungeon_02:{id:`maze_boss`,name:`迷宮の主`,hp:22,atk:7,def:2}};function kt(e){let t=Ot[e];return t?Tt(t):null}function At(e){let t=Dt[e];return!t||t.length===0?null:Tt(t[Math.floor(Math.random()*t.length)])}function jt(e){let t=At(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が現れた！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function Mt(e){let t=kt(e.mapId);if(!t)return e;let n={enemy:t,phase:`select`,log:[`${t.name} が立ちはだかった！　逃げられない！`],cursorIndex:0,guarding:!1};return{...e,battle:n}}function Nt(e){let{battle:t}=e;if(!t)return e;let n=Math.max(1,t.enemy.atk-(t.guarding?e.playerDef*2:e.playerDef)),r=e.playerHp-n,i=[...t.log,`${t.enemy.name} の攻撃！ ケン に ${n} ダメージ！`];return r<=0?{...e,playerHp:0,battle:{...t,phase:`lose`,log:[...i,`ケン は倒れた……`],guarding:!1}}:{...e,playerHp:r,battle:{...t,phase:`select`,log:i,guarding:!1}}}function Pt(e){let{battle:t}=e;if(!t)return e;if(t.cursorIndex===2){if(e.pendingBossTilePos){let n=[...t.log,`逃げることはできない！`];return Nt({...e,battle:{...t,log:n,guarding:!1}})}if(Math.random()<.5)return{...e,battle:null};let n=[...t.log,`逃げられなかった！`];return Nt({...e,battle:{...t,log:n,guarding:!1}})}if(t.cursorIndex===1){let n=[...t.log,`ケン は身を守った！`];return Nt({...e,battle:{...t,log:n,guarding:!0}})}let n=Math.max(1,e.playerAtk-t.enemy.def),r=t.enemy.hp-n,i=[...t.log,`ケン の攻撃！ ${t.enemy.name} に ${n} ダメージ！`];if(r<=0){let n={...t.enemy,hp:0};return{...e,battle:{...t,enemy:n,phase:`win`,log:[...i,`${t.enemy.name} を倒した！`],guarding:!1}}}let a={...t.enemy,hp:r};return Nt({...e,battle:{...t,enemy:a,log:i,guarding:!1}})}function Ft(e,t){let{battle:n}=e;if(!n)return e;let r=t===`Enter`||t===` `,i=t===`ArrowUp`||t===`w`||t===`W`,a=t===`ArrowDown`||t===`s`||t===`S`;if(n.phase===`select`)return i?{...e,battle:{...n,cursorIndex:(n.cursorIndex+2)%3}}:a?{...e,battle:{...n,cursorIndex:(n.cursorIndex+1)%3}}:r?Pt(e):e;if(!r)return e;if(n.phase===`win`){if(e.pendingBossTilePos){let t=new Set(e.triggeredEvents);return t.add(e.pendingBossTilePos),{...e,battle:null,pendingBossTilePos:null,triggeredEvents:t}}return{...e,battle:null}}return n.phase===`lose`?{...e,pendingDeath:!0}:e}var It=.2,Lt={N:{fwd:{x:0,y:-1},left:{x:-1,y:0},right:{x:1,y:0},back:{x:0,y:1}},E:{fwd:{x:1,y:0},left:{x:0,y:-1},right:{x:0,y:1},back:{x:-1,y:0}},S:{fwd:{x:0,y:1},left:{x:1,y:0},right:{x:-1,y:0},back:{x:0,y:-1}},W:{fwd:{x:-1,y:0},left:{x:0,y:1},right:{x:0,y:-1},back:{x:1,y:0}}},Rt={N:`W`,W:`S`,S:`E`,E:`N`},zt={N:`E`,E:`S`,S:`W`,W:`N`};function Bt(e,t,n){return n<0||n>=e.length||t<0||t>=(e[n]?.length??0)?`#`:e[n][t]??`#`}function J(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Vt(e,t){return{x:e.x*t,y:e.y*t}}function Ht(e){for(let t=0;t<e.length;t++){let n=e[t].indexOf(`S`);if(n>=0)return{x:n,y:t}}return{x:1,y:1}}function Ut(e,t,n,r){let i=wt[e]??wt.dungeon_01,a=r?.initialPos??Ht(i),o=r?.initialDir??`N`,s=t?.maxHp??20,c=Math.min(s,Math.max(1,t?.hp??s)),l=r?.initialVisited?new Set(r.initialVisited):new Set([`${a.x},${a.y}`]),u=r?.initialTriggeredEvents?new Set(r.initialTriggeredEvents):new Set;return{pos:a,dir:o,map:i,mapId:e,visited:l,atExit:!1,steps:0,playerHp:c,playerMaxHp:s,playerAtk:t?.atk??5,playerDef:t?.def??2,battle:null,inventory:n??[],pendingEvent:null,triggeredEvents:u,pendingDeath:!1,pendingBossTilePos:null}}function Wt(e,t,n,r){let i=e.inventory.indexOf(t);if(i===-1||r?.attackEnemy!==void 0&&!e.battle)return e;let a=[...e.inventory.slice(0,i),...e.inventory.slice(i+1)],o=[`${n}を使った！`],s=e.playerHp;if(r?.healHp===`full`?(s=e.playerMaxHp,o.push(`HPが全回復した！`)):typeof r?.healHp==`number`&&(s=Math.min(e.playerMaxHp,e.playerHp+r.healHp),o.push(`HPが ${r.healHp} 回復した！`)),e.battle&&r?.attackEnemy!==void 0){let t=e.battle.enemy,n=Math.min(r.attackEnemy,t.hp),i=Math.max(0,t.hp-r.attackEnemy);o.push(`${t.name} に ${n} の大ダメージ！`);let c={...t,hp:i};return i<=0?(o.push(`${t.name} を倒した！`),{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,phase:`win`,log:[...e.battle.log,...o]}}):{...e,inventory:a,playerHp:s,battle:{...e.battle,enemy:c,log:[...e.battle.log,...o]}}}if(e.battle){let t=[...e.battle.log,...o];return{...e,inventory:a,playerHp:s,battle:{...e.battle,log:t}}}return{...e,inventory:a,playerHp:s}}var Gt=new Set([`.`,`S`,`X`,`#`]);function Kt(e,t){let n=J(e.pos,t),r=Bt(e.map,n.x,n.y);if(r===`#`)return e;let i=`${n.x},${n.y}`,a=new Set(e.visited);a.add(i);let o=r===`X`,s={...e,pos:n,visited:a,atExit:o,steps:e.steps+1};return!o&&r===`B`&&!e.triggeredEvents.has(i)?Mt({...s,pendingBossTilePos:i}):!o&&!Gt.has(r)&&r!==`B`&&!e.triggeredEvents.has(i)?{...s,pendingEvent:r}:!o&&r!==`B`&&Dt[e.mapId]&&Math.random()<It?jt(s):s}function qt(e){return Kt(e,Lt[e.dir].fwd)}function Jt(e){return Kt(e,Lt[e.dir].back)}function Yt(e){return{...e,dir:Rt[e.dir]}}function Xt(e){return{...e,dir:zt[e.dir]}}function Zt(e,t){if(e.pendingDeath)return e;if(e.battle)return Ft(e,t);if(e.pendingEvent!==null||e.atExit)return e;switch(t){case`ArrowUp`:case`w`:case`W`:return qt(e);case`ArrowDown`:case`s`:case`S`:return Jt(e);case`ArrowLeft`:case`a`:case`A`:return Yt(e);case`ArrowRight`:case`d`:case`D`:return Xt(e);default:return e}}function Qt(e,t){let{fwd:n,left:r,right:i}=Lt[e.dir],a=[!1],o=[!1],s=[!1];for(let c=1;c<=t;c++){let t=J(e.pos,Vt(n,c));a.push(Bt(e.map,t.x,t.y)===`#`);let l=J(e.pos,Vt(n,c-1));o.push(Bt(e.map,J(l,r).x,J(l,r).y)===`#`),s.push(Bt(e.map,J(l,i).x,J(l,i).y)===`#`)}return{front:a,left:o,right:s}}var $t=480,Y=320,en=4,tn=[[0,0,480,320],[60,40,420,280],[120,80,360,240],[172,110,308,210],[207,128,273,192]],nn=[1,1,.78,.56,.38];function rn(e,t,n,r){return`rgb(${Math.round(e*r)},${Math.round(t*r)},${Math.round(n*r)})`}function an(e){let t=parseInt(e.replace(`#`,``),16);return[t>>16&255,t>>8&255,t&255]}function on(e,t,n){let{front:r,left:i,right:a}=Qt(t,en),[o,s,c]=an(n.wallFront),[l,u,d]=an(n.wallSide),f=e.createLinearGradient(0,0,0,Y/2);f.addColorStop(0,n.ceilTop),f.addColorStop(1,n.ceilBottom),e.fillStyle=f,e.fillRect(0,0,$t,Y/2);let p=e.createLinearGradient(0,Y/2,0,Y);p.addColorStop(0,n.floorTop),p.addColorStop(1,n.floorBottom),e.fillStyle=p,e.fillRect(0,Y/2,$t,Y/2);let m=en;for(let e=1;e<=en;e++)if(r[e]){m=e;break}for(let t=m;t>=1;t--){let n=nn[t]??.3,[f,p,m,h]=tn[t],[g,_,v,y]=tn[t-1];if(r[t]){e.fillStyle=rn(o,s,c,n),e.fillRect(f,p,m-f,h-p),e.strokeStyle=`rgba(0,0,0,0.45)`,e.lineWidth=1;let t=Math.max(8,Math.floor((h-p)/3));for(let n=p+t;n<h;n+=t)e.beginPath(),e.moveTo(f,n),e.lineTo(m,n),e.stroke();let r=Math.floor((h-p)/t);for(let n=0;n<r;n++){let r=n%2*Math.floor((m-f)/4),i=Math.max(6,Math.floor((m-f)/3));for(let a=f+r;a<m;a+=i)e.beginPath(),e.moveTo(a,p+n*t),e.lineTo(a,p+(n+1)*t),e.stroke()}}i[t]&&(e.fillStyle=rn(l,u,d,n),e.beginPath(),e.moveTo(g,_),e.lineTo(f,p),e.lineTo(f,h),e.lineTo(g,y),e.closePath(),e.fill(),e.strokeStyle=rn(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(f,p),e.lineTo(f,h),e.stroke()),a[t]&&(e.fillStyle=rn(l,u,d,n),e.beginPath(),e.moveTo(m,p),e.lineTo(v,_),e.lineTo(v,y),e.lineTo(m,h),e.closePath(),e.fill(),e.strokeStyle=rn(l+20,u+15,d+5,n),e.lineWidth=1,e.beginPath(),e.moveTo(m,p),e.lineTo(m,h),e.stroke())}if(!r[m]&&m===en){let[t,r,i,a]=tn[en];e.fillStyle=n.ceilTop,e.fillRect(t,r,i-t,a-r)}}var sn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function cn({state:e,theme:t}){let n=(0,a.useRef)(null),r=t??sn;return(0,a.useEffect)(()=>{let t=n.current?.getContext(`2d`);t&&on(t,e,r)},[e,r]),(0,I.jsx)(`canvas`,{ref:n,width:$t,height:Y,style:{display:`block`,imageRendering:`pixelated`}})}var X=10,ln=3,un={N:[[0,-5],[-4,4],[4,4]],E:[[5,0],[-4,-4],[-4,4]],S:[[0,5],[-4,-4],[4,-4]],W:[[-5,0],[4,-4],[4,4]]};function dn({state:e}){let t=(0,a.useRef)(null),n=e.map[0]?.length??0,r=e.map.length,i=n*X+ln*2,o=r*X+ln*2;return(0,a.useEffect)(()=>{let a=t.current?.getContext(`2d`);if(!a)return;a.clearRect(0,0,i,o),a.fillStyle=`#0a0a0a`,a.fillRect(0,0,i,o);for(let t=0;t<r;t++)for(let r=0;r<n;r++){let n=e.map[t]?.[r]??`#`,i=`${r},${t}`,o=e.visited.has(i),s=ln+r*X,c=ln+t*X;n===`#`?(a.fillStyle=o?`#554433`:`#2a1a0a`,a.fillRect(s,c,X,X)):(a.fillStyle=o?`#443322`:`#110a04`,a.fillRect(s,c,X,X),n===`X`&&(a.fillStyle=`#33bb55`,a.fillRect(s+2,c+2,X-4,X-4)))}let s=ln+e.pos.x*X+X/2,c=ln+e.pos.y*X+X/2,l=un[e.dir]??un.N;a.fillStyle=`#ffdd00`,a.beginPath(),a.moveTo(s+l[0][0],c+l[0][1]),a.lineTo(s+l[1][0],c+l[1][1]),a.lineTo(s+l[2][0],c+l[2][1]),a.closePath(),a.fill()},[e,i,o,r,n]),(0,I.jsx)(`canvas`,{ref:t,width:i,height:o,style:{display:`block`,imageRendering:`pixelated`}})}var fn=[`攻撃`,`防御`,`逃げる`];function pn({hp:e,maxHp:t,color:n}){return(0,I.jsx)(`div`,{style:{height:8,background:`#2a2020`,borderRadius:4,overflow:`hidden`},children:(0,I.jsx)(`div`,{style:{width:`${Math.max(0,Math.min(1,t>0?e/t:0))*100}%`,height:`100%`,background:n,transition:`width 0.2s`,borderRadius:4}})})}function mn({label:e,active:t,font:n,theme:r,onHover:i,onClick:o}){let[s,c]=(0,a.useState)(!1),l=t||s;return(0,I.jsx)(`div`,{onMouseEnter:()=>{c(!0),i()},onMouseLeave:()=>c(!1),onClick:o,style:{flex:1,fontSize:13,padding:`8px 0`,background:l?r.uiBorder:`#1a1008`,color:r.uiAccent,border:`1px solid ${l?r.uiAccent:r.uiBorder}`,borderRadius:3,cursor:`pointer`,userSelect:`none`,textAlign:`center`,fontFamily:n,transition:`background 0.1s, border-color 0.1s`},children:e})}function hn({state:e,theme:t,onSelectCommand:n,onCommand:r,font:i}){let{battle:a}=e;if(!a)return null;let o=a.log.at(-1);return(0,I.jsxs)(`div`,{style:{width:`100%`,display:`flex`,flexDirection:`column`,gap:8,flexShrink:0,fontFamily:i},children:[(0,I.jsxs)(`div`,{children:[(0,I.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:t.uiAccent},children:[(0,I.jsx)(`span`,{children:a.enemy.name}),(0,I.jsxs)(`span`,{style:{opacity:.65},children:[`HP `,a.enemy.hp,`/`,a.enemy.maxHp]})]}),(0,I.jsx)(pn,{hp:a.enemy.hp,maxHp:a.enemy.maxHp,color:`#e05050`})]}),a.phase===`select`?(0,I.jsx)(`div`,{style:{display:`flex`,gap:6},children:fn.map((e,o)=>(0,I.jsx)(mn,{label:e,active:a.cursorIndex===o,font:i,theme:t,onHover:()=>n?.(o),onClick:()=>{n?.(o),r?.(o)}},e))}):a.phase===`win`?(0,I.jsx)(`div`,{style:{fontSize:12,color:`#d8b8ff`,opacity:.95,userSelect:`none`,textShadow:`0 0 8px rgba(180,120,255,0.65)`},children:`撃破！`}):(0,I.jsx)(`div`,{style:{fontSize:12,color:`#ff9090`,opacity:.95,userSelect:`none`},children:`倒れてしまった……`}),(0,I.jsxs)(`div`,{style:{borderTop:`1px solid ${t.uiBorder}`,paddingTop:6},children:[o&&(0,I.jsx)(`div`,{style:{fontSize:13,lineHeight:1.5,marginBottom:5,color:`#f3dfaa`,textShadow:`0 0 6px rgba(204,170,102,0.35)`},children:o}),(0,I.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2,maxHeight:74,overflow:`hidden`,background:`rgba(0,0,0,0.18)`,border:`1px solid ${t.uiBorder}`,borderRadius:3,padding:`5px 6px`},children:a.log.slice(-5).map((e,t,n)=>(0,I.jsx)(`div`,{style:{fontSize:11,lineHeight:1.35,opacity:.36+(t+1)/n.length*.5},children:e},`${e}-${t}`))})]})]})}function gn({enemy:e,assetsBaseUrl:t,defeated:n=!1,onClick:r}){let i=e.maxHp>0?e.hp/e.maxHp:1,a=.4+i*.6,o=`${t}/enemies/${e.id}.png`,s=e.id===`maze_boss`;return(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,pointerEvents:`none`},children:[(0,I.jsx)(`div`,{style:{position:`absolute`,width:s?380:250,height:s?340:220,borderRadius:`50%`,background:s?`radial-gradient(circle, rgba(80,0,0,0.80) 0%, rgba(0,0,0,0.60) 40%, transparent 70%)`:`radial-gradient(circle, rgba(0,0,0,0.70) 0%, transparent 68%)`}}),(0,I.jsx)(`img`,{src:o,alt:e.name,style:{position:`relative`,maxHeight:s?280:180,maxWidth:s?300:220,objectFit:`contain`,opacity:a,transition:`opacity 0.5s, transform 0.45s, filter 0.45s`,imageRendering:`pixelated`,transform:n?`scale(1.18) rotate(-3deg)`:void 0,pointerEvents:r&&!n?`auto`:`none`,cursor:r&&!n?`crosshair`:`default`,filter:n?`brightness(2.3) saturate(0) blur(2px) drop-shadow(0 0 28px rgba(220,180,255,0.95))`:s?`drop-shadow(0 0 18px rgba(200,0,0,${.3+i*.5}))`:void 0},title:r&&!n?`${e.name}を攻撃`:void 0,onClick:r,onError:e=>{e.target.style.display=`none`}}),n&&(0,I.jsx)(`div`,{style:{position:`absolute`,width:s?360:250,height:s?300:210,borderRadius:`50%`,background:`radial-gradient(circle, rgba(255,255,255,0.95) 0%, rgba(180,120,255,0.5) 26%, transparent 68%)`,mixBlendMode:`screen`,animation:`maze-enemy-burst 650ms ease-out forwards`}})]})}function _n({name:e,usable:t,count:n,theme:r,font:i,onUse:o}){let[s,c]=(0,a.useState)(!1);return(0,I.jsxs)(`div`,{onClick:t?o:void 0,onMouseEnter:()=>t&&c(!0),onMouseLeave:()=>c(!1),style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,fontSize:12,padding:`5px 8px`,borderRadius:3,cursor:t?`pointer`:`default`,background:s?r.uiBorder:`transparent`,border:`1px solid ${t?s?r.uiAccent:r.uiBorder:`transparent`}`,color:t?r.uiAccent:r.uiBorder,opacity:t?1:.55,fontFamily:i,userSelect:`none`,transition:`background 0.12s`},children:[(0,I.jsx)(`span`,{children:e}),(0,I.jsxs)(`span`,{style:{fontSize:10,opacity:.6},children:[t?`使う`:`　`,n>1?` ×${n}`:``]})]})}function vn({inventory:e,itemDefs:t,theme:n,onUse:r,notification:i,font:a}){let o=new Map(t.map(e=>[e.id,e])),s=new Map;for(let t of e)s.set(t,(s.get(t)??0)+1);let c=[...s.keys()];return(0,I.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,I.jsx)(`div`,{style:{borderTop:`1px solid ${n.uiBorder}`,paddingTop:8,fontSize:10,color:n.uiBorder,letterSpacing:`0.08em`,fontFamily:a},children:`アイテム`}),i&&(0,I.jsx)(`div`,{style:{fontSize:11,color:n.uiAccent,padding:`3px 6px`,background:`${n.uiBorder}55`,borderRadius:3,fontFamily:a},children:i}),c.length===0?(0,I.jsx)(`div`,{style:{fontSize:11,color:n.uiBorder,opacity:.4,padding:`2px 4px`,fontFamily:a},children:`持ち物なし`}):(0,I.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:2},children:c.map(e=>{let t=o.get(e);return(0,I.jsx)(_n,{name:t?.name??e,usable:t?.usable??!1,count:s.get(e)??1,theme:n,font:a,onUse:()=>r(e,t?.name??e)},e)})})]})}var yn={ceilTop:`#020213`,ceilBottom:`#0d0d25`,floorTop:`#130a02`,floorBottom:`#060300`,wallFront:`#9a7420`,wallSide:`#5a420a`,uiBg:`#080504`,uiAccent:`#ccaa66`,uiBorder:`#443322`};function bn(e){return e?{...yn,...e}:yn}var xn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,Sn={N:`北`,E:`東`,S:`南`,W:`西`};function Cn(){let e=()=>Math.min(1,Math.min(window.innerWidth/800,window.innerHeight/600)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function wn(e,t,n,r){let i=r&&n?n:t;(0,a.useEffect)(()=>{if(!i)return;let t=`${e.replace(/\/$/,``)}/${i}`,n=new Audio(t);return n.loop=!0,n.volume=.6,n.play().catch(()=>{}),()=>{n.pause(),n.currentTime=0}},[i,e])}function Tn({hp:e,maxHp:t,theme:n}){let r=Math.max(0,Math.min(1,t>0?e/t:0)),i=r>.5?`#50c050`:r>.25?`#c0a020`:`#e03030`;return(0,I.jsxs)(`div`,{children:[(0,I.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:11,marginBottom:4,color:n.uiAccent},children:[(0,I.jsx)(`span`,{style:{letterSpacing:`0.06em`},children:`HP`}),(0,I.jsxs)(`span`,{style:{opacity:.8},children:[e,` / `,t]})]}),(0,I.jsx)(`div`,{style:{height:6,background:`#2a2020`,borderRadius:3,overflow:`hidden`},children:(0,I.jsx)(`div`,{style:{width:`${r*100}%`,height:`100%`,background:i,transition:`width 0.3s`,borderRadius:3}})})]})}function En({label:e,theme:t,onClick:n}){let[r,i]=(0,a.useState)(!1);return(0,I.jsx)(`button`,{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),onClick:n,style:{flex:1,background:r?t.uiBorder:`#1a1008`,border:`1px solid ${r?t.uiAccent:t.uiBorder}`,color:t.uiAccent,fontFamily:xn,fontSize:12,padding:`8px 4px`,cursor:`pointer`,borderRadius:3,userSelect:`none`,textAlign:`center`,transition:`background 0.1s, border-color 0.1s`},children:e})}function Dn({context:e,config:t,onExit:n}){let r=Cn(),[i,o]=(0,a.useState)(()=>Ut(t.map,e.playerStats,e.inventory,{initialPos:t.initialPos,initialDir:t.initialDir,initialVisited:t.initialVisited,initialTriggeredEvents:t.initialTriggeredEvents})),s=bn(t.theme),c=t.assetsBaseUrl??`/assets`;wn(c,t.bgm,t.battleBgm,!!i.battle);let[l,u]=(0,a.useState)(null),[d,f]=(0,a.useState)(!1),[p,m]=(0,a.useState)(!1),h=(0,a.useRef)(null),g=(0,a.useRef)(i.battle),_=(0,a.useCallback)(e=>{o(t=>Zt(t,e))},[]),v=(0,a.useCallback)(()=>{!i.battle||i.battle.phase!==`select`||(f(!0),window.setTimeout(()=>f(!1),180),o(e=>!e.battle||e.battle.phase!==`select`?e:Zt({...e,battle:{...e.battle,cursorIndex:0}},`Enter`)))},[i.battle]),y=(0,a.useCallback)((e,n)=>{let r=t.itemEffects?.[e];r?.attackEnemy!==void 0&&!i.battle||(o(t=>Wt(t,e,n,r)),i.battle||(h.current&&clearTimeout(h.current),u(r?.healHp===`full`?`${n}を使った！ HP全回復！`:typeof r?.healHp==`number`?`${n}を使った！ HP+${r.healHp}！`:`${n}を使った！`),h.current=setTimeout(()=>u(null),2500)))},[t.itemEffects,i.battle]);(0,a.useEffect)(()=>{let e=e=>{[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`Enter`,` `].includes(e.key)&&e.preventDefault(),o(t=>Zt(t,e.key))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[]),(0,a.useEffect)(()=>{let e=g.current,t=i.battle;if(t?.phase===`win`&&e?.phase!==`win`){m(!0);let e=window.setTimeout(()=>m(!1),900);return g.current=t,()=>window.clearTimeout(e)}(!t||t.phase===`select`)&&m(!1),g.current=t},[i.battle]),(0,a.useEffect)(()=>{if(i.battle?.phase!==`win`&&i.battle?.phase!==`lose`)return;let e=i.battle.phase===`win`?850:1050,t=window.setTimeout(()=>{o(e=>e.battle?.phase!==`win`&&e.battle?.phase!==`lose`?e:Zt(e,`Enter`))},e);return()=>window.clearTimeout(t)},[i.battle?.phase]);let b=(0,a.useCallback)(()=>({...e,flags:{...e.flags,[`explored_${t.map}`]:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}}),[e,t.map,i.inventory,i.playerHp,i.playerMaxHp,i.playerAtk,i.playerDef]),x=(0,a.useCallback)(()=>{let e=b(),r={...e,playerStats:{...e.playerStats,hp:i.playerMaxHp}},a=t._novelReturn;a?.exitSceneId?n(r,{engineId:`novel`,config:{...a,initialSceneId:a.exitSceneId,autoStart:!0}}):n(r)},[b,t._novelReturn,n,i.playerMaxHp]);(0,a.useEffect)(()=>{if(!i.pendingDeath)return;let r=t._novelReturn;if(r){if(i.pendingBossTilePos&&r.gameoverBossSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0,flag_boss_challenged:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},[o,s]=i.pendingBossTilePos.split(`,`).map(Number),c={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn,initialPos:{x:(o??0)-1,y:s??0},initialDir:`E`,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverBossSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:c,returnTransition:`rift`})}else if(r.gameoverSceneId){let a={...e,flags:{...e.flags,flag_maze_defeated:!0},inventory:i.inventory,playerStats:{...e.playerStats,hp:i.playerMaxHp,maxHp:i.playerMaxHp,atk:i.playerAtk,def:i.playerDef}},o={map:t.map,name:t.name,theme:t.theme,assetsBaseUrl:t.assetsBaseUrl,bgm:t.bgm,battleBgm:t.battleBgm,items:t.items,events:t.events,itemEffects:t.itemEffects,_novelReturn:t._novelReturn};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:r.gameoverLandingSceneId??r.gameoverSceneId,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:o,returnTransition:`rift`})}}},[i.pendingDeath]),(0,a.useEffect)(()=>{if(!i.pendingEvent)return;let e=t.events?.[i.pendingEvent],r=t._novelReturn;if(!e||!r)return;let a=b(),o=`${i.pos.x},${i.pos.y}`,s={...t,initialPos:i.pos,initialDir:i.dir,initialVisited:[...i.visited],initialTriggeredEvents:[...i.triggeredEvents,o]};n(a,{engineId:`novel`,transition:`rift`,config:{...r,initialSceneId:e,autoStart:!0},returnEngineId:`maze_rpg`,returnConfig:s,returnTransition:`rift`})},[i.pendingEvent]);let S=(0,a.useCallback)(e=>{i.atExit&&(e.key!==`Enter`&&e.key!==` `||x())},[i.atExit,x]);return(0,a.useEffect)(()=>(window.addEventListener(`keydown`,S),()=>window.removeEventListener(`keydown`,S)),[S]),(0,I.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:s.uiBg,overflow:`hidden`},children:(0,I.jsxs)(`div`,{style:{width:800,height:600,flexShrink:0,transformOrigin:`center center`,transform:`scale(${r})`,background:s.uiBg,display:`flex`,flexDirection:`column`,fontFamily:xn,color:s.uiAccent,userSelect:`none`,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`},children:[(0,I.jsx)(`style`,{children:`
        ...
        `}),(0,I.jsxs)(`div`,{style:{background:s.uiBorder,borderBottom:`1px solid ${s.uiBorder}`,padding:`4px 12px`,fontSize:13,display:`flex`,justifyContent:`space-between`,alignItems:`center`,flexShrink:0,letterSpacing:`0.06em`},children:[(0,I.jsxs)(`span`,{children:[`⚔ `,t.name??t.map]}),(0,I.jsxs)(`span`,{style:{fontSize:11,opacity:.7},children:[`歩数: `,i.steps]})]}),(0,I.jsxs)(`div`,{style:{display:`flex`,flex:1,overflow:`hidden`},children:[(0,I.jsx)(`div`,{style:{flex:`0 0 488px`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,I.jsxs)(`div`,{style:{position:`relative`},children:[(0,I.jsxs)(`div`,{style:{border:`2px solid ${s.uiBorder}`,boxShadow:`0 0 12px rgba(100,60,10,0.4)`,position:`relative`},children:[(0,I.jsx)(cn,{state:i,theme:s}),i.battle&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(gn,{enemy:i.battle.enemy,assetsBaseUrl:c,defeated:p||i.battle.phase===`win`,onClick:i.battle.phase===`select`?v:void 0}),d&&(0,I.jsx)(`div`,{style:{position:`absolute`,left:`50%`,top:`45%`,width:240,height:18,borderRadius:10,background:`linear-gradient(90deg, transparent, rgba(255,255,255,0.98), rgba(180,90,255,0.7), transparent)`,boxShadow:`0 0 18px rgba(220,180,255,0.9)`,pointerEvents:`none`,animation:`maze-hit-slash 180ms ease-out forwards`}})]}),!i.battle&&!i.atExit&&(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`grid`,gridTemplateColumns:`1fr 2fr 1fr`,gridTemplateRows:`1fr 1fr`},children:[(0,I.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>_(`ArrowLeft`)}),(0,I.jsx)(`div`,{title:`前進`,style:{cursor:`n-resize`},onClick:()=>_(`ArrowUp`)}),(0,I.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>_(`ArrowRight`)}),(0,I.jsx)(`div`,{title:`左回転`,style:{cursor:`w-resize`},onClick:()=>_(`ArrowLeft`)}),(0,I.jsx)(`div`,{title:`後退`,style:{cursor:`s-resize`},onClick:()=>_(`ArrowDown`)}),(0,I.jsx)(`div`,{title:`右回転`,style:{cursor:`e-resize`},onClick:()=>_(`ArrowRight`)})]})]}),i.atExit&&(0,I.jsx)(`div`,{onClick:x,style:{marginTop:8,background:`#1a2a0a`,border:`1px solid #44aa22`,borderRadius:4,padding:`8px 16px`,color:`#88ff44`,fontSize:14,textAlign:`center`,cursor:`pointer`,fontFamily:xn,letterSpacing:`0.04em`},children:`階段を見つけた！ [Enter] / クリックで地上へ戻る`})]})}),(0,I.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,borderLeft:`1px solid ${s.uiBorder}`,padding:`10px 10px 8px`,gap:8,overflow:`hidden`},children:[(0,I.jsx)(Tn,{hp:i.playerHp,maxHp:i.playerMaxHp,theme:s}),(0,I.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),(0,I.jsxs)(`div`,{style:{display:`flex`,gap:10,alignItems:`flex-start`,justifyContent:`center`},children:[(0,I.jsx)(`div`,{style:{border:`1px solid ${s.uiBorder}`},children:(0,I.jsx)(dn,{state:i})}),(0,I.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:4},children:[(0,I.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`24px 24px 24px`,gridTemplateRows:`24px 24px 24px`,gap:2,textAlign:`center`},children:[[``,`N`,``].map((e,t)=>(0,I.jsx)(On,{label:e,dir:i.dir,theme:s},`t${t}`)),[`W`,``,`E`].map((e,t)=>(0,I.jsx)(On,{label:e,dir:i.dir,theme:s},`m${t}`)),[``,`S`,``].map((e,t)=>(0,I.jsx)(On,{label:e,dir:i.dir,theme:s},`b${t}`))]}),(0,I.jsx)(`div`,{style:{fontSize:11,color:s.uiAccent,letterSpacing:`0.05em`},children:Sn[i.dir]}),(0,I.jsxs)(`div`,{style:{fontSize:9,color:s.uiBorder,letterSpacing:`0.04em`},children:[`(`,i.pos.x,`,`,i.pos.y,`)`]})]})]}),(0,I.jsx)(`div`,{style:{borderTop:`1px solid ${s.uiBorder}`,flexShrink:0}}),i.battle?(0,I.jsx)(hn,{state:i,theme:s,font:xn,onSelectCommand:e=>o(t=>!t.battle||t.battle.phase!==`select`?t:{...t,battle:{...t.battle,cursorIndex:e}}),onCommand:e=>o(t=>!t.battle||t.battle.phase!==`select`?t:Zt({...t,battle:{...t.battle,cursorIndex:e}},`Enter`))}):(0,I.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,I.jsx)(`div`,{style:{display:`flex`},children:(0,I.jsx)(En,{label:`↑ 前進`,theme:s,onClick:()=>_(`ArrowUp`)})}),(0,I.jsxs)(`div`,{style:{display:`flex`,gap:4},children:[(0,I.jsx)(En,{label:`← 左`,theme:s,onClick:()=>_(`ArrowLeft`)}),(0,I.jsx)(En,{label:`↓ 後退`,theme:s,onClick:()=>_(`ArrowDown`)}),(0,I.jsx)(En,{label:`→ 右`,theme:s,onClick:()=>_(`ArrowRight`)})]})]}),(0,I.jsx)(vn,{inventory:i.inventory,itemDefs:t.items??[],theme:s,onUse:y,notification:l??void 0,font:xn})]})]})]})})}function On({label:e,dir:t,theme:n}){let r=e===t;return(0,I.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,background:r?n.uiBorder:e?n.uiBg:`transparent`,border:e?`1px solid ${r?n.uiAccent:n.uiBorder}`:`none`,borderRadius:2,color:r?n.uiAccent:n.uiBorder,fontWeight:r?`bold`:`normal`,fontSize:10,fontFamily:xn},children:e})}var kn={component:Dn},Z=800,An=600,jn=50,Mn=An-jn*2,Q=jn+Mn-50,$=150,Nn=42,Pn=72,Fn=.0017,In=-.82,Ln=3e4,Rn=420,zn=100,Bn=.0048,Vn=18,Hn=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,Un=[{id:`candy_01`,type:`candy`,spawnMs:1600,laneY:356,speed:.34,size:28},{id:`pot_01`,type:`pot`,spawnMs:3300,laneY:395,speed:.38,size:46},{id:`candy_02`,type:`candy`,spawnMs:4700,laneY:318,speed:.37,size:28},{id:`candy_03`,type:`candy`,spawnMs:6600,laneY:392,speed:.42,size:30},{id:`pot_02`,type:`pot`,spawnMs:8200,laneY:342,speed:.43,size:48},{id:`candy_04`,type:`candy`,spawnMs:1e4,laneY:360,speed:.46,size:28},{id:`candy_05`,type:`candy`,spawnMs:11800,laneY:302,speed:.42,size:30},{id:`pot_03`,type:`pot`,spawnMs:13700,laneY:400,speed:.48,size:50},{id:`candy_06`,type:`candy`,spawnMs:15400,laneY:340,speed:.48,size:30},{id:`candy_07`,type:`candy`,spawnMs:17600,laneY:388,speed:.52,size:28},{id:`pot_04`,type:`pot`,spawnMs:19600,laneY:330,speed:.52,size:50},{id:`candy_08`,type:`candy`,spawnMs:21500,laneY:358,speed:.55,size:30},{id:`candy_09`,type:`candy`,spawnMs:23800,laneY:305,speed:.5,size:28},{id:`pot_05`,type:`pot`,spawnMs:26e3,laneY:390,speed:.56,size:52},{id:`candy_10`,type:`candy`,spawnMs:27800,laneY:346,speed:.58,size:30}],Wn=[{id:`dog_01`,type:`dog`,spawnMs:1800,laneY:392,speed:.42,size:48},{id:`bird_01`,type:`bird`,spawnMs:3800,laneY:300,speed:.46,size:42},{id:`dog_02`,type:`dog`,spawnMs:6200,laneY:394,speed:.5,size:50},{id:`bird_02`,type:`bird`,spawnMs:8400,laneY:292,speed:.52,size:44},{id:`dog_03`,type:`dog`,spawnMs:11100,laneY:396,speed:.56,size:52},{id:`bird_03`,type:`bird`,spawnMs:13600,laneY:306,speed:.58,size:42},{id:`dog_04`,type:`dog`,spawnMs:16400,laneY:390,speed:.62,size:52},{id:`bird_04`,type:`bird`,spawnMs:19e3,laneY:298,speed:.64,size:44}],Gn={sky:`#151827`,ground:`#2a2d32`,accent:`#f2d16b`};function Kn(e){return{...Gn,...e}}function qn(){let e=()=>Math.min(1,Math.min(window.innerWidth/Z,window.innerHeight/An)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function Jn(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function Yn(e){let[t,n]=(0,a.useState)(null),[r,i]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{if(!e){n(null),i(!1);return}let t=!1,r=new Image;return r.onload=()=>{t||(n(r),i(!1))},r.onerror=()=>{t||(n(null),i(!0))},r.src=e,()=>{t=!0}},[e]),{image:t,failed:r}}function Xn(e,t,n=.28){(0,a.useEffect)(()=>{let r,i=Math.max(0,Math.min(1,n));if(t?.startsWith(`synth:`))return r=Zn(i),()=>r?.();if(t){let n=new Audio(Jn(e,t));return n.loop=!0,n.volume=i,n.play().catch(()=>{}),r=()=>{n.pause(),n.currentTime=0},()=>r?.()}},[e,t,n])}function Zn(e){let t=window.AudioContext??window.webkitAudioContext;if(!t)return()=>{};let n=new t,r=n.createGain();r.gain.value=e,r.connect(n.destination);let i=n.createDelay();i.delayTime.value=.18;let a=n.createGain();a.gain.value=.18,i.connect(a),a.connect(i),i.connect(r);let o=[392,523.25,659.25,783.99,659.25,523.25,440,587.33],s=0,c=!1,l=()=>{if(c)return;let e=n.currentTime,t=n.createOscillator(),a=n.createGain();t.type=s%4==0?`square`:`triangle`,t.frequency.setValueAtTime(o[s%o.length],e),a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.24,e+.018),a.gain.exponentialRampToValueAtTime(1e-4,e+.16),t.connect(a),a.connect(r),a.connect(i),t.start(e),t.stop(e+.18),s+=1};n.resume().catch(()=>{}),l();let u=window.setInterval(l,135);return()=>{c=!0,window.clearInterval(u),n.close().catch(()=>{})}}function Qn(e,t,n=1){return Z+80-Math.max(0,t-e.spawnMs)*e.speed*n}function $n(e){return e.type===`dog`?Q-e.size:e.laneY}function er(e,t){return e.x<t.x+t.width&&e.x+e.width>t.x&&e.y<t.y+t.height&&e.y+e.height>t.y}function tr(e,t){let n=e.y-(Q-Pn);return Q-t+n}function nr(e,t,n,r,i){let a=Math.sin(i*.012)*4;e.save(),e.translate(t+r/2,n+r/2),e.rotate(Math.sin(i*.008)*.4),e.fillStyle=`#ff7aa8`,e.beginPath(),e.ellipse(0,0,r*.42,r*.3,0,0,Math.PI*2),e.fill(),e.fillStyle=`#fff1b8`,e.fillRect(-r*.14,-r*.28+a*.03,r*.28,r*.56),e.fillStyle=`#ffd6e5`,e.beginPath(),e.moveTo(-r*.38,0),e.lineTo(-r*.62,-r*.2),e.lineTo(-r*.62,r*.2),e.closePath(),e.fill(),e.beginPath(),e.moveTo(r*.38,0),e.lineTo(r*.62,-r*.2),e.lineTo(r*.62,r*.2),e.closePath(),e.fill(),e.restore()}function rr(e,t,n,r,i){e.save(),e.translate(t+r/2,n+r/2),e.rotate(i*.012),e.fillStyle=`#59606b`,e.beginPath(),e.roundRect(-r*.42,-r*.25,r*.84,r*.58,r*.12),e.fill(),e.strokeStyle=`#d5dde8`,e.lineWidth=4,e.beginPath(),e.arc(0,-r*.32,r*.28,Math.PI,Math.PI*2),e.stroke(),e.strokeStyle=`#2c3139`,e.lineWidth=5,e.beginPath(),e.moveTo(-r*.5,-r*.08),e.lineTo(-r*.7,-r*.08),e.moveTo(r*.5,-r*.08),e.lineTo(r*.7,-r*.08),e.stroke(),e.restore()}function ir(e,t,n,r,i){let a=Math.sin(i*.02)*3;e.save(),e.translate(t,n),e.fillStyle=`#8b5a3c`,e.fillRect(r*.16,r*.34,r*.58,r*.3),e.fillStyle=`#a46a45`,e.beginPath(),e.arc(r*.74,r*.36,r*.18,0,Math.PI*2),e.fill(),e.fillStyle=`#5b3928`,e.beginPath(),e.moveTo(r*.68,r*.22),e.lineTo(r*.78,r*.02),e.lineTo(r*.84,r*.26),e.closePath(),e.fill(),e.strokeStyle=`#5b3928`,e.lineWidth=4,e.beginPath(),e.moveTo(r*.15,r*.38),e.quadraticCurveTo(-r*.05,r*.18,r*.1,r*.08),e.stroke(),e.fillStyle=`#3b2319`,e.fillRect(r*.24,r*.62,r*.1,r*.24+a),e.fillRect(r*.56,r*.62,r*.1,r*.24-a),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.8,r*.34,2.5,0,Math.PI*2),e.fill(),e.restore()}function ar(e,t,n,r,i){let a=Math.sin(i*.024)*r*.16;e.save(),e.translate(t+r/2,n+r/2),e.fillStyle=`#3f78a8`,e.beginPath(),e.ellipse(0,0,r*.28,r*.2,0,0,Math.PI*2),e.fill(),e.fillStyle=`#72b7d2`,e.beginPath(),e.moveTo(-r*.08,-r*.06),e.quadraticCurveTo(-r*.44,-r*.36-a,-r*.5,r*.02),e.quadraticCurveTo(-r*.26,r*.06,-r*.08,r*.04),e.fill(),e.beginPath(),e.moveTo(r*.08,-r*.06),e.quadraticCurveTo(r*.44,-r*.36+a,r*.5,r*.02),e.quadraticCurveTo(r*.26,r*.06,r*.08,r*.04),e.fill(),e.fillStyle=`#f2d16b`,e.beginPath(),e.moveTo(r*.28,-r*.02),e.lineTo(r*.44,r*.04),e.lineTo(r*.28,r*.1),e.closePath(),e.fill(),e.fillStyle=`#11131a`,e.beginPath(),e.arc(r*.16,-r*.06,2.4,0,Math.PI*2),e.fill(),e.restore()}function or(e,t,n){let r=Math.min(650,$+95+t*3.6),i=Q-74+Math.sin(n*.02)*3;e.save(),e.translate(r,i),e.fillStyle=`#f1d2b0`,e.fillRect(13,0,24,22),e.fillStyle=`#2b2f39`,e.fillRect(8,20,34,36),e.fillStyle=`#e6533f`,e.fillRect(4,28,42,10),e.fillStyle=`#151827`,e.fillRect(12,54,10,24),e.fillRect(30,54,10,24),e.fillStyle=`#f2d16b`,e.fillRect(17,8,4,4),e.fillRect(29,8,4,4),e.restore()}function sr(e,t,n,r){t.type===`candy`?nr(e,n,$n(t),t.size,r):t.type===`pot`?rr(e,n,$n(t),t.size,r):t.type===`dog`?ir(e,n,$n(t),t.size,r):ar(e,n,$n(t),t.size,r)}function cr(e,t,n,r,i){let a=Math.min(1,t.elapsedMs/n.durationMs),o=n.mode===`chase`,s=o?Wn:Un,c=t.worldElapsedMs*.18,l=t.elapsedMs<t.penaltyUntilMs;if(e.fillStyle=`#000`,e.fillRect(0,0,Z,An),i.backgroundImage){let t=i.backgroundImage.width*(Mn/i.backgroundImage.height),n=Math.max(1,i.backgroundLoopWidth,t),r=n*(i.backgroundImage.height/i.backgroundImage.width),a=jn+(r>Mn?(Mn-r)/2:0),o=-(c*.65%n);for(let t=o-n;t<Z+n;t+=n)e.drawImage(i.backgroundImage,t,a,n,r)}else{let t=e.createLinearGradient(0,0,0,Q);t.addColorStop(0,r.sky),t.addColorStop(1,`#090a12`),e.fillStyle=t,e.fillRect(0,jn,Z,Mn),e.fillStyle=`rgba(255,255,255,0.12)`;for(let t=0;t<6;t+=1){let n=(t*180-c*.18%180+Z)%Z;e.fillRect(n,120+t%2*34,82,10)}e.fillStyle=`#202431`;for(let t=0;t<9;t+=1){let n=(t*130-c*.48%130+Z)%Z,r=78+t%3*34;e.fillRect(n,Q-r,72,r),e.fillStyle=`rgba(242,209,107,0.22)`,e.fillRect(n+16,Q-r+18,10,16),e.fillRect(n+44,Q-r+46,10,16),e.fillStyle=`#202431`}}if(!i.backgroundImage){e.fillStyle=r.ground,e.fillRect(0,Q,Z,An-Q),e.fillStyle=`#11131a`;for(let t=0;t<18;t+=1){let n=(t*58-c%58+Z)%Z;e.fillRect(n,Q+18,34,4)}for(let t=0;t<7;t+=1){let n=(t*190-c*.95%190+Z)%Z,i=28+t%2*18;e.fillStyle=`#342739`,e.fillRect(n,Q-i,38,i),e.fillStyle=r.accent,e.fillRect(n+8,Q-i-8,22,8)}}let u=t.grounded?Math.sin(t.elapsedMs*.018)*3:0,d=t.y+u,f=l?-34+Math.sin(t.elapsedMs*.08)*8:0;i.playerImageEnabled||(e.fillStyle=`#f1f3f5`,e.fillRect($+f+10,d,22,22),e.fillStyle=r.accent,e.fillRect($+f,d+24,Nn,36),e.fillStyle=`#11131a`,e.fillRect($+f+6,d+58,12,24),e.fillRect($+f+25,d+58,12,24),e.fillStyle=`#f1f3f5`,e.fillRect($+f+Nn,d+30,20,10)),o&&!i.opponentImageEnabled&&or(e,t.chaseDistance,t.elapsedMs);for(let r of s){if(t.collectedIds.includes(r.id)||t.hitIds.includes(r.id))continue;let i=Qn(r,t.worldElapsedMs,n.objectSpeedMultiplier);i<-100||i>Z+120||sr(e,r,i,t.elapsedMs)}if(e.fillStyle=`rgba(0,0,0,0.35)`,e.fillRect(24,24,752,56),e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,58,712,8),e.fillStyle=r.accent,e.fillRect(44,58,712*a,8),o){let r=1-Math.min(1,Math.max(0,t.chaseDistance/n.chaseStartDistance));e.fillStyle=`rgba(255,255,255,0.18)`,e.fillRect(44,70,712,6),e.fillStyle=`#ff8f70`,e.fillRect(44,70,712*r,6)}e.fillStyle=`#f7f2dc`,e.font=`20px ${Hn}`,e.fillText(o?`公園の追跡劇`:`アーケード街の死闘`,44,48),e.font=`14px ${Hn}`,e.fillText(`${Math.ceil((n.durationMs-t.elapsedMs)/1e3)}秒`,708,48),e.fillText(o?`距離 ${Math.ceil(t.chaseDistance)}`:`アメ ${t.score}`,610,48),l&&(e.fillStyle=`rgba(120,0,0,0.7)`,e.fillRect(300,92,200,32),e.fillStyle=`#fff4e8`,e.font=`16px ${Hn}`,e.fillText(o?`追いつけない！`:`鍋に当たった！`,o?348:344,114));let p=[i.backgroundImageConfigured&&i.backgroundImageFailed?`background image not found`:null,i.playerImageConfigured&&i.playerImageFailed?`player image not found`:null,i.opponentImageConfigured&&i.opponentImageFailed?`opponent image not found`:null].filter(Boolean);p.length>0&&(e.fillStyle=`rgba(120,0,0,0.72)`,e.fillRect(24,92,360,30),e.fillStyle=`#fff4e8`,e.font=`13px ${Hn}`,e.fillText(p.join(` / `),38,112))}function lr({context:e,config:t,onExit:n}){let r=(0,a.useRef)(null),i=t.mode??`collect`,o=Math.max(1e3,t.durationMs||Ln),s=Math.max(1,t.chaseStartDistance??zn),c=Math.max(.001,t.chaseCatchRate??Bn),l=Math.max(0,t.chaseHitDistancePenalty??Vn),u=(0,a.useRef)({elapsedMs:0,worldElapsedMs:0,y:Q-Pn,velocityY:0,grounded:!0,score:0,penaltyCount:0,penaltyUntilMs:0,scrollFreezeUntilMs:0,chaseDistance:s,collectedIds:[],hitIds:[]}),d=(0,a.useRef)(null),f=(0,a.useRef)(!1),[p,m]=(0,a.useState)(0),h=qn(),g=(0,a.useMemo)(()=>Kn(t.theme),[t.theme]),_=t.stageId||`default`,v=Jn(t.assetsBaseUrl,t.backgroundImage),y=Jn(t.assetsBaseUrl,t.playerImage),b=Jn(t.assetsBaseUrl,t.opponentImage);Xn(t.assetsBaseUrl,t.bgm,t.bgmVolume);let x=Yn(v),S=Yn(y),C=Yn(b),ee=Math.max(1,t.backgroundLoopWidth??Z),w=Math.max(1,t.playerWidth??74),T=Math.max(1,t.playerHeight??104),E=Math.max(1,t.opponentWidth??58),D=Math.max(1,t.opponentHeight??84),O=Math.max(.1,t.objectSpeedMultiplier??1),k=(0,a.useCallback)(()=>{let e=u.current;e.grounded&&(u.current={...e,velocityY:In,grounded:!1})},[]),A=(0,a.useCallback)(t=>{if(f.current)return;f.current=!0;let r=u.current;n({...e,flags:{...e.flags,cleared_runner_action:!0,[`cleared_runner_action_${_}`]:!0,runner_action_score:r.score,[`runner_action_score_${_}`]:r.score,runner_action_penalties:r.penaltyCount,[`runner_action_penalties_${_}`]:r.penaltyCount,runner_action_result:t,[`runner_action_result_${_}`]:t,runner_action_distance:Math.ceil(r.chaseDistance),[`runner_action_distance_${_}`]:Math.ceil(r.chaseDistance)},playerStats:{...e.playerStats,runnerScore:r.score,runnerPenalties:r.penaltyCount,runnerDistance:Math.ceil(r.chaseDistance)}})},[e,n,_]);(0,a.useEffect)(()=>{let e=e=>{e.key!==` `&&e.key!==`Enter`||(e.preventDefault(),k())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[k]),(0,a.useEffect)(()=>{let e=0,t=n=>{let a=d.current??n,f=Math.min(40,n-a);d.current=n;let p=u.current,h=Math.min(o,p.elapsedMs+f),_=p.elapsedMs<p.scrollFreezeUntilMs?0:f,E=Math.min(o,p.worldElapsedMs+_),D=i===`chase`?Math.max(0,p.chaseDistance-_*c):p.chaseDistance,k=p.velocityY+Fn*f,j=p.y+k*f,M=!1,N=Q-Pn;j>=N&&(j=N,k=0,M=!0);let P={...p,elapsedMs:h,worldElapsedMs:E,chaseDistance:D,y:j,velocityY:k,grounded:M},te=i===`chase`?Wn:Un,F=h<P.penaltyUntilMs,ne=Math.max(24,Math.min(w,74)-12),re=Math.max(48,Math.min(T,104)-8),ie={x:$+(F?-34:0)+8,y:tr(P,T)+4,width:ne,height:re};for(let e of te){if(P.collectedIds.includes(e.id)||P.hitIds.includes(e.id))continue;let t=Qn(e,E,O);t<-100||t>Z+120||er(ie,{x:t,y:$n(e),width:e.size,height:e.size})&&(P=e.type===`candy`?{...P,score:P.score+1,collectedIds:[...P.collectedIds,e.id]}:{...P,score:Math.max(0,P.score-2),penaltyCount:P.penaltyCount+1,penaltyUntilMs:h+900,scrollFreezeUntilMs:h+Rn,chaseDistance:i===`chase`?Math.min(s,P.chaseDistance+l):P.chaseDistance,hitIds:[...P.hitIds,e.id]})}u.current=P;let ae=r.current?.getContext(`2d`);if(ae&&cr(ae,P,{durationMs:o,mode:i,chaseStartDistance:s,objectSpeedMultiplier:O},g,{backgroundImage:x.image,backgroundImageConfigured:!!v,backgroundImageFailed:x.failed,backgroundLoopWidth:ee,playerImageEnabled:!!y&&!S.failed,playerImageConfigured:!!y,playerImageFailed:S.failed,opponentImageEnabled:!!b&&!C.failed,opponentImageConfigured:!!b,opponentImageFailed:C.failed,playerWidth:w,playerHeight:T}),m(h),i===`chase`&&P.chaseDistance<=0){A(`win`);return}if(h>=o){A(i===`chase`?`lose`:`complete`);return}e=requestAnimationFrame(t)};return e=requestAnimationFrame(t),()=>cancelAnimationFrame(e)},[x.failed,x.image,v,ee,c,l,s,o,A,i,C.failed,C.image,b,O,S.failed,S.image,T,y,w,_,g]);let j=Math.min(1,p/o),M=u.current,N=M.elapsedMs<M.penaltyUntilMs,P=M.grounded?Math.sin(M.elapsedMs*.018)*3:0,te=$+(N?-34+Math.sin(M.elapsedMs*.08)*8:0),F=tr(M,T)+P,ne=!!y&&!S.failed,re=Math.min(650,$+95+M.chaseDistance*3.6),ie=Q-D+Math.sin(M.elapsedMs*.02)*3,ae=i===`chase`&&!!b&&!C.failed;return(0,I.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#05060a`,overflow:`hidden`},children:(0,I.jsxs)(`div`,{style:{width:Z,height:An,flexShrink:0,transform:`scale(${h})`,transformOrigin:`center center`,position:`relative`,background:g.sky,overflow:`hidden`,boxShadow:`0 0 60px rgba(0,0,0,0.8)`,fontFamily:Hn},onMouseDown:k,onTouchStart:e=>{e.preventDefault(),k()},children:[(0,I.jsx)(`canvas`,{ref:r,width:Z,height:An,style:{display:`block`}}),ne&&(0,I.jsx)(`img`,{src:y,alt:``,draggable:!1,style:{position:`absolute`,left:te,top:F,width:w,height:T,pointerEvents:`none`,userSelect:`none`}}),ae&&(0,I.jsx)(`img`,{src:b,alt:``,draggable:!1,style:{position:`absolute`,left:re,top:ie,width:E,height:D,pointerEvents:`none`,userSelect:`none`}}),(0,I.jsxs)(`div`,{style:{position:`absolute`,left:24,right:24,bottom:22,display:`flex`,alignItems:`center`,justifyContent:`space-between`,color:`#f7f2dc`,fontSize:14,textShadow:`0 2px 6px rgba(0,0,0,0.8)`,pointerEvents:`none`},children:[(0,I.jsx)(`span`,{children:t.name??`Runner Action`}),(0,I.jsx)(`span`,{children:`Space / Enter / Click`}),(0,I.jsxs)(`span`,{children:[Math.round(j*100),`%`]})]})]})})}var ur={component:lr},dr=`'Hiragino Mincho ProN', 'Yu Mincho', 'MS Mincho', serif`,fr=800,pr=600,mr=148,hr=36,gr=130,_r=pr-hr-gr,vr=120,yr=[{symbol:`飴`,color:`#f4a260`},{symbol:`花`,color:`#f48fb1`},{symbol:`星`,color:`#fff176`},{symbol:`月`,color:`#ce93d8`},{symbol:`家`,color:`#80cbc4`},{symbol:`鐘`,color:`#80deea`},{symbol:`鳥`,color:`#a5d6a7`},{symbol:`波`,color:`#64b5f6`}],br=[`どれかな……`,`えーと……`,`うーん……`],xr=[`……`,`ふむ……`,`どれかな`],Sr=[`やった！`,`そろった！`,`ふふ`],Cr=[`いただき`,`ふふふ`,`そうそう`],wr=[`あれ……`,`ちがった`,`うーん`],Tr=[`おや`,`むむ……`,`ちがったか`];async function Er(e){let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-1`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)}function Dr(e){let t=(0,a.useRef)(null);return{speak:(0,a.useCallback)(async(n,r)=>{let i=await Er(`${n}_${r}`),a=`${(e??`/assets`).replace(/\/$/,``)}/voicevox/${i}.wav`,o=(await fetch(a,{method:`HEAD`}).catch(()=>null))?.ok?a:null;if(!o)try{let e=await fetch(`http://localhost:50021/audio_query?text=${encodeURIComponent(n)}&speaker=${r}`,{method:`POST`}).then(e=>e.json()),t=await fetch(`http://localhost:50021/synthesis?speaker=${r}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}).then(e=>e.arrayBuffer()).catch(()=>null);t&&(o=URL.createObjectURL(new Blob([t],{type:`audio/wav`})))}catch{}if(!o)return;t.current&&t.current.pause();let s=new Audio(o);t.current=s,s.play().catch(()=>{})},[e]),stop:(0,a.useCallback)(()=>{t.current&&=(t.current.pause(),null)},[])}}function Or(){let e=()=>Math.min(1,Math.min(window.innerWidth/fr,window.innerHeight/pr)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function kr(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function Ar(e){let t=[];for(let n=0;n<e;n++)t.push({id:n*2,pairId:n}),t.push({id:n*2+1,pairId:n});return{cards:kr(t),flipped:[],matched:[],matchedBy:{},currentTurn:`player`,seen:{},playerPairs:0,opponentPairs:0,turns:0,phase:`playing`,lastEvent:`turn_start`,eventId:0}}var jr=4,Mr=110,Nr=140,Pr=14,Fr=14;function Ir(e,t){if(t)return/^(https?:)?\/\//.test(t)||t.startsWith(`/`)?t:`${(e??`/assets`).replace(/\/$/,``)}/${t.replace(/^\//,``)}`}function Lr(e){return e.length===0?null:e[Math.floor(Math.random()*e.length)]}function Rr(e,t=`normal`){let n=t===`weak`?.18:.45,r=t===`weak`?.08:.25,i=e.cards.filter(t=>!e.matched.includes(t.pairId)&&!e.flipped.includes(t.id));if(i.length===0)return null;if(e.flipped.length===1){let t=e.cards.find(t=>t.id===e.flipped[0]),r=i.find(e=>t&&e.pairId===t.pairId);return r&&Math.random()<n?r.id:Lr(i)?.id??null}let a=new Map;for(let t of i)e.seen[t.id]===t.pairId&&a.set(t.pairId,[...a.get(t.pairId)??[],t.id]);let o=[...a.values()].find(e=>e.length>=2);return o&&Math.random()<r?o[0]:Lr(i)?.id??null}function zr({side:e,name:t,faceSrc:n,score:r,active:i}){let a=e===`left`?`#fff176`:`#80deea`,o=_r-96;return(0,I.jsxs)(`div`,{style:{position:`absolute`,top:hr,[e]:0,width:mr,height:_r,overflow:`hidden`,background:i?`rgba(${e===`left`?`255,241,118`:`128,222,234`},0.06)`:`rgba(6,6,18,0.65)`,borderRight:e===`left`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,borderLeft:e===`right`?`1px solid ${i?`${a}55`:`rgba(38,42,72,0.5)`}`:`none`,transition:`background 0.4s, border-color 0.4s`,zIndex:3},children:[(0,I.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:o,overflow:`hidden`},children:[n?(0,I.jsx)(`img`,{src:n,alt:``,draggable:!1,style:{display:`block`,width:`100%`,height:`100%`,objectFit:`contain`,objectPosition:`bottom center`,filter:i?`none`:`brightness(0.55) saturate(0.6)`,transition:`filter 0.4s`}}):(0,I.jsx)(`div`,{style:{height:`100%`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:56,color:`#1e2040`},children:e===`left`?`🎮`:`🤖`}),(0,I.jsx)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:60,background:`linear-gradient(to top, ${i?e===`left`?`rgba(18,16,2,0.96)`:`rgba(2,16,18,0.96)`:`rgba(6,6,18,0.96)`} 0%, transparent 100%)`,pointerEvents:`none`}})]}),(0,I.jsxs)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0,height:96,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:4,borderTop:`1px solid ${i?`${a}44`:`rgba(36,40,68,0.5)`}`,background:i?e===`left`?`rgba(22,18,2,0.92)`:`rgba(2,18,22,0.92)`:`rgba(6,6,18,0.92)`,transition:`background 0.4s, border-color 0.4s`},children:[(0,I.jsx)(`div`,{style:{fontSize:48,lineHeight:1,color:i?a:`#4a5090`,fontVariantNumeric:`tabular-nums`,textShadow:i?`0 0 24px ${a}55`:`none`,transition:`color 0.4s, text-shadow 0.4s`},children:r}),(0,I.jsx)(`div`,{style:{fontSize:10,color:`#3c4278`,letterSpacing:`0.08em`},children:`取得ペア`}),(0,I.jsx)(`div`,{style:{fontSize:11,color:i?`#c5cae9`:`#4a5090`,letterSpacing:`0.05em`,maxWidth:mr-16,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`,textAlign:`center`,transition:`color 0.4s`},children:t})]}),i&&(0,I.jsx)(`div`,{style:{position:`absolute`,top:10,...e===`left`?{right:10}:{left:10},color:a,fontSize:14,opacity:.9},children:e===`left`?`▶`:`◀`})]})}function Br({speakerName:e,speakerSide:t,text:n}){return(0,I.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,bottom:0,height:gr,background:`rgba(6,6,20,0.92)`,borderTop:`1px solid rgba(46,50,88,0.7)`,zIndex:10},children:[e&&(0,I.jsx)(`div`,{style:{position:`absolute`,top:-30,...t===`right`?{right:mr+20}:{left:mr+20},background:`rgba(6,6,20,0.94)`,border:`1px solid rgba(46,50,88,0.7)`,borderBottom:`none`,padding:`5px 20px`,fontSize:13,color:`#c5cae9`,letterSpacing:`0.1em`},children:e}),(0,I.jsx)(`div`,{style:{position:`absolute`,top:18,left:mr+24,right:mr+24,bottom:14,color:`#e8eaf6`,fontSize:15,lineHeight:1.9,letterSpacing:`0.08em`,overflow:`hidden`},children:n??``})]})}function Vr({context:e,config:t,onExit:n}){let r=t.mode??`solo`,i=r===`duel`,o=t.opponentSkill??`normal`,s=t.pairs??6,c=t.maxTurns??20,l=Math.ceil(s*2/jr),u=i?vr:Nr,d=jr*Mr+(jr-1)*Pr,f=l*u+(l-1)*Fr,p=Math.round((fr-d)/2),m=i?hr+Math.round((_r-f)/2):Math.round((pr-f)/2)+16,h=Or(),{speak:g,stop:_}=Dr(t.assetsBaseUrl),[v,y]=(0,a.useState)(()=>Ar(s)),b=(0,a.useRef)(!1),[x,S]=(0,a.useState)(()=>{if(r!==`duel`)return null;let e=Lr(t.playerDialogue?.length?t.playerDialogue:br);return e?{speaker:`player`,text:e}:null});(0,a.useEffect)(()=>{if(v.phase!==`win`&&v.phase!==`lose`)return;let r=v.phase===`win`,i=setTimeout(()=>{n({...e,flags:{...e.flags,[`memory_game_result_${t.stageId}`]:r?`win`:`lose`,[`memory_game_player_pairs_${t.stageId}`]:v.playerPairs,[`memory_game_opponent_pairs_${t.stageId}`]:v.opponentPairs}})},2500);return()=>clearTimeout(i)},[v.phase]),(0,a.useEffect)(()=>{if(!x||!i)return;let e=x.speaker===`player`?t.playerVoicevoxSpeakerId:t.opponentVoicevoxSpeakerId;if(e!=null)return g(x.text,e),_},[x]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`){S(null);return}let e=v.currentTurn,n;switch(v.lastEvent){case`match`:n=e===`opponent`?t.opponentMatchDialogue?.length?t.opponentMatchDialogue:Cr:t.playerMatchDialogue?.length?t.playerMatchDialogue:Sr;break;case`mismatch`:n=e===`opponent`?t.opponentMissDialogue?.length?t.opponentMissDialogue:Tr:t.playerMissDialogue?.length?t.playerMissDialogue:wr;break;default:n=e===`opponent`?t.opponentDialogue?.length?t.opponentDialogue:xr:t.playerDialogue?.length?t.playerDialogue:br}let r=Lr(n);S(r?{speaker:e,text:r}:null)},[v.eventId,i,v.phase]);let C=(0,a.useCallback)(e=>{b.current||y(t=>{if(t.phase!==`playing`)return t;let n=t.cards.find(t=>t.id===e);if(!n||t.matched.includes(n.pairId)||t.flipped.includes(e)||t.flipped.length>=2)return t;let r=[...t.flipped,e],a={...t.seen,[e]:n.pairId};if(r.length<2)return{...t,flipped:r,seen:a};let[o,c]=r,l=t.cards.find(e=>e.id===o),u=t.cards.find(e=>e.id===c),d=l.pairId===u.pairId,f=t.turns+1,p=i?t.currentTurn:`player`;if(d){let e=[...t.matched,l.pairId],n=t.playerPairs+ +(p===`player`),r=t.opponentPairs+ +(p===`opponent`),o=e.length===s,c=i?n>r:!0;return{...t,flipped:[],matched:e,matchedBy:{...t.matchedBy,[l.pairId]:p},seen:a,playerPairs:n,opponentPairs:r,turns:f,phase:o?c?`win`:`lose`:`playing`,lastEvent:`match`,eventId:t.eventId+1}}return{...t,flipped:r,seen:a,turns:f,lastEvent:`mismatch`,eventId:t.eventId+1}})},[i,s,c]),ee=(0,a.useCallback)(e=>{i&&v.currentTurn!==`player`||C(e)},[i,C,v.currentTurn]);(0,a.useEffect)(()=>{if(v.flipped.length!==2)return;let[e,t]=v.flipped,n=v.cards.find(t=>t.id===e),r=v.cards.find(e=>e.id===t);if(n.pairId===r.pairId)return;b.current=!0;let a=setTimeout(()=>{y(e=>({...e,flipped:[],currentTurn:i?e.currentTurn===`player`?`opponent`:`player`:e.currentTurn,phase:!i&&c>0&&e.turns>=c?`lose`:e.phase,lastEvent:`turn_start`,eventId:e.eventId+1})),b.current=!1},900);return()=>{clearTimeout(a),b.current=!1}},[v.flipped]),(0,a.useEffect)(()=>{if(!i||v.phase!==`playing`||v.currentTurn!==`opponent`||b.current)return;let e=v.flipped.length===0?650:820,t=setTimeout(()=>{let e=Rr(v,o);e!==null&&C(e)},e);return()=>clearTimeout(t)},[i,o,C,v]);let w=c>0?c-v.turns:null,T=w!==null&&w<=5,E=Ir(t.assetsBaseUrl,t.playerFaceImage),D=Ir(t.assetsBaseUrl,t.opponentFaceImage),O=t.playerName??`こちら`,k=t.opponentName??`相手`,A=Ir(t.assetsBaseUrl,t.backgroundImage),j=x?x.speaker===`player`?O:k:null,M=x?x.speaker===`player`?`left`:`right`:null;return(0,I.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#0a0a14`,overflow:`hidden`},children:(0,I.jsxs)(`div`,{style:{width:fr,height:pr,position:`relative`,userSelect:`none`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${h})`,fontFamily:dr,...A?{backgroundImage:`url(${A})`,backgroundSize:`cover`,backgroundPosition:`center`}:{background:`linear-gradient(150deg, #0d0d1a 0%, #0a0a14 60%, #0e0a1c 100%)`}},children:[A&&(0,I.jsx)(`div`,{style:{position:`absolute`,inset:0,background:`rgba(4,4,12,0.56)`,pointerEvents:`none`}}),(0,I.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:hr,display:`flex`,alignItems:`center`,justifyContent:`center`,zIndex:4,borderBottom:`1px solid rgba(36,40,68,0.5)`,background:`rgba(6,6,20,0.7)`},children:[(0,I.jsx)(`span`,{style:{color:`#c5cae9`,fontSize:15,letterSpacing:`0.14em`},children:t.title??`神経衰弱`}),!i&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsxs)(`span`,{style:{position:`absolute`,left:20,color:`#8bc34a`,fontSize:13},children:[v.matched.length,` / `,s,` ペア`]}),(0,I.jsx)(`span`,{style:{position:`absolute`,right:20,color:T?`#ef9a9a`:`#4a4d62`,fontSize:13},children:c>0?`残り ${w} 手`:`${v.turns} 手`})]})]}),i&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(zr,{side:`left`,name:O,faceSrc:E,score:v.playerPairs,active:v.currentTurn===`player`&&v.phase===`playing`}),(0,I.jsx)(zr,{side:`right`,name:k,faceSrc:D,score:v.opponentPairs,active:v.currentTurn===`opponent`&&v.phase===`playing`})]}),v.cards.map((e,t)=>{let n=t%jr,r=Math.floor(t/jr),a=p+n*(Mr+Pr),o=m+r*(u+Fr),s=v.flipped.includes(e.id)||v.matched.includes(e.pairId),c=v.matched.includes(e.pairId),l=yr[e.pairId%yr.length],d=(c?v.matchedBy[e.pairId]:void 0)===`opponent`?`#80deea`:l.color;return(0,I.jsx)(`div`,{onClick:()=>ee(e.id),style:{position:`absolute`,left:a,top:o,width:Mr,height:u,borderRadius:10,cursor:s||i&&v.currentTurn!==`player`||b.current?`default`:`pointer`,background:s?`#141426`:`#0c0c1c`,border:c?`2px solid ${d}88`:s?`2px solid #3a3a5a`:`2px solid #1c1c30`,display:`flex`,alignItems:`center`,justifyContent:`center`,boxShadow:c?`0 0 20px ${d}36, 0 2px 8px rgba(0,0,0,0.55)`:s?`0 4px 14px rgba(0,0,0,0.65)`:`0 2px 6px rgba(0,0,0,0.45)`,transition:`background 0.12s, border-color 0.12s, box-shadow 0.2s`,zIndex:2},children:s?(0,I.jsx)(`span`,{style:{fontSize:i?44:52,color:c?`${l.color}80`:l.color,lineHeight:1},children:l.symbol}):(0,I.jsx)(`span`,{style:{fontSize:24,color:`#1c1e38`},children:`✦`})},e.id)}),i&&v.phase===`playing`&&(0,I.jsx)(Br,{speakerName:j,speakerSide:M,text:x?.text??null}),v.phase===`win`&&(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,I.jsx)(`div`,{style:{fontSize:46,color:`#fff176`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(255,241,118,0.45)`},children:`勝　利`}),(0,I.jsx)(`div`,{style:{fontSize:16,color:`#c5cae9`,letterSpacing:`0.08em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`${v.turns} 手でクリア`})]}),v.phase===`lose`&&(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.90)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,I.jsx)(`div`,{style:{fontSize:46,color:`#ef9a9a`,letterSpacing:`0.25em`,textShadow:`0 0 40px rgba(239,154,154,0.35)`},children:`惜　敗`}),(0,I.jsx)(`div`,{style:{fontSize:16,color:`#667`,letterSpacing:`0.06em`},children:i?`${v.playerPairs} — ${v.opponentPairs}`:`もう一度チャレンジしてください`})]})]})})}var Hr={component:Vr},Ur=800,Wr=600,Gr=`'Hiragino Kaku Gothic ProN', 'Meiryo', 'Yu Gothic', sans-serif`,Kr={easy:{count:3,min:1,max:9,flashMs:800,blankMs:150,negatives:0},normal:{count:4,min:3,max:20,flashMs:600,blankMs:120,negatives:1},hard:{count:5,min:5,max:50,flashMs:400,blankMs:100,negatives:2}};function qr(e,t){return Math.floor(Math.random()*(t-e+1))+e}function Jr(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function Yr(e){let{count:t,min:n,max:r,negatives:i}=Kr[e];for(;;){let e=[];e.push(qr(n,r));for(let a=1;a<t;a++){let t=i>0&&a<=i&&Math.random()<.45;e.push(qr(n,r)*(t?-1:1))}let a=e.reduce((e,t)=>e+t,0);if(a>0)return{nums:e,answer:a}}}function Xr(e){let t=new Set([e]);for(let n of Zr([3,7,12,18,25])){if(t.size>=4)break;let r=e+(Math.random()<.5?1:-1)*n;r>0&&r!==e&&t.add(r)}let n=1;for(;t.size<4;)t.add(e+n),t.add(e-n),n+=1;return Jr([...t].slice(0,4))}function Zr(e){return Jr(e)}function Qr(e){let t=Yr(e);return{phase:`countdown`,countdown:3,round:0,problem:t,flashIdx:0,choices:Xr(t.answer),selected:null,isCorrect:null,score:0,seq:0}}function $r(){let e=()=>Math.min(1,Math.min(window.innerWidth/Ur,window.innerHeight/Wr)),[t,n]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let t=()=>n(e());return window.addEventListener(`resize`,t),()=>window.removeEventListener(`resize`,t)},[]),t}function ei({context:e,config:t,onExit:n}){let r=t.difficulty??`easy`,i=t.rounds??5,o=Kr[r],s=$r(),[c,l]=(0,a.useState)(()=>Qr(r)),u=(0,a.useRef)(0),d=(0,a.useCallback)(()=>(u.current+=1,u.current),[]);(0,a.useEffect)(()=>{if(c.phase!==`countdown`)return;let e=d(),t=setTimeout(()=>{u.current===e&&(c.countdown>1?l(e=>({...e,countdown:e.countdown-1,seq:e.seq+1})):l(e=>({...e,phase:`flash`,flashIdx:0,seq:e.seq+1})))},800);return()=>clearTimeout(t)},[c.phase,c.countdown,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`flash`)return;let e=d(),t=setTimeout(()=>{u.current===e&&(c.flashIdx+1<c.problem.nums.length?l(e=>({...e,phase:`blank`,seq:e.seq+1})):l(e=>({...e,phase:`answer`,selected:null,isCorrect:null,seq:e.seq+1})))},o.flashMs);return()=>clearTimeout(t)},[c.phase,c.flashIdx,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`blank`)return;let e=d(),t=setTimeout(()=>{u.current===e&&l(e=>({...e,phase:`flash`,flashIdx:e.flashIdx+1,seq:e.seq+1}))},o.blankMs);return()=>clearTimeout(t)},[c.phase,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`feedback`)return;let e=d(),t=setTimeout(()=>{if(u.current!==e)return;let t=c.round+1;if(t>=i)l(e=>({...e,phase:`result`,seq:e.seq+1}));else{let e=Yr(r);l(n=>({...n,phase:`countdown`,countdown:3,round:t,problem:e,flashIdx:0,choices:Xr(e.answer),selected:null,isCorrect:null,seq:n.seq+1}))}},1400);return()=>clearTimeout(t)},[c.phase,c.round,c.seq]),(0,a.useEffect)(()=>{if(c.phase!==`result`)return;let t=d(),r=setTimeout(()=>{u.current===t&&n({...e,flags:{...e.flags,flash_calc_score:c.score,flash_calc_rounds:i,flash_calc_passed:c.score>ii},playerStats:{...e.playerStats,flash_calc_score:c.score}})},3500);return()=>clearTimeout(r)},[c.phase]);let f=(0,a.useCallback)(e=>{if(c.phase!==`answer`)return;let t=e===c.problem.answer;l(n=>({...n,phase:`feedback`,selected:e,isCorrect:t,score:t?n.score+1:n.score,seq:n.seq+1}))},[c.phase,c.problem.answer]),p=c.problem.nums[c.flashIdx],m=typeof p==`number`&&p<0;return(0,I.jsx)(`div`,{style:{width:`100vw`,height:`100dvh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#0a0a14`,overflow:`hidden`},children:(0,I.jsxs)(`div`,{style:{width:Ur,height:Wr,position:`relative`,overflow:`hidden`,flexShrink:0,transformOrigin:`center center`,transform:`scale(${s})`,fontFamily:Gr,background:`linear-gradient(160deg, #0c0c1e 0%, #080812 60%, #10081e 100%)`,userSelect:`none`},children:[(0,I.jsx)(ti,{round:c.round,totalRounds:i,score:c.score}),(0,I.jsx)(ni,{phase:c.phase,countdown:c.countdown,currentNum:p,isNeg:m,flashIdx:c.flashIdx,totalNums:c.problem.nums.length,isCorrect:c.isCorrect,correctAnswer:c.problem.answer,selected:c.selected}),(c.phase===`answer`||c.phase===`feedback`)&&(0,I.jsx)(ri,{choices:c.choices,selected:c.selected,correct:c.problem.answer,onSelect:f,disabled:c.phase===`feedback`}),c.phase===`result`&&(0,I.jsx)(ai,{score:c.score,total:i})]})})}function ti({round:e,totalRounds:t,score:n}){return(0,I.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:44,display:`flex`,alignItems:`center`,justifyContent:`center`,borderBottom:`1px solid rgba(80,60,140,0.4)`,background:`rgba(8,8,20,0.8)`,zIndex:5},children:[(0,I.jsx)(`span`,{style:{color:`#c5cae9`,fontSize:15,letterSpacing:`0.18em`},children:`フラッシュ暗算`}),(0,I.jsxs)(`span`,{style:{position:`absolute`,left:24,color:`#7c7ca0`,fontSize:13,letterSpacing:`0.06em`},children:[`ラウンド `,e+1,` / `,t]}),(0,I.jsxs)(`span`,{style:{position:`absolute`,right:24,color:`#8bc34a`,fontSize:13,letterSpacing:`0.06em`},children:[`正解 `,n]})]})}function ni({phase:e,countdown:t,currentNum:n,isNeg:r,flashIdx:i,totalNums:a,isCorrect:o,correctAnswer:s,selected:c}){let l=44+Math.round((Wr-44-160)/2);if(e===`result`)return null;if(e===`countdown`)return(0,I.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,top:l-80,bottom:160,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:20},children:[(0,I.jsx)(`div`,{style:{fontSize:96,color:`#e8d5ff`,lineHeight:1,textShadow:`0 0 60px rgba(180,100,255,0.6)`,animation:`flashCalcPop 0.25s ease-out`},children:t}),(0,I.jsx)(`div`,{style:{fontSize:14,color:`#5c5c80`,letterSpacing:`0.1em`},children:`集中してください`})]});if(e===`flash`){let e=r?`−${Math.abs(n)}`:`${n}`;return(0,I.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,top:l-60,bottom:160,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:24},children:[(0,I.jsx)(`div`,{style:{display:`flex`,gap:10,marginBottom:8},children:Array.from({length:a},(e,t)=>(0,I.jsx)(`div`,{style:{width:8,height:8,borderRadius:`50%`,background:t<i?`rgba(140,120,220,0.5)`:t===i?`#c5b3ff`:`rgba(60,60,90,0.5)`,transition:`background 0.15s`}},t))}),(0,I.jsx)(`div`,{style:{fontSize:110,color:r?`#ef9a9a`:`#e8d5ff`,lineHeight:1,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 60px ${r?`rgba(239,154,154,0.55)`:`rgba(180,140,255,0.55)`}`},children:e})]})}return e===`blank`?(0,I.jsx)(`div`,{style:{position:`absolute`,left:0,right:0,top:l-60,bottom:160,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,I.jsx)(`div`,{style:{display:`flex`,gap:10},children:Array.from({length:a},(e,t)=>(0,I.jsx)(`div`,{style:{width:8,height:8,borderRadius:`50%`,background:t<i?`rgba(140,120,220,0.5)`:`rgba(60,60,90,0.5)`}},t))})}):e===`answer`?(0,I.jsxs)(`div`,{style:{position:`absolute`,left:0,right:0,top:l-60,bottom:160,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:16},children:[(0,I.jsx)(`div`,{style:{fontSize:80,color:`#7c72a0`,lineHeight:1},children:`?`}),(0,I.jsx)(`div`,{style:{fontSize:15,color:`#6c6c90`,letterSpacing:`0.1em`},children:`こたえを えらんでね`})]}):e===`feedback`?(0,I.jsx)(`div`,{style:{position:`absolute`,left:0,right:0,top:l-60,bottom:160,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:16},children:o?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`div`,{style:{fontSize:64,color:`#8bc34a`,textShadow:`0 0 40px rgba(139,195,74,0.55)`},children:`せいかい！`}),(0,I.jsx)(`div`,{style:{fontSize:32,color:`#c5e1a5`,fontVariantNumeric:`tabular-nums`},children:s})]}):(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`div`,{style:{fontSize:64,color:`#ef9a9a`,textShadow:`0 0 40px rgba(239,154,154,0.5)`},children:`ざんねん`}),(0,I.jsxs)(`div`,{style:{fontSize:18,color:`#7c7ca0`,letterSpacing:`0.1em`},children:[`こたえは `,s]}),c!==null&&(0,I.jsxs)(`div`,{style:{fontSize:14,color:`#4a4a68`},children:[`あなたは `,c,` と答えました`]})]})}):null}function ri({choices:e,selected:t,correct:n,onSelect:r,disabled:i}){return(0,I.jsx)(`div`,{style:{position:`absolute`,left:40,right:40,bottom:40,height:100,display:`flex`,gap:20,alignItems:`center`,justifyContent:`center`},children:e.map(e=>{let a=`rgba(20,18,40,0.9)`,o=`2px solid rgba(80,70,140,0.4)`,s=`#c5cae9`,c=`none`;return i&&t!==null&&(e===n?(a=`rgba(60,90,30,0.9)`,o=`2px solid #8bc34a`,s=`#c5e1a5`,c=`0 0 20px rgba(139,195,74,0.35)`):e===t&&e!==n&&(a=`rgba(80,30,30,0.9)`,o=`2px solid #ef9a9a`,s=`#ef9a9a`)),(0,I.jsx)(`button`,{onClick:()=>!i&&r(e),style:{flex:1,height:`100%`,background:a,border:o,borderRadius:12,color:s,fontSize:36,fontFamily:Gr,fontVariantNumeric:`tabular-nums`,cursor:i?`default`:`pointer`,boxShadow:c,transition:`background 0.15s, border-color 0.15s, box-shadow 0.15s`},children:e},e)})})}var ii=3;function ai({score:e,total:t}){if(e>ii){let n=e===t?`#fff176`:`#8bc34a`,r=e===t?`パーフェクト！`:`よくできました！`;return(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.92)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:28},children:[(0,I.jsx)(`div`,{style:{fontSize:48,color:n,letterSpacing:`0.2em`,textShadow:`0 0 40px ${n}55`},children:r}),(0,I.jsxs)(`div`,{style:{fontSize:80,color:n,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 60px ${n}44`},children:[e,` `,(0,I.jsxs)(`span`,{style:{fontSize:28,color:`#6c6c90`},children:[`/ `,t]})]}),(0,I.jsxs)(`div`,{style:{fontSize:14,color:`#4a4a68`,letterSpacing:`0.1em`},children:[`せいかい `,e,` もん`]})]})}return(0,I.jsxs)(`div`,{style:{position:`absolute`,inset:0,zIndex:30,background:`rgba(6,6,16,0.92)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:24},children:[(0,I.jsx)(`div`,{style:{fontSize:48,color:`#ef9a9a`,letterSpacing:`0.2em`,textShadow:`0 0 40px rgba(239,154,154,0.5)`},children:`ざんねん…`}),(0,I.jsxs)(`div`,{style:{fontSize:80,color:`#ef9a9a`,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 60px rgba(239,154,154,0.35)`},children:[e,` `,(0,I.jsxs)(`span`,{style:{fontSize:28,color:`#6c6c90`},children:[`/ `,t]})]}),(0,I.jsx)(`div`,{style:{fontSize:18,color:`#7c6080`,letterSpacing:`0.1em`},children:`4もん以上せいかいしてね`}),(0,I.jsx)(`div`,{style:{marginTop:8,fontSize:15,color:`#5a4a68`,letterSpacing:`0.12em`},children:`ケンに相談しよう…`})]})}var oi={component:ei},si=vt(),ci=vt(`chapter2`),li=vt(`chapter3`),ui=vt(`chapter4`),di=`/dojonovel/assets`,fi=[{id:`chapter1`,title:`第1章へ`,chapterTitle:`赤羽の一日`,masterData:si,initialSceneId:`scene_danchi_morning`,initialLocationId:`loc_danchi`,initialFlags:{flag_chapter:1}},{id:`chapter2`,title:`第2章へ`,chapterTitle:`一番街の怨霊`,masterData:ci,initialSceneId:`scene_ch2_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_chapter1_cleared`,initialFlags:{flag_chapter:2,flag_chapter1_cleared:!0}},{id:`chapter3`,title:`第3章へ`,chapterTitle:`アーケード街の死闘`,masterData:li,initialSceneId:`scene_ch3_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_ch2_cleared`,initialFlags:{flag_chapter:3,flag_chapter1_cleared:!0,flag_ch2_cleared:!0}},{id:`chapter4`,title:`第4章へ`,chapterTitle:`（タイトル未定）`,masterData:ui,initialSceneId:`scene_ch4_start`,initialLocationId:`loc_danchi`,unlockFlag:`flag_ch3_cleared`,initialFlags:{flag_chapter:4,flag_chapter1_cleared:!0,flag_ch2_cleared:!0,flag_ch3_cleared:!0}}];function pi(){return(0,I.jsx)(xt,{engines:{novel:Ct,maze_rpg:kn,runner_action:ur,memory_game:Hr,flash_calc:oi},initial:{engineId:`novel`,config:{masterData:si,assetsBaseUrl:di,chapterId:`chapter1`,initialSceneId:`scene_danchi_morning`,initialLocationId:`loc_danchi`,chapters:fi}},initialContext:{flags:{},inventory:[],playerStats:{}}})}(0,o.createRoot)(document.getElementById(`root`)).render((0,I.jsx)(a.StrictMode,{children:(0,I.jsx)(pi,{})}));